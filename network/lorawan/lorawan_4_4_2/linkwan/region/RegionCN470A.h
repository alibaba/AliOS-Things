 ...
 */
#define CN470A_JOIN_CHANNELS \
    (uint16_t)(LC(1) | LC(2) | LC(3) | LC(4) | LC(5) | LC(6) | LC(7) | LC(8))
 ...
 * Beacon frequency
 */
#define CN470A_BEACON_CHANNEL_INTRA_FREQ             471900000

#define CN470A_BEACON_CHANNEL_INTER_FREQ             485500000
 ...
 */
#define CN470A_PING_SLOT_CHANNEL_DR                  DR_2
 ...
 */
#define CN470A_BAND0                                 { 1, CN470A_MAX_TX_POWER, 0, 0, 0 } //  100.0 %

/*!
 * Defines the first channel for RX window 1 for CN470 band
 */
#define CN470A_FIRST_RX1_CHANNEL                     ( (uint32_t) 500300000 )

/*!
 * Defines the last channel for RX window 1 for CN470 band
 */
#define CN470A_LAST_RX1_CHANNEL                      ( (uint32_t) 509700000 )

/*!
 * Defines the step width of the channels for RX window 1
 */
#define CN470A_STEPWIDTH_RX1_CHANNEL                 ( (uint32_t) 200000 )
 ...
 */
static const uint32_t BandwidthsCN470A[] = { 125e3, 125e3, 125e3, 125e3,
                                             125e3, 125e3, 250e3, 0 };
 ...
 * repeater.
 */
static const uint8_t MaxPayloadOfDatarateCN470A[] = { 51,  51,  51,  115,
                                                      242, 242, 242, 242 };
 ...
 * repeater.
 */
static const uint8_t MaxPayloadOfDatarateRepeaterCN470A[] = { 51,  51,  51,
                                                              115, 222, 222,
                                                              222, 222 };
 ...
 */
void RegionCN470AInitDefaults(InitDefaultsParams_t* params);
 ...
 */
int8_t RegionCN470AAlternateDr(int8_t currentDr);
 ...
 * datarate]
 */
LoRaMacStatus_t RegionCN470ANextChannel(NextChanParams_t *nextChanParams, uint8_t *channel,
