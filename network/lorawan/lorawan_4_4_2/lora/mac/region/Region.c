...
#define CN470A_INIT_DEFAULTS( )                    CN470A_CASE { RegionCN470AInitDefaults( params ); break; }
#define CN470A_GET_NVM_CTX( )                      CN470A_CASE { return RegionCN470AGetNvmCtx( params ); }
...
#define CN470A_ALTERNATE_DR( )                     CN470A_CASE { return RegionCN470AAlternateDr( currentDr ); }
