...
$(NAME)_SOURCES-$(CONFIG_BT_MESH_PROVISIONER) += ./src/provisioner_main.c \
...
GLOBAL_DEFINES += CONFIG_BT_MESH_RELAY CONFIG_BT_MESH_PROV USE_BT_MESH_CUSTOM_LOG

GLOBAL_INCLUDES += ./inc/

GLOBAL_DEFINES-$(AOS_COMP_BT_MESH) += CONFIG_BT_MESH

ifeq (y,$(CONFIG_BT_MESH_PROVISIONER))
ifeq (y,$(CONFIG_BT_MESH_PB_GATT))
GLOBAL_DEFINES += CONFIG_BT_CENTRAL CONFIG_BT_GATT_CLIENT
endif
endif
