...
typedef struct sRegionCN470ANvmCtx
{
    /*!
     * LoRaMAC channels
     */
    ChannelParams_t Channels[ CN470A_MAX_NB_CHANNELS ];
    /*!
     * LoRaMac bands
     */
    Band_t Bands[ CN470A_MAX_NB_BANDS ];
    /*!
...
}RegionCN470ANvmCtx_t;

static RegionCN470ANvmCtx_t NvmCtx;
...
void RegionCN470AInitDefaults(InitDefaultsParams_t* params)
{
    switch (params->Type) {
        case INIT_TYPE_INIT: {
            uint16_t bandmask = get_lora_freqband_mask();
            ...
            ChannelsDefaultMask[0] =
              ...
              LC(9) + LC(10) + LC(11) + LC(12) + LC(13) + LC(14) + LC(15) + LC(16);
...
void* RegionCN470AGetNvmCtx(GetNvmCtxParams_t* param)
{
    param->nvmCtxSize = sizeof(RegionCN470ANvmCtx_t);
