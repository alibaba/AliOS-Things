...
static void task_net_connect_fun(void *arg)
{
    ...
    pdata->onconnect_cb = (be_jse_symbol_t *)msg->onconn_cb;
    pdata->onerror_cb   = (be_jse_symbol_t *)msg->onerror_cb;
    pdata->ondata_cb    = (be_jse_symbol_t *)msg->ondata_cb;
    pdata->onclose_cb   = (be_jse_symbol_t *)msg->onclose_cb;
