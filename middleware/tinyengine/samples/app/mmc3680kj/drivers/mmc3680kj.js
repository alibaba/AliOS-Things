...
function MMC3680KJ() {
    this.isOn = 1;
    this.handle = I2C.open('mmc3680kj');
    this.enRead = 0;
...
var mmc3680kj = new MMC3680KJ();

mmc3680kj.read_one = function(addr){
    var reg=[0];
    reg[0] = addr;
...
mmc3680kj.read_two = function(addr){
...
mmc3680kj.write_one = function(addr,val){
    var data = [0,0];
    data[0]=addr; 
    data[1]=val; 
...
module.exports.mmc3680kj = mmc3680kj;
