...
void ota_md5_free( ota_md5_context *ctx )
{
    ...
    ota_zeroize( ctx, sizeof( ota_md5_context ) );
}
...
void ota_md5_process( ota_md5_context *ctx, const unsigned char data[64] )
{
...
void ota_md5_update( ota_md5_context *ctx, const unsigned char *input, unsigned int ilen )
{
    ...
    if ( left && ilen >= fill ) {
        ...
        ota_md5_process( ctx, ctx->buffer );
        input += fill;
        ilen  -= fill;
        left = 0;
    }
...
void ota_md5_finish( ota_md5_context *ctx, unsigned char output[16] )
{
    ...
    ota_md5_update( ctx, md5_padding, padn );
    ota_md5_update( ctx, msglen, 8 );
