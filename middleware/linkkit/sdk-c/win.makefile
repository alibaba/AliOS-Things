...
INPUT_FLAGS := -DFORCE_SSL_VERIFY -DCOAP_OBSERVE_SERVER_SUPPORTED -DCOAP_OBSERVE_CLIENT_SUPPORTED -DCOAP_SERV_MULTITHREAD -DCOAP_USE_PLATFORM_MEMORY -DCOAP_USE_PLATFORM_LOG -DALCS_ENABLED -DDEPRECATED_LINKKIT -DDEVICE_MODEL_GATEWAY -DMQTT_COMM_ENABLED -DMQTT_DIRECT -DDEVICE_MODEL_ENABLED -DSUPPORT_TLS -DWIFI_PROVISION_ENABLED -DDEV_BIND_ENABLED -DCONFIG_CM_VIA_CLOUD_CONN -DCONFIG_CM_SUPPORT_LOCAL_CONN -DCONFIG_DM_SUPPORT_LOCAL_CONN -DCONFIG_DM_DEVTYPE_GATEWAY -DCONFIG_SDK_THREAD_COST=1 -DOTA_SIGNAL_CHANNEL=1  -D__UBUNTU_SDK_DEMO__ -DWITH_MEM_STATS=0 -DWITH_MQTT_DYNBUF=1 -DCONFIG_HTTP_AUTH_TIMEOUT=500 -DCONFIG_MID_HTTP_TIMEOUT=500 -DCONFIG_GUIDER_AUTH_TIMEOUT=500 -DCONFIG_MQTT_RX_MAXLEN=5000 -DCONFIG_MQTT_SUBTOPIC_MAXNUM=65535 -DCONFIG_MBEDTLS_DEBUG_LEVEL=0 $(CONFIG_ENV_CFLAGS) $(TOOL_CHAIN_CFLAGS)
GATEEAY_OBJS := 
else
INPUT_FLAGS := -DFORCE_SSL_VERIFY -DCOAP_OBSERVE_SERVER_SUPPORTED -DCOAP_OBSERVE_CLIENT_SUPPORTED -DCOAP_SERV_MULTITHREAD -DCOAP_USE_PLATFORM_MEMORY -DCOAP_USE_PLATFORM_LOG -DALCS_ENABLED -DDEPRECATED_LINKKIT -DMQTT_COMM_ENABLED -DMQTT_DIRECT -DDEVICE_MODEL_ENABLED -DSUPPORT_TLS -DWIFI_PROVISION_ENABLED -DDEV_BIND_ENABLED -DCONFIG_CM_VIA_CLOUD_CONN -DCONFIG_CM_SUPPORT_LOCAL_CONN -DCONFIG_DM_SUPPORT_LOCAL_CONN -DCONFIG_DM_DEVTYPE_SINGLE -DOTA_SIGNAL_CHANNEL=1 -D__UBUNTU_SDK_DEMO__ -DWITH_MEM_STATS=0 -DWITH_MQTT_DYNBUF=1 -DCONFIG_HTTP_AUTH_TIMEOUT=500 -DCONFIG_MID_HTTP_TIMEOUT=500 -DCONFIG_GUIDER_AUTH_TIMEOUT=500 -DCONFIG_MQTT_RX_MAXLEN=5000 -DCONFIG_MQTT_SUBTOPIC_MAXNUM=65535 -DCONFIG_MBEDTLS_DEBUG_LEVEL=0 $(CONFIG_ENV_CFLAGS) $(TOOL_CHAIN_CFLAGS)  
endif
