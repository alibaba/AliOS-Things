...
extern const char DM_URI_THING_LAN_PREFIX_GET[]              DM_READ_ONLY;
extern const char DM_URI_THING_LAN_PREFIX_GET_REPLY[]        DM_READ_ONLY;
extern const char DM_URI_THING_LAN_PREFIX_UPDATE[]           DM_READ_ONLY;
