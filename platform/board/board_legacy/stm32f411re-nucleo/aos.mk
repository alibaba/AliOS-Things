...
ifeq ($(COMPILER),armcc)
GLOBAL_LDFLAGS += -L --scatter=platform/board/board_legacy/stm32f411re-nucleo/stm32f411xe.sct
else ifeq ($(COMPILER),iar)
GLOBAL_LDFLAGS += --config platform/board/board_legacy/stm32f411re-nucleo/STM32F411.icf
else
GLOBAL_LDFLAGS += -T platform/board/board_legacy/stm32f411re-nucleo/STM32F411RETx_FLASH.ld
endif
