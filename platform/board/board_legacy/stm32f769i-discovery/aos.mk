...
GLOBAL_LDFLAGS += -L --scatter=platform/board/board_legacy/stm32f769i-discovery/stm32f769i-discovery.sct
else ifeq ($(COMPILER), iar)
$(NAME)_SOURCES += startup/startup_iar.s
GLOBAL_LDFLAGS += --config platform/board/board_legacy/stm32f769i-discovery/stm32f769i-discovery.icf
else
GLOBAL_CFLAGS += -DUSE_DIRECT_UART_PUTC
$(NAME)_SOURCES += startup/startup_gcc.s
GLOBAL_LDFLAGS += -T platform/board/board_legacy/stm32f769i-discovery/stm32f769i-discovery.ld
endif
GLOBAL_INCLUDES += . \
                   config/ \
                   drivers/
