...
GLOBAL_LDFLAGS += -L --scatter=platform/board/board_legacy/stm32f103rb-nucleo/stm32f103rb-nucleo.sct
else ifeq ($(COMPILER), iar)
$(NAME)_SOURCES += startup/startup_stm32f103xb_iar.s
GLOBAL_LDFLAGS += --config platform/board/board_legacy/stm32f103rb-nucleo/stm32f103xb_flash.icf
else
#GLOBAL_CFLAGS += -DUSE_DIRECT_UART_PUTC
$(NAME)_SOURCES += startup/startup_stm32f103xb.s
GLOBAL_LDFLAGS += -T platform/board/board_legacy/stm32f103rb-nucleo/STM32F103RBTx_FLASH.ld
endif
