...
linux_only_targets="coapapp das_app helloworld http2app httpclient_app id2_app itls_app linkkit_gateway linkkitapp lwm2mapp meshapp mqttapp otaapp prov_app  udata_demo.sensor_cloud_demo udata_demo.sensor_local_demo udataapp ulocation.baseapp yts"
