...
$(NAME)_COMPONENTS += $(HOST_MCU_FAMILY) newlib_stub kernel_init netmgr cli yloop fatfs
...
ifneq ($(no_with_xip),1)
GLOBAL_LDFLAGS += -T platform/board/board_legacy/xr871evb/xr871-xip.ld
else
GLOBAL_LDFLAGS += -T platform/board/board_legacy/xr871evb/xr871.ld
endif
