...
linux_only_targets="at_app blink coapapp dk.dk_audio dk.dk_camera dk.dk_gui dk.dk_qr helloworld http2app httpapp httpclient_app jsengine_app linkkit_gateway linkkitapp lwm2m_app modbus_app mqttapp otaapp sal_app udata_demo.sensor_cloud_demo udata_demo.sensor_local_demo udata_demo.udata_cloud_demo udata_demo.udata_local_demo udataapp ulocation.baseapp ulog_app websoc_app wifi_at_app yloop_app yts"
