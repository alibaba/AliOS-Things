NAME := board_numaker-pfm-nano130

$(NAME)_MBINS_TYPE := kernel
$(NAME)_VERSION    := 1.0.1
$(NAME)_SUMMARY    := configuration for board numaker-pfm-nano130
MODULE             := 1062
HOST_ARCH          := Cortex-M0
...
GLOBAL_LDFLAGS  += -T platform/board/board_legacy/numaker-pfm-nano130/NANO130.ld
...
CONFIG_SYSINFO_PRODUCT_MODEL := ALI_AOS_NUMAKER_NANO130
