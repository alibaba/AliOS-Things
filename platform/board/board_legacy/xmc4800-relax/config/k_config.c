...
#else /* GCC */
extern void         *Heap_Bank1_End;
extern void         *Heap_Bank1_Start;
...
void aos_heap_set()
{
    g_mm_region[0].start = (uint8_t*)&Heap_Bank1_Start;
    g_mm_region[0].len   =
        ((uint8_t*)&Heap_Bank1_End - (uint8_t*)&Heap_Bank1_Start) - RHINO_CONFIG_SYSTEM_STACK_SIZE;
}
#endif
#endif
