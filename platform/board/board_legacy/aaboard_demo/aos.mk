...
GLOBAL_LDFLAGS += -L --scatter=platform/board/board_legacy/aaboard_demo/aaboard_demo.sct
else ifeq ($(COMPILER), iar)
$(NAME)_SOURCES    += startup/startup_iar.s
GLOBAL_LDFLAGS += --config platform/board/board_legacy/aaboard_demo/aaboard_demo.icf
else
$(NAME)_SOURCES    += startup/startup_gcc.s
GLOBAL_LDFLAGS += -T platform/board/board_legacy/aaboard_demo/aaboard_demo.ld
endif
