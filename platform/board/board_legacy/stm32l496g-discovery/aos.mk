...
ifeq ($(COMPILER),armcc)
GLOBAL_LDFLAGS += -L --scatter=platform/board/board_legacy/stm32l496g-discovery/STM32L496.sct
else ifeq ($(COMPILER),iar)
GLOBAL_LDFLAGS += --config platform/board/board_legacy/stm32l496g-discovery/STM32L496.icf
else
GLOBAL_LDFLAGS += -T platform/board/board_legacy/stm32l496g-discovery/STM32L496AGIx_FLASH.ld
endif
