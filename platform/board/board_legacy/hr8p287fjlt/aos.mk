...
$(NAME)_COMPONENTS += $(HOST_MCU_FAMILY) newlib_stub network
...
GLOBAL_LDFLAGS += -L --scatter=platform/board/board_legacy/hr8p287fjlt/hr8p287.sct
endif
...
CONFIG_SYSINFO_PRODUCT_MODEL := ALI_AOS_HR8P287FJLT
CONFIG_SYSINFO_DEVICE_NAME   := HR8P287
