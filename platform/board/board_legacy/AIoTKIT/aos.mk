...
ifeq ($(COMPILER),armcc)
GLOBAL_LDFLAGS += -L --scatter=platform/board/board_legacy/AIoTKIT/STM32L476RGTx_FLASH.sct
else ifeq ($(COMPILER),iar)
GLOBAL_LDFLAGS += --config platform/board/board_legacy/AIoTKIT/stm32l476xx_flash.icf
else
GLOBAL_LDFLAGS += -T platform/board/board_legacy/AIoTKIT/STM32L476RGTx_FLASH.ld
endif
