...
linux_only_targets="blink coapapp helloworld http2app jsengine_app linkkit_gateway linkkitapp modbus_app mqttapp otaapp udata_demo.sensor_cloud_demo udata_demo.sensor_local_demo udata_demo.udata_cloud_demo udata_demo.udata_local_demo udataapp ulocation.baseapp yts"
