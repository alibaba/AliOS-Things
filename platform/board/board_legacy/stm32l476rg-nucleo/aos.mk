NAME := board_stm32l476rg-nucleo

$(NAME)_MBINS_TYPE := kernel
$(NAME)_VERSION    := 1.0.1
$(NAME)_SUMMARY    := configuration for board stm32l476rg-nucleo
MODULE             := 1062
HOST_ARCH          := Cortex-M4
...
ifeq ($(COMPILER),armcc)
GLOBAL_LDFLAGS += -L --scatter=platform/board/board_legacy/stm32l476rg-nucleo/STM32L476RGTx_FLASH.sct
else ifeq ($(COMPILER),iar)
GLOBAL_LDFLAGS += --config platform/board/board_legacy/stm32l476rg-nucleo/stm32l476xx_flash.icf
else
GLOBAL_LDFLAGS += -T platform/board/board_legacy/stm32l476rg-nucleo/STM32L476RGTx_FLASH.ld
endif
