...
$(NAME)_COMPONENTS += $(HOST_MCU_FAMILY) kernel_init network sensor
...
ifeq ($(COMPILER),armcc)
GLOBAL_LDFLAGS += -L --scatter=platform/board/board_legacy/starterkit/STM32L433.sct
else ifeq ($(COMPILER),iar)
GLOBAL_LDFLAGS += --config platform/board/board_legacy/starterkit/STM32L433.icf
else
GLOBAL_LDFLAGS += -T platform/board/board_legacy/starterkit/STM32L433RCTxP_FLASH.ld
endif
