...
GLOBAL_LDFLAGS += -L --scatter=platform/board/board_legacy/stm32f091rc-nucleo/stm32f091rc-nucleo.sct
else ifeq ($(COMPILER), iar)
$(NAME)_SOURCES += startup/startup_stm32f091xc_iar.s
GLOBAL_LDFLAGS += --config platform/board/board_legacy/stm32f091rc-nucleo/stm32f091xc_flash.icf
else
#GLOBAL_CFLAGS += -DUSE_DIRECT_UART_PUTC
$(NAME)_SOURCES += startup/startup_stm32f091xc.s
GLOBAL_LDFLAGS += -T platform/board/board_legacy/stm32f091rc-nucleo/STM32F091RCTx_FLASH.ld
endif
...
$(NAME)_KEIL_DEVICE = STM32F091RCTx
