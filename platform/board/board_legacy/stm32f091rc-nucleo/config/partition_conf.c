...
/*The flash size is 256KB, 0x08000000~0x0801FFFF*/
void flash_partition_init(void)
{
    ...
    hal_partitions[HAL_PARTITION_APPLICATION].partition_length           = 0x3B000; //236k bytes
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_1].partition_start_addr       = 0x0803B000;
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_2].partition_start_addr       = 0x0803C000;
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_3].partition_start_addr       = 0x0803E000;
