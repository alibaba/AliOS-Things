...
GLOBAL_LDFLAGS += -T ./platform/board/developerkit/bootloader/STM32L496VGTx_FLASH_bootloader.ld

CONFIG_SYSINFO_PRODUCT_MODEL := ALI_AOS_developerkit_2ndboot
CONFIG_SYSINFO_DEVICE_NAME := developerkit_2ndboot

EXTRA_TARGET_MAKEFILES +=  ./platform/board/developerkit/gen_image_bin.mk
...
include ./platform/board/developerkit/irda_hal/irda_hal.mk
endif

ifeq ($(ENABLE_CAMERA_HAL),1)
include ./platform/board/developerkit/camera_hal/camera_hal.mk
endif

ifeq ($(ENABLE_AUDIO_HAL),1)
include ./platform/board/developerkit/audio_hal/audio_hal.mk
endif
...
ifeq ($(MBINS),)
GLOBAL_LDFLAGS += -T platform/board/developerkit/STM32L496VGTx_FLASH.ld
else ifeq ($(MBINS),app)
ifneq ($(MBINS_APP),)
GLOBAL_LDFLAGS += -T platform/board/developerkit/$(MBINS_APP).ld
else
GLOBAL_LDFLAGS += -T platform/board/developerkit/STM32L496VGTx_FLASH_app.ld
endif
else ifeq ($(MBINS),kernel)
GLOBAL_LDFLAGS += -T platform/board/developerkit/STM32L496VGTx_FLASH_kernel.ld
endif
endif
endif
