...
ifeq ($(COMPILER),armcc)
GLOBAL_LDFLAGS += -L --scatter=platform/board/stm32f429zi-mk/STM32F429ZITx.sct
else ifeq ($(COMPILER),iar)
GLOBAL_LDFLAGS += --config platform/board/stm32f429zi-mk/STM32F429.icf
else
ifeq ($(MBINS),)
GLOBAL_LDFLAGS += -T platform/board/stm32f429zi-mk/STM32F429ZITx_FLASH.ld
else ifeq ($(MBINS),kernel)
GLOBAL_LDFLAGS += -T platform/board/stm32f429zi-mk/STM32F429ZITx_FLASH_kernel.ld
else ifeq ($(MBINS),app)
ifeq ($(ENABLE_USPACE),1)
GLOBAL_LDFLAGS += -T platform/board/stm32f429zi-mk/$(MBINS_APP).ld
else
GLOBAL_LDFLAGS += platform/board/stm32f429zi-mk/STM32F429ZITx_FLASH_app.ld
endif
endif
endif
