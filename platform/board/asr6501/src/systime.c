...
void SysTimeSet( SysTime_t sysTime )
{
    ...
    #endif
    aos_lrwan_time_itf.set_sys_time(sysTime.Seconds, sysTime.SubSeconds);
}
...
SysTime_t SysTimeGet( void )
{
    ...
    #endif
//    aos_lrwan_time_itf.get_sys_time(sysTime.Seconds, sysTime.SubSeconds);
//    return sysTime;
    SysTime_t sysTime = { 0 };

    sysTime.Seconds = aos_lrwan_time_itf.get_sys_time( ( uint16_t* )&sysTime.SubSeconds );
