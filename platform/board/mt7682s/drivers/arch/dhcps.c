...
//	dump_client_table();
	...
	char *pstr;
	pstr = ip4addr_ntoa(&(pnetif->ip_addr));
	printf("pstr = %s\r\n",pstr);
	dhcps_pcb = udp_new(); 
	if (dhcps_pcb == NULL) {
