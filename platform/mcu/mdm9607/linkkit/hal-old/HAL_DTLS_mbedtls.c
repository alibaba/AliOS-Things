...
#define platform_trace(format, ...)  printf(LOG_TAG format, ##__VA_ARGS__)
#define platform_info(format, ...)   printf(LOG_TAG format, ##__VA_ARGS__)
#define platform_err(format, ...)    printf(LOG_TAG format, ##__VA_ARGS__)
