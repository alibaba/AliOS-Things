...
#define platform_info(format, ...) printf("%s:%d:"format, __FUNCTION__, __LINE__, ##__VA_ARGS__)
#define platform_err(format, ...) printf("%s:%d"format, __FUNCTION__, __LINE__, ##__VA_ARGS__)
