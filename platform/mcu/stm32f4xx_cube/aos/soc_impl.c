...
lr_timer_t soc_lr_hw_cnt_get(void) { return 0; }
...
size_t soc_intrpt_stack_remain_get(void) { return 0; }
#endif
...
void aos_heap_set() {
  ...
  g_mm_region[0].len = (g_iram1_start + g_iram1_total_size -
                        (size_t)&Image$$RW_IRAM1$$ZI$$Limit) /
                       2;
...
static void soc_print_stack() {
  ...
  end = krhino_cur_task_get()->task_stack_base +
        krhino_cur_task_get()->stack_size;
