...
int main()
{
	...
	//参数2 : 输出文件 
	//参数3:  输入IMAGE类型,0：user image，1：flashboot
...
int main(int argc,char *argv[])
{
	...
	switch (argc)
	{
		...
		default:
			...
			printf("参数2 : 输出文件\n");
			printf("参数3:  输入IMAGE类型,0：user image，1：flashboot，2：secboot\n");
			printf("参数4:  输入压缩类型标志，0：非压缩，1：压缩\n");
			printf("参数5:  版本号文件\n");
			printf("参数6： 输入image存放位置\n");
			printf("参数7： 输入原始image文件\n");
			printf("参数8： 输入解压到FLASH的存放位置\n");
			return -1;
