...
#define SPI_DMA_CMD_ADDR 		((u32)(0x20029000))
#define SPI_DMA_BUF_ADDR		((u32)(0x20029020))
#define SPI_DMA_BUF_MAX_SIZE	(0x2002B000- SPI_DMA_BUF_ADDR)

#define SPI_DMA_CMD_MAX_SIZE (SPI_DMA_BUF_ADDR - SPI_DMA_CMD_ADDR)
  /** after 0x61800, used for slave spi */
