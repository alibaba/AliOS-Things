...
LDSCRIPT_S  = $(PROJ_DIR)/ld/lite_ilm_flash.lds.S
else
...
$(error please trun on HTTPC_EN to enable OTA feature.)
endif
ifeq ($(strip $(TFTP_EN)), 0)
$(error please trun on TFTP_EN to enable OTA feature.)
endif
IMPORT_DIR 		+= components/tools/ota_api
endif
...
CFLAGS 		+=  -DMINIMAL_STACK_SIZE=128
AFLAGS 		+=  -DMINIMAL_STACK_SIZE=128
...
ifeq ($(strip $(SUPPORT_UASCENT_USER_CFG)), 1)
CFLAGS          += -DSUPPORT_UASCENT_USER_CFG
endif
