...
/*-----------------------------------------------------------*/
	...
	#if ( portSTACK_GROWTH > 0 )
		pucStackByte -= sizeof( StackType_t );
	#else
		pucStackByte += sizeof( StackType_t );
	#endif
...
uint32_t uxTaskStackBase(void* taskHandle)
{
	return (uint32_t)(((TCB_t*)taskHandle)->pxStack);
}

//uint32_t uxTaskStackSize(void* handle)
//{
//	return (((TCB_t*)handle)->uxSizeOfStack);
//}

void vTaskSetUserInfo(void* taskHandle, void* userInfo)
{
	((TCB_t*)taskHandle)->pvUserInfo = userInfo;
}

void vTaskGetUserInfo(void* taskHandle, void** userInfo)
{
	*userInfo = ((TCB_t*)taskHandle)->pvUserInfo;
}
