HOST_OPENOCD := MKL82Z7
NAME := mkl82z7impl

$(NAME)_TYPE := kernel

$(NAME)_COMPONENTS += platform/arch/arm/armv6m
$(NAME)_COMPONENTS += rhino libc rhino.fs.kv middleware.common cli rhino.vfs digest_algorithm
...
GLOBAL_LDFLAGS += -T platform/mcu/mkl82z7/gcc/MKL82Z128xxx7_flash.ld
...
$(NAME)_SOURCES     += ./system_MKL82Z7.c
$(NAME)_SOURCES     += ./gcc/startup_MKL82Z7.S
