...
static int32_t usart_config(uart_dev_t *uart)
{
    ...
    usart_stop_bits_e stopbits = STOP_BITS_1;
    ...
    ret = csi_usart_config_flowctrl(usart_dev->usart_handle, uart->config.flow_control, (int32_t)NULL, (int32_t)NULL);
...
int32_t hal_uart_init(uart_dev_t *uart)
{
    ...
    usart_dev->usart_handle = csi_usart_initialize(CONSOLE_TXD, CONSOLE_RXD, (usart_event_cb_t)usart_event_cb_fun, NULL);
