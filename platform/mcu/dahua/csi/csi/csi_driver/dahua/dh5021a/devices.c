...
const sg_timer_config[CONFIG_TIMER_NUM] = {
    {DH5021A_TIM0_BASE, TIM0_IRQn},
    {DH5021A_TIM1_BASE, TIM1_IRQn},
    {DH5021A_TIM2_BASE, TIM2_IRQn},
    {DH5021A_TIM3_BASE, TIM3_IRQn}
...
const sg_iic_config[CONFIG_IIC_NUM] = {
    {DH5021A_I2C0_BASE, I2C0_IRQn},
    {DH5021A_I2C1_BASE, I2C1_IRQn},
    {DH5021A_I2C2_BASE, I2C0_IRQn},
    {DH5021A_I2C3_BASE, I2C1_IRQn}
};
...
{
    *base = sg_iic_config[scl].base;
    *irq = sg_iic_config[scl].irq;
