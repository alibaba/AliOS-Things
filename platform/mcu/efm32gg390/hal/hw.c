...
extern hal_wifi_module_t aos_wifi_module_cc3100;


void hw_start_hal(void)
{
    printf("start-----------hal\n");
#if defined(DEV_SAL_CC3100)
    printf("hal_wifi_register_module\n");
    extern hal_wifi_module_t aos_wifi_module_cc3100;
    hal_wifi_register_module(&aos_wifi_module_cc3100);
#endif
