...
** History:
**
**   - 2018-05-02  0.1   Lux First version.
**
******************************************************************************/
...
typedef struct
{
    __IO uint32_t SQR_RESULT0               :12;
} stc_adc_sqr_result0_field_t;

typedef struct
{
    __IO uint32_t SQR_RESULT1               :12;
} stc_adc_sqr_result1_field_t;

typedef struct
{
    __IO uint32_t SQR_RESULT2               :12;
} stc_adc_sqr_result2_field_t;

typedef struct
{
    __IO uint32_t SQR_RESULT3               :12;
} stc_adc_sqr_result3_field_t;

typedef struct
{
    __IO uint32_t SQR_RESULT4               :12;
} stc_adc_sqr_result4_field_t;

typedef struct
{
    __IO uint32_t SQR_RESULT5               :12;
} stc_adc_sqr_result5_field_t;

typedef struct
{
    __IO uint32_t SQR_RESULT6               :12;
} stc_adc_sqr_result6_field_t;

typedef struct
{
    __IO uint32_t SQR_RESULT7               :12;
} stc_adc_sqr_result7_field_t;

typedef struct
{
    __IO uint32_t SQR_RESULT8               :12;
} stc_adc_sqr_result8_field_t;

typedef struct
{
    __IO uint32_t SQR_RESULT9               :12;
} stc_adc_sqr_result9_field_t;

typedef struct
{
    __IO uint32_t SQR_RESULT10              :12;
} stc_adc_sqr_result10_field_t;

typedef struct
{
    __IO uint32_t SQR_RESULT11              :12;
} stc_adc_sqr_result11_field_t;

typedef struct
{
    __IO uint32_t SQR_RESULT12              :12;
} stc_adc_sqr_result12_field_t;

typedef struct
{
    __IO uint32_t SQR_RESULT13              :12;
} stc_adc_sqr_result13_field_t;

typedef struct
{
    __IO uint32_t SQR_RESULT14              :12;
} stc_adc_sqr_result14_field_t;

typedef struct
{
    __IO uint32_t SQR_RESULT15              :12;
} stc_adc_sqr_result15_field_t;

typedef struct
{
    __IO uint32_t JQR_RESULT0               :12;
} stc_adc_jqr_result0_field_t;

typedef struct
{
    __IO uint32_t JQR_RESULT1               :12;
} stc_adc_jqr_result1_field_t;

typedef struct
{
    __IO uint32_t JQR_RESULT2               :12;
} stc_adc_jqr_result2_field_t;

typedef struct
{
    __IO uint32_t JQR_RESULT3               :12;
} stc_adc_jqr_result3_field_t;
...
typedef struct
{
    ...
    __IO uint32_t PB12                      : 1;
    __IO uint32_t PB14                      : 1;
} stc_adc_ext_trigger1_field_t;

typedef struct
{
    __IO uint32_t START                     : 1;
} stc_adc_slg_start_field_t;

typedef struct
{
    __IO uint32_t START                     : 1;
} stc_adc_sqr_start_field_t;

typedef struct
{
    __IO uint32_t START                     : 1;
} stc_adc_jqr_start_field_t;
...
typedef struct
{
    ...
    __IO uint32_t TRIGSEL                   : 6;
    __IO uint32_t START                     : 1;
    __IO uint32_t HALT                      : 1;
    __IO uint32_t EN                        : 1;
} stc_dma_a0cr_field_t;
...
} stc_dma_b0cr_field_t;

typedef struct
{
    __IO uint32_t SRCADR0                   :32;
} stc_dma_srcadr0_field_t;

typedef struct
{
    __IO uint32_t DSTADR0                   :32;
} stc_dma_dstadr0_field_t;
...
typedef struct
{
    ...
    __IO uint32_t WIDTH                     : 2;
    __IO uint32_t MODE                      : 2;
} stc_dma_b1cr_field_t;

typedef struct
{
    __IO uint32_t SRCADR0                   :32;
} stc_dma_srcadr1_field_t;

typedef struct
{
    __IO uint32_t DSTADR0                   :32;
} stc_dma_dstadr1_field_t;
...
typedef struct
{
    ...
    __IO uint32_t RESINSEL                  : 2;
} stc_opa_op0cr_field_t;
...
{
    __IO uint32_t CNT                       :16;
} stc_tim_cnter_field_t;

typedef struct
{
    __IO uint32_t PERA                      :16;
} stc_tim_perar_field_t;

typedef struct
{
    __IO uint32_t PERB                      :16;
} stc_tim_perbr_field_t;

typedef struct
{
    __IO uint32_t GCMA                      :16;
} stc_tim_gcmar_field_t;

typedef struct
{
    __IO uint32_t GCMB                      :16;
} stc_tim_gcmbr_field_t;

typedef struct
{
    __IO uint32_t GCMC                      :16;
} stc_tim_gcmcr_field_t;

typedef struct
{
    __IO uint32_t GCMD                      :16;
} stc_tim_gcmdr_field_t;

typedef struct
{
    __IO uint32_t SCMA                      :16;
} stc_tim_scmar_field_t;

typedef struct
{
    __IO uint32_t SCMB                      :16;
} stc_tim_scmbr_field_t;

typedef struct
{
    __IO uint32_t DTUA                      :16;
} stc_tim_dtuar_field_t;

typedef struct
{
    __IO uint32_t DTDA                      :16;
} stc_tim_dtdar_field_t;
...
typedef struct
{
    ...
    __IO uint32_t UDFF                      : 1;
    __IO uint32_t DTEF                      : 1;
    __IO uint32_t CMSAF                     : 1;
    __IO uint32_t CMSBF                     : 1;
...
} stc_tim_aossr_field_t;

typedef struct
{
    __IO uint32_t FBRAKE                    : 1;
    __IO uint32_t FSAME                     : 1;
} stc_tim_aoscl_field_t;
...
typedef struct
{
    ...
    union
    {
        ...
        stc_adc_sqr_result0_field_t SQR_RESULT0_f;
    };
    union
    {
        __IO uint32_t SQR_RESULT1;
        stc_adc_sqr_result1_field_t SQR_RESULT1_f;
    };
    union
    {
        __IO uint32_t SQR_RESULT2;
        stc_adc_sqr_result2_field_t SQR_RESULT2_f;
    };
    union
    {
        __IO uint32_t SQR_RESULT3;
        stc_adc_sqr_result3_field_t SQR_RESULT3_f;
    };
    union
    {
        __IO uint32_t SQR_RESULT4;
        stc_adc_sqr_result4_field_t SQR_RESULT4_f;
    };
    union
    {
        __IO uint32_t SQR_RESULT5;
        stc_adc_sqr_result5_field_t SQR_RESULT5_f;
    };
    union
    {
        __IO uint32_t SQR_RESULT6;
        stc_adc_sqr_result6_field_t SQR_RESULT6_f;
    };
    union
    {
        __IO uint32_t SQR_RESULT7;
        stc_adc_sqr_result7_field_t SQR_RESULT7_f;
    };
    union
    {
        __IO uint32_t SQR_RESULT8;
        stc_adc_sqr_result8_field_t SQR_RESULT8_f;
    };
    union
    {
        __IO uint32_t SQR_RESULT9;
        stc_adc_sqr_result9_field_t SQR_RESULT9_f;
    };
    union
    {
        __IO uint32_t SQR_RESULT10;
        stc_adc_sqr_result10_field_t SQR_RESULT10_f;
    };
    union
    {
        __IO uint32_t SQR_RESULT11;
        stc_adc_sqr_result11_field_t SQR_RESULT11_f;
    };
    union
    {
        __IO uint32_t SQR_RESULT12;
        stc_adc_sqr_result12_field_t SQR_RESULT12_f;
    };
    union
    {
    ...
    union
    {
        __IO uint32_t SQR_RESULT14;
        stc_adc_sqr_result14_field_t SQR_RESULT14_f;
    };
    union
    {
        __IO uint32_t SQR_RESULT15;
        stc_adc_sqr_result15_field_t SQR_RESULT15_f;
    };
    union
    {
        __IO uint32_t JQR_RESULT0;
        stc_adc_jqr_result0_field_t JQR_RESULT0_f;
    };
    union
    {
        __IO uint32_t JQR_RESULT1;
        stc_adc_jqr_result1_field_t JQR_RESULT1_f;
    };
    union
    {
        __IO uint32_t JQR_RESULT2;
        stc_adc_jqr_result2_field_t JQR_RESULT2_f;
    };
    union
    {
        __IO uint32_t JQR_RESULT3;
        stc_adc_jqr_result3_field_t JQR_RESULT3_f;
    };
    union
    {
    ...
    union
    {
        __IO uint32_t EXT_TRIGGER0;
        stc_adc_ext_trigger0_field_t EXT_TRIGGER0_f;
    };
    union
    {
        __IO uint32_t EXT_TRIGGER1;
        stc_adc_ext_trigger1_field_t EXT_TRIGGER1_f;
    };
    union
    {
        __IO uint32_t SLG_START;
        stc_adc_slg_start_field_t SLG_START_f;
    };
    union
    {
        __IO uint32_t SQR_START;
        stc_adc_sqr_start_field_t SQR_START_f;
    };
    union
    {
        __IO uint32_t JQR_START;
        stc_adc_jqr_start_field_t JQR_START_f;
    };
}M0P_ADC_TypeDef;
...
typedef struct
{
    union
    {
        ...
        stc_crc_cr_field_t CRC_CR_f;
    };
    union
    {
        __IO uint32_t CRC_RESULT;
        stc_crc_result_field_t CRC_RESULT_f;
    };
    uint8_t RESERVED2[120];
    union
    {
        __IO uint32_t CRC_DATA;
        stc_crc_data_field_t CRC_DATA_f;
    };
}M0P_CRC_TypeDef;
...
typedef struct
{
    ...
    {
        __IO uint32_t CR;
        stc_dma_cr_field_t CR_f;
    };
    uint8_t RESERVED1[12];
    union
    {
        __IO uint32_t A0CR;
        stc_dma_a0cr_field_t A0CR_f;
    };
    union
    {
        __IO uint32_t B0CR;
        stc_dma_b0cr_field_t B0CR_f;
    };
    union
    {
        __IO uint32_t SRCADR0;
        stc_dma_srcadr0_field_t SRCADR0_f;
    };
    union
    {
        __IO uint32_t DSTADR0;
        stc_dma_dstadr0_field_t DSTADR0_f;
    };
    union
    {
        __IO uint32_t A1CR;
        stc_dma_a1cr_field_t A1CR_f;
    };
    union
    {
        __IO uint32_t B1CR;
        stc_dma_b1cr_field_t B1CR_f;
    };
    union
    {
        __IO uint32_t SRCADR1;
        stc_dma_srcadr1_field_t SRCADR1_f;
    };
    union
    {
        __IO uint32_t DSTADR1;
        stc_dma_dstadr1_field_t DSTADR1_f;
    };
}M0P_DMA_TypeDef;
...
typedef struct
{
    ...
    {
        __IO uint32_t OP0CR;
        stc_opa_op0cr_field_t OP0CR_f;
    };
    union
    {
        __IO uint32_t OP1CR;
        stc_opa_op1cr_field_t OP1CR_f;
    };
    union
    {
        __IO uint32_t OP2CR;
        stc_opa_op2cr_field_t OP2CR_f;
    };
    union
    {
        __IO uint8_t CR;
...
typedef struct
{
    ...
    {
        __IO uint32_t CNTER;
        stc_tim_cnter_field_t CNTER_f;
    };
    union
    {
        __IO uint32_t PERAR;
        stc_tim_perar_field_t PERAR_f;
    };
    union
    {
        __IO uint32_t PERBR;
        stc_tim_perbr_field_t PERBR_f;
    };
    uint8_t RESERVED3[4];
    union
    {
        __IO uint32_t GCMAR;
        stc_tim_gcmar_field_t GCMAR_f;
    };
    union
    {
        __IO uint32_t GCMBR;
        stc_tim_gcmbr_field_t GCMBR_f;
    };
    union
    {
        __IO uint32_t GCMCR;
        stc_tim_gcmcr_field_t GCMCR_f;
    };
    union
    {
        __IO uint32_t GCMDR;
        stc_tim_gcmdr_field_t GCMDR_f;
    };
    uint8_t RESERVED7[8];
    union
    {
        __IO uint32_t SCMAR;
        stc_tim_scmar_field_t SCMAR_f;
    };
    union
    {
        __IO uint32_t SCMBR;
        stc_tim_scmbr_field_t SCMBR_f;
    };
    uint8_t RESERVED9[16];
    union
    {
        __IO uint32_t DTUAR;
        stc_tim_dtuar_field_t DTUAR_f;
    };
    union
    {
        __IO uint32_t DTDAR;
        stc_tim_dtdar_field_t DTDAR_f;
    };
    uint8_t RESERVED11[8];
    union
    {
        __IO uint32_t GCONR;
        stc_tim_gconr_field_t GCONR_f;
    };
    union
    {
        __IO uint32_t ICONR;
        stc_tim_iconr_field_t ICONR_f;
    };
    union
    {
        __IO uint32_t PCONR;
        stc_tim_pconr_field_t PCONR_f;
    };
    union
    {
        __IO uint32_t BCONR;
        stc_tim_bconr_field_t BCONR_f;
    };
    union
    {
        __IO uint32_t DCONR;
        stc_tim_dconr_field_t DCONR_f;
    };
    uint8_t RESERVED16[4];
    union
    {
        __IO uint32_t FCONR;
        stc_tim_fconr_field_t FCONR_f;
    };
    union
    {
        __IO uint32_t VPERR;
        stc_tim_vperr_field_t VPERR_f;
    };
    union
    {
        __IO uint32_t STFLR;
        stc_tim_stflr_field_t STFLR_f;
    };
    union
    {
        __IO uint32_t HSTAR;
        stc_tim_hstar_field_t HSTAR_f;
    };
    union
    {
        __IO uint32_t HSTPR;
        stc_tim_hstpr_field_t HSTPR_f;
    };
    union
    {
        __IO uint32_t HCELR;
        stc_tim_hcelr_field_t HCELR_f;
    };
    union
    {
        __IO uint32_t HCPAR;
        stc_tim_hcpar_field_t HCPAR_f;
    };
    union
    {
        __IO uint32_t HCPBR;
        stc_tim_hcpbr_field_t HCPBR_f;
    };
    union
    {
        __IO uint32_t HCUPR;
        stc_tim_hcupr_field_t HCUPR_f;
    };
    union
    {
        __IO uint32_t HCDOR;
        stc_tim_hcdor_field_t HCDOR_f;
    };
    ...
    {
        __IO uint32_t AOSSR;
        stc_tim_aossr_field_t AOSSR_f;
    };
    union
    {
        __IO uint32_t AOSCL;
        stc_tim_aoscl_field_t AOSCL_f;
    };
    union
    {
        __IO uint32_t PTBKS;
        stc_tim_ptbks_field_t PTBKS_f;
    };
    union
    {
        __IO uint32_t TTRIG;
        stc_tim_ttrig_field_t TTRIG_f;
    };
    union
    {
        __IO uint32_t ITRIG;
        stc_tim_itrig_field_t ITRIG_f;
    };
    union
    {
        __IO uint32_t PTBKP;
        stc_tim_ptbkp_field_t PTBKP_f;
    };
    uint8_t RESERVED35[716];
    union
    {
        __IO uint32_t SSTAR;
        stc_tim_sstar_field_t SSTAR_f;
    };
    union
    {
        __IO uint32_t SSTPR;
        stc_tim_sstpr_field_t SSTPR_f;
    };
    union
    {
        __IO uint32_t SCLRR;
        stc_tim_sclrr_field_t SCLRR_f;
    };
}M0P_TIM4_TypeDef;
...
#define M0P_DMA_BASE                           (M0P_PERIPH_BASE + 0x00021000UL)
...
#define M0P_DMA                                ((M0P_DMA_TypeDef *)0x40021000UL)
...
#define M0P_TIM5                               ((M0P_TIM4_TypeDef *)0x40003400UL)
#define M0P_TIM6                               ((M0P_TIM4_TypeDef *)0x40003800UL)
