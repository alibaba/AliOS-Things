...
#define MCU_CFG_ICLK_HZ             (16000000)
#define MCU_CFG_FCLK_HZ             (16000000)
...
****************************************************************************************/
    ...
    #define MCU_RAM_SIZE_BYTES              (16384)
    #define MCU_DATA_FLASH_SIZE_BYTES       (0)
#elif MCU_CFG_PART_MEMORY_SIZE == 0x6        // "H" parts 
    #define MCU_ROM_SIZE_BYTES              (8192)
    #define MCU_RAM_SIZE_BYTES              (8192)
    #define MCU_DATA_FLASH_SIZE_BYTES       (0)
#else
...
/* RSKRX110 equates for reference. Change to #if 1 if want to use. */
#if 0
#define LED_ON          (0)
#define LED_OFF         (1)
