...
*           18.11.2016 1.10    Added memory sizes for new larger parts
*           02.08.2017 1.20    Moved FLASH_CFG_USE_FIT_BSP == 1 case to r_flash_targets.h.
***********************************************************************************************************************/
...
#define MCU_CFG_ICLK_HZ             (80000000)
...
****************************************************************************************/
#if   MCU_CFG_PART_MEMORY_SIZE == 0xE
...
/* RSKRX24T equates for reference. Change to #if 1 if want to use. */
#if 0
#define LED_ON          (0)
#define LED_OFF         (1)
#define LED0            PORTB.PODR.BIT.B3
#define LED1            PORTE.PODR.BIT.B5
#define LED2            PORT5.PODR.BIT.B3
#define LED3            PORT5.PODR.BIT.B2
#define SW1             PORT1.PIDR.BIT.B0
#define SW2             PORT0.PIDR.BIT.B2
