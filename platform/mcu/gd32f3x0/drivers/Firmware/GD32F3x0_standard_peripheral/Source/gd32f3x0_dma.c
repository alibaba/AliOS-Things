...
/*!
    ...
    \param[in]  channelx: specify which DMA channel 
      \arg        DMA_CHx(x=0..6)
    \param[in]  mwidth: transfer data size of memory
...
/*!
    ...
    \param[in]  channelx: specify which DMA channel 
      \arg        DMA_CHx(x=0..6)
    \param[in]  pwidth: transfer data size of peripheral
...
/*!
    ...
    \param[in]  source: specify which interrupt to enbale
      ...
      \arg        DMA_INT_HTF: channel transfer half finish interrupt
      \arg        DMA_INT_FTF: channel transfer finish interrupt
    \param[out] none
    \retval     none
*/
