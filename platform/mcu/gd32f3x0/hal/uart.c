...
static const uint32_t  s_uart_buffersize_table[] = {128, 128};
static const uint32_t s_uart_periph_table[] = {USART0, USART1};
static const rcu_periph_enum s_uart_clk_table[] = {RCU_USART0, RCU_USART1};
static const uint32_t s_uart_txpin_table[] = {GPIO_PIN_9, GPIO_PIN_2};
static const uint32_t s_uart_rxpin_table[] = {GPIO_PIN_10, GPIO_PIN_3};
static const uint32_t s_uart_gpio_table[] = {GPIOA, GPIOA};
static const rcu_periph_enum s_uart_gpio_clk_table[] = {RCU_GPIOA, RCU_GPIOA};
static const IRQn_Type s_uart_irqn[] = {USART0_IRQn, USART1_IRQn};
