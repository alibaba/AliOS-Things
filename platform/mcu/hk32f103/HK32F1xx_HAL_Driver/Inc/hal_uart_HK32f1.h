...
#ifndef __HAL_UART_HK32L4_H
#define __HAL_UART_HK32L4_H
...
extern void HK32F1_soc_init(void);
extern int32_t hal_uart_send(uart_dev_t *uart, const void *data, uint32_t size, uint32_t timeout);
