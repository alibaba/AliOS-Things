...
extern DSTATUS ff_raw_status (BYTE pdrv);
		case DEV_FLASH1:
		case DEV_FLASH2:	
			return ff_raw_status(pdrv);
#endif
...
#ifdef CONFIG_AOS_FATFS_SUPPORT_RAW_FLASH
extern DSTATUS ff_raw_initialize (BYTE pdrv);
		case DEV_FLASH1:
		case DEV_FLASH2:	
			return ff_raw_initialize(pdrv);
#endif
...
#ifdef CONFIG_AOS_FATFS_SUPPORT_RAW_FLASH
extern DRESULT ff_raw_read (BYTE pdrv, BYTE *buff, DWORD sector, UINT count);
		case DEV_FLASH1:
		case DEV_FLASH2:	
			return ff_raw_read(pdrv, buff, sector, count);
#endif
...
#ifdef CONFIG_AOS_FATFS_SUPPORT_RAW_FLASH
extern DRESULT ff_raw_write (BYTE pdrv, const BYTE *buff, DWORD sector, UINT count);
		case DEV_FLASH1:
		case DEV_FLASH2:	
			return ff_raw_write(pdrv, buff, sector, count);
#endif
...
#ifdef CONFIG_AOS_FATFS_SUPPORT_RAW_FLASH
extern DRESULT ff_raw_ioctl (BYTE pdrv, BYTE cmd, void *buff);
		case DEV_FLASH1:
		case DEV_FLASH2:	
			return ff_raw_ioctl(pdrv, cmd, buff);
#endif
