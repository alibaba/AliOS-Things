...
/**
  ...
  */
esp_err_t esp_register_freertos_idle_hook_for_cpu(esp_freertos_idle_cb_t new_idle_cb, espos_basetype_t cpuid);
...
/**
  ...
  *     - ESP_ERR_INVALID_ARG: cpuid is invalid
  */
esp_err_t esp_register_freertos_tick_hook_for_cpu(esp_freertos_tick_cb_t new_tick_cb, espos_basetype_t cpuid);
...
/**
  ...
  * @param[in]  cpuid           id of the core
  */
void esp_deregister_freertos_idle_hook_for_cpu(esp_freertos_idle_cb_t old_idle_cb, espos_basetype_t cpuid);
...
/**
  ...
  * @param[in]  cpuid           id of the core
  */
void esp_deregister_freertos_tick_hook_for_cpu(esp_freertos_tick_cb_t old_tick_cb, espos_basetype_t cpuid);
