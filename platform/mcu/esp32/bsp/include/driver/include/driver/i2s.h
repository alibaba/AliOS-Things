 ...
 */
esp_err_t i2s_driver_install(i2s_port_t i2s_num, const i2s_config_t *i2s_config, int queue_size, espos_queue_t i2s_queue);
 ...
 */
int i2s_write_bytes(i2s_port_t i2s_num, const void *src, size_t size, espos_tick_t ticks_to_wait) __attribute__ ((deprecated));
 ...
 *     - ESP_ERR_INVALID_ARG  Parameter error
 */
esp_err_t i2s_write(i2s_port_t i2s_num, const void *src, size_t size, size_t *bytes_written, espos_tick_t ticks_to_wait);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
esp_err_t i2s_write_expand(i2s_port_t i2s_num, const void *src, size_t size, size_t src_bits, size_t aim_bits, size_t *bytes_written, espos_tick_t ticks_to_wait);
 ...
 *     - ESP_FAIL  Parameter error
 */
int i2s_read_bytes(i2s_port_t i2s_num, void *dest, size_t size, espos_tick_t ticks_to_wait) __attribute__ ((deprecated));
 ...
 *     - ESP_ERR_INVALID_ARG  Parameter error
 */
esp_err_t i2s_read(i2s_port_t i2s_num, void *dest, size_t size, size_t *bytes_read, espos_tick_t ticks_to_wait);
 ...
 *     - ESP_FAIL Parameter error
 */
int i2s_push_sample(i2s_port_t i2s_num, const void *sample, espos_tick_t ticks_to_wait) __attribute__ ((deprecated));
 ...
 *     - ESP_FAIL Parameter error
 */
int i2s_pop_sample(i2s_port_t i2s_num, void *sample, espos_tick_t ticks_to_wait) __attribute__ ((deprecated));
