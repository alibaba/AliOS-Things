...
void hal_dma_set_handler(int channelid, uint32_t handler, uint32_t id, uint32_t event)
{
...
void hal_dma_fill_description(int channelid, uint32_t u32Peripheral, uint32_t data_width, uint32_t addr_src, uint32_t addr_dst, int32_t length )
{
