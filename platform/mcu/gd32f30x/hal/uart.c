...
static const uint32_t  s_uart_buffersize_table[] = {128, 128, 128, 128};
...
void dev_uart_init(uart_dev_t *uart)
{
    ...
    gpio_init(s_uart_gpio_table[uart->port], GPIO_MODE_AF_PP, GPIO_OSPEED_50MHZ, s_uart_txpin_table[uart->port]);

    /* connect port to USARTx_Rx */
    gpio_init(s_uart_gpio_table[uart->port], GPIO_MODE_IN_FLOATING, GPIO_OSPEED_50MHZ, s_uart_rxpin_table[uart->port]);
