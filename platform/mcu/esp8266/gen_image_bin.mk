...
gen_standard_images:
	...
	cd $(BIN_DIR) && $(SETENV) ESP8266_NM=${NM} && python ../../../platform/mcu/esp8266/tools/gen_appbin.py $(CLEANED_BUILD_STRING)$(RADIXPOINT)$(BINSTYPE_LOWER)$(LINK_OUTPUT_SUFFIX) 2 2 0 5 && cd -
