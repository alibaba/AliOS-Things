...
STRUCT_PACKED struct eap_tlv_hdr {
	be16 tlv_type;
	be16 length;
}GCC_PACKED;

STRUCT_PACKED struct eap_tlv_nak_tlv {
	be16 tlv_type;
	be16 length;
	be32 vendor_id;
	be16 nak_type;
...
STRUCT_PACKED struct eap_tlv_result_tlv {
	be16 tlv_type;
	be16 length;
	be16 status;
}GCC_PACKED;
...
STRUCT_PACKED struct eap_tlv_intermediate_result_tlv {
	be16 tlv_type;
	be16 length;
	be16 status;
...
STRUCT_PACKED struct eap_tlv_crypto_binding_tlv {
	be16 tlv_type;
	be16 length;
	u8 reserved;
	u8 version;
...
STRUCT_PACKED struct eap_tlv_pac_ack_tlv {
	be16 tlv_type;
	be16 length;
	be16 pac_type;
	be16 pac_len;
...
STRUCT_PACKED struct eap_tlv_request_action_tlv {
	be16 tlv_type;
	be16 length;
	be16 action;
}GCC_PACKED;
...
STRUCT_PACKED struct eap_tlv_pac_type_tlv {
