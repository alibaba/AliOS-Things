...
#define INODE_IS_NETWORK(node)    INODE_IS_TYPE(node, VFS_TYPE_NETWORK_DEV)
...
#define INODE_SET_NETWORK(node)    INODE_SET_TYPE(node, VFS_TYPE_NETWORK_DEV)
