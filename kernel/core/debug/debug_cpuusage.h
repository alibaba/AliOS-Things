...
#ifndef DEBUG_CONFIG_CPUUSAGE_MAX_TASK
    #define DEBUG_CPUUSAGE_MAX_TASK  80
#else
    #define DEBUG_CPUUSAGE_MAX_TASK DEBUG_CONFIG_CPUUSAGE_MAX_TASK
#endif

#ifndef DEBUG_CONFIG_CPUUSAGE_FILE_NAME
    #define DEBUG_CPUUSAGE_FILE_NAME "/data/cpuusage"
#else
    #define DEBUG_CPUUSAGE_FILE_NAME DEBUG_CONFIG_CPUUSAGE_FILE_NAME
#endif
