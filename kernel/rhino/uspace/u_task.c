                           ...
                           uint8_t cpu_num, uint8_t cpu_binded)
{
    ...
    task->task_stack  = cpu_task_stack_init(kstack_buf, kstack_size, arg, entry);
    task->utask_stack = cpu_utask_stack_init(ustack_buf, ustack_size);
                        ...
                        uint8_t cpu_num, uint8_t cpu_binded, uint8_t autorun)
{
    ...
    ret = task_create(task, name, arg, pri, ticks, task_stack, stack, entry,
