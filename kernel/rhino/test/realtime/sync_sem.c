...
void rttest_sync_sem(void)
{
    ...
    rttest_aux_show_result(SYNC_SEM_OPERATION_ID, "syn_sem_request", test_count, time_sum_request, time_max_request, time_min_request);
    rttest_aux_show_result(SYNC_SEM_OPERATION_ID, "syn_sem_release", test_count, time_sum_release, time_max_release, time_min_release);
