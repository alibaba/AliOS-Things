...
#define SYS_KRHINO_UPROCESS_JOIN    (K_UPROCESS_BASE + 2)
#define SYS_KRHINO_UPROCESS_RES_GET (K_UPROCESS_BASE + 3)
...
#define SYS_LINKKIT_START                   (LINKKIT_BASE + 0)
#define SYS_LINKKIT_END                     (LINKKIT_BASE + 1)
#define SYS_LINKKIT_DISPATCH                (LINKKIT_BASE + 2)
#define SYS_LINKKIT_YIELD                   (LINKKIT_BASE + 3)
#define SYS_LINKKIT_SET_VALUE               (LINKKIT_BASE + 4)
#define SYS_LINKKIT_GET_VALUE               (LINKKIT_BASE + 5)
#define SYS_LINKKIT_SET_TSL                 (LINKKIT_BASE + 6)
#define SYS_LINKKIT_ANSWER_SERVICE          (LINKKIT_BASE + 7)
#define SYS_LINKKIT_INVOKE_RAW_SERVICE      (LINKKIT_BASE + 8)
#define SYS_LINKKIT_TRIGGER_EVENT           (LINKKIT_BASE + 9)
#define SYS_LINKKIT_POST_PROPERTY           (LINKKIT_BASE + 10)
#define SYS_LINKKIT_SET_OPT                 (LINKKIT_BASE + 11)
#define SYS_LINKKIT_TRY_LEAVE               (LINKKIT_BASE + 12)
#define SYS_LINKKIT_IS_TRY_LEAVE            (LINKKIT_BASE + 13)
#define SYS_LINKKIT_IS_END                  (LINKKIT_BASE + 14)
#define SYS_LINKKIT_TRIGGER_XINFO_OPERATION (LINKKIT_BASE + 15)
#define SYS_LINKKIT_IOCTL                   (LINKKIT_BASE + 16)

#define LINKKIT_END (SYS_LINKKIT_IOCTL)
