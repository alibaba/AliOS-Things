...
void *syscall_tbl[] = {
    ...
    [SYS_KRHINO_TASK_SUSPEND]    = sys_krhino_task_suspend_stub,
    [SYS_KRHINO_TASK_RESUME]     = sys_krhino_task_resume_stub,
#if (RHINO_CONFIG_TASK_WAIT_ABORT > 0)
    [SYS_KRHINO_TASK_WAIT_ABORT] = sys_krhino_task_wait_abort_stub,
#endif
    ...
    [SYS_KRHINO_UPROCESS_JOIN]    = sys_krhino_uprocess_join_stub,
    ...
    [SYS_CLI_UNREGISTER_CMD]  = sys_cli_unregister_command_stub,
    [SYS_CLI_REGISTER_CMDS]   = sys_cli_register_commands_stub,
    [SYS_CLI_UNREGISTER_CMDS] = sys_cli_unregister_commands_stub,
    ...
    [SYS_LWIP_GETADDRINOF]        = sys_lwip_getaddrinfo_stub,
        ...
        /* ---------------- linkkit --------------------*/
#if (CONFIG_LINKKIT_SYSCALL > 0)
    [SYS_LINKKIT_START]                   = sys_linkkit_start_stub,
    [SYS_LINKKIT_END]                     = sys_linkkit_end_stub,
    [SYS_LINKKIT_DISPATCH]                = sys_linkkit_dispatch_stub,
    [SYS_LINKKIT_YIELD]                   = sys_linkkit_yield_stub,
    [SYS_LINKKIT_SET_VALUE]               = sys_linkkit_set_value_stub,
    [SYS_LINKKIT_GET_VALUE]               = sys_linkkit_get_value_stub,
    [SYS_LINKKIT_SET_TSL]                 = sys_linkkit_set_tsl_stub,
    [SYS_LINKKIT_ANSWER_SERVICE]          = sys_linkkit_answer_service_stub,
    [SYS_LINKKIT_INVOKE_RAW_SERVICE]      = sys_linkkit_invoke_raw_service_stub,
    [SYS_LINKKIT_TRIGGER_EVENT]           = sys_linkkit_trigger_event_stub,
    [SYS_LINKKIT_POST_PROPERTY]           = sys_linkkit_post_property_stub,
    [SYS_LINKKIT_SET_OPT]                 = sys_linkkit_set_opt_stub,
    [SYS_LINKKIT_TRY_LEAVE]               = sys_linkkit_try_leave_stub,
    [SYS_LINKKIT_IS_TRY_LEAVE]            = sys_linkkit_is_try_leave_stub,
    [SYS_LINKKIT_IS_END]                  = sys_linkkit_is_end_stub,
    [SYS_LINKKIT_TRIGGER_XINFO_OPERATION] = sys_linkkit_trigger_xinfo_operate_stub,
    [SYS_LINKKIT_IOCTL]                   = sys_linkkit_ioctl_stub,
#endif /* CONFIG_LINKKIT_SYSCALL */
