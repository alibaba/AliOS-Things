...
static void* prep_queue_msg[CONFIG_BLUETOOTH_ATT_PREPARE_COUNT];
...
#if CONFIG_BLUETOOTH_ATT_PREPARE_COUNT > 0
	k_fifo_init(&att->prep_queue,"prep queue",(void **)&prep_queue_msg,CONFIG_BLUETOOTH_ATT_PREPARE_COUNT);
#endif
