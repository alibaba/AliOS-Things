...
#include <stdbool.h>
    ...
    typedef struct _lv_anim_t
    {
        ...
        int16_t act_time; /*Current time in animation. Set to negative to make
                             delay.*/
    ...
    /**
     * Calculate the time of an animation with a given speed and the start and
     * end values
    ...
    /**
     * Calculate the current value of an animation applying linear
     * characteristic
