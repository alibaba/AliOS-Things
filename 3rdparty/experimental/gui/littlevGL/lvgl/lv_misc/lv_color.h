...
#error "Invalid LV_COLOR_DEPTH in misc_conf.h! Set it to 1, 8, 16 or 24!"
     ...
     * - When converting to bigger color type the LSB weight of 1 LSB is
     * calculated E.g. 16 bit Red has 5 bits 8 bit Red has 2 bits
     *        ----------------------
...
#if LV_COLOR_DEPTH != 1
        ret.red =
          (uint16_t)((uint16_t)c1.red * mix + (c2.red * (255 - mix))) >> 8;
        ret.green =
...
#define LV_COLOR_MAKE(r8, g8, b8) \
    ((lv_color_t){ (b8 >> 7 | g8 >> 7 | r8 >> 7) })
#elif LV_COLOR_DEPTH == 8
#define LV_COLOR_MAKE(r8, g8, b8) \
    ((lv_color_t){ { b8 >> 6, g8 >> 5, r8 >> 5 } })
#elif LV_COLOR_DEPTH == 16
#define LV_COLOR_MAKE(r8, g8, b8) \
    ((lv_color_t){ { b8 >> 3, g8 >> 2, r8 >> 3 } })
#elif LV_COLOR_DEPTH == 24
#define LV_COLOR_MAKE(r8, g8, b8) \
...
#if LV_COLOR_DEPTH == 1
#define LV_COLOR_MAKE(r8, g8, b8) \
    ((lv_color_t){ (r8 >> 7 | g8 >> 7 | b8 >> 7) })
#elif LV_COLOR_DEPTH == 8
#define LV_COLOR_MAKE(r8, g8, b8) \
    ((lv_color_t){ { r8 >> 6, g8 >> 5, b8 >> 5 } })
#elif LV_COLOR_DEPTH == 16
#define LV_COLOR_MAKE(r8, g8, b8) \
    ((lv_color_t){ { r8 >> 3, g8 >> 2, b8 >> 3 } })
#elif LV_COLOR_DEPTH == 24
#define LV_COLOR_MAKE(r8, g8, b8) \
