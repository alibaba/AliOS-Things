...
#include "lv_fonts/lv_symbol_def.h"
    ...
    /**
     * Create a pair from font name and font dsc. get function. After it
     * 'font_get' can be used for this font
    ...
    /**
     * Generic bitmap get function used in 'font->get_bitmap' when the font
     ...
     */
    int16_t lv_font_get_width_continuous(const lv_font_t *font,
                                         uint32_t         unicode_letter);

    /**
     * Generic glyph width get function used in 'font->get_bitmap' when the font
     * NOT contains all characters in the range (sparse)
     * @param font pointer to font
     * @param unicode_letter an unicode letter which width should be get
     * @return width of the glyph or -1 if not found
     */
    int16_t lv_font_get_width_sparse(const lv_font_t *font,
                                     uint32_t         unicode_letter);
