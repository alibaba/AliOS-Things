...
#include "../lv_misc/lv_color.h"
    ...
    typedef struct _disp_drv_t
    {
        ...
        void (*mem_blend)(lv_color_t *dest, const lv_color_t *src,
     ...
     * fully cover)
     */
    void lv_disp_mem_blend(lv_color_t *dest, const lv_color_t *src,
                           uint32_t length, lv_opa_t opa);
     ...
     * @return false: 'mem_blend' is not supported in the driver; true:
     * 'mem_blend' is supported in the driver
     */
    bool lv_disp_is_mem_blend_supported(void);

    /**
     * Shows if memory fill (by GPU) is supported or not
     * @return false: 'mem_fill' is not supported in the drover; true:
     * 'mem_fill' is supported in the driver
     */
