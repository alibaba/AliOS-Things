...
#include "../lv_misc/lv_area.h"
    ...
    typedef enum
    {
        ...
        LV_INDEV_TYPE_BUTTON,  /*External (hardware button) which is assinged to
                                  a specific point of the screen*/
    } lv_hal_indev_type_t;
    ...
    typedef struct
    {
        union
        {
            ...
            uint32_t
              btn; /*For LV_INDEV_TYPE_BUTTON the currently pressed button*/
        };
    ...
    typedef struct
    {
        ...
        bool (*read)(lv_indev_data_t
                       *data); /*Function pointer to read data. Return 'true' if
                                  there is still data to be read (buffered)*/
        void *user_data;       /*Pointer to user defined data, passed in
                                  'lv_indev_data_t' on read*/
    } lv_indev_drv_t;
    ...
    typedef struct _lv_indev_t
    {
        ...
        union
        {
            ...
            lv_point_t
              *btn_points; /*Array points assigned to the button ()screen will
