...
#define LV_GROUP_KEY_ENTER_LONG \
    ...
    typedef struct _lv_group_t
    {
        ...
        lv_group_style_mod_func_t style_mod; /*A function which modifies the
                                                style of the focused object*/
        lv_group_focus_cb_t focus_cb; /*A function to call when a new object is
                                         focused (optional)*/
        lv_style_t
                style_tmp;  /*Stores the modified style of the focused object */
    ...
    /**
     * Set a function for a group which will modify the object's style if it is
     * in focus
     * @param group pointer to a group
    ...
    /**
     * Set a function for a group which will be called when a new object is
     * focused
     * @param group pointer to a group
     ...
     * @return a copy of the input style but modified with the 'style_mod'
     * function
     */
