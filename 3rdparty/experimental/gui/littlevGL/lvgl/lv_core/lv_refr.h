...
#include <stdbool.h>
    ...
    /**
     * Set a function to call after every refresh to announce the refresh time
     * and the number of refreshed pixels
     * @param cb pointer to a callback function (void my_refr_cb(uint32_t
     * time_ms, uint32_t px_num))
     */
