...
#include "../lv_objx/lv_label.h"
    ...
    typedef struct
    {
        ...
        lv_coord_t
          fix_height; /*Height if the ddlist is opened. (0: auto-size)*/
    } lv_ddlist_ext_t;
     ...
     * @param par pointer to an object, it will be the parent of the new drop
     * down list
     ...
     * If 0 then the opened ddlist will be auto. sized else the set height will
     * be applied.
     * @param ddlist pointer to a drop down list
     ...
     */
    static inline void lv_ddlist_set_sb_mode(lv_obj_t    *ddlist,
                                             lv_sb_mode_t mode)
    {
