...
#include "../lv_core/lv_indev.h"
    ...
    typedef enum
    {
        ...
        LV_SB_MODE_AUTO, /*Show scrollbars when the scrollable container is
     ...
     * @param copy pointer to a page object, if not NULL then the new object
     ...
     * @param page pointer to a page object
     * @param h the new height of the scrollable (it ha no effect is vertical
     * fit is enabled)
     */
     ...
     */
    static inline void lv_page_set_scrl_layout(lv_obj_t   *page,
                                               lv_layout_t layout)
    {
    ...
    /**
     * Glue the object to the page. After it the page can be moved (dragged)
    ...
    /**
     * Focus on an object. It ensures that the object will be visible on the
     * page.
     * @param page pointer to a page object
