...
#include "lv_label.h"
    ...
    typedef struct
    {
        ...
        uint16_t
          anim_time; /*Duration of close animation [ms] (0: no animation)*/
    } lv_mbox_ext_t;
     ...
     *                E.g.  a const char *txt[] = {"ok", "close", ""} (Can not
     * be local variable)
     ...
     * @param txt a '\0' terminated character string which will be the message
     * box text
     */
