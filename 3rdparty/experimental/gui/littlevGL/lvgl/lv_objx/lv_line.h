...
#include "../lv_core/lv_obj.h"
    ...
    typedef struct
    {
        ...
        uint8_t auto_size : 1; /*1: set obj. width to x max and obj. height to y
                                  max */
     ...
     * to its points. (set width to x max and height to y max)
     * @param line pointer to a line object
     * @param autosize_en true: auto size is enabled, false: auto size is
     * disabled
     */
     ...
     * @param line pointer to a line object
     * @param yinv_en true: enable the y inversion, false:disable the y
     * inversion
     */
