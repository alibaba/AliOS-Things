...
#include "../lv_objx/lv_page.h"
    ...
    /**
     * Set an action to call when a tab is loaded (Good to create content only
     * if required) lv_tabview_get_act() still gives the current (old) tab (to
     ...
     */
    lv_style_t *lv_tabview_get_style(lv_obj_t          *tabview,
