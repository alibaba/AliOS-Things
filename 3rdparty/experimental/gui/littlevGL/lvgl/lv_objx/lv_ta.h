...
#define LV_TA_CURSOR_LAST (0x7FFF) /*Put the cursor after the last character*/
    ...
    typedef struct
    {
        ...
        {
            lv_style_t
              *style; /*Style of the cursor (NULL to use label's style)*/
            lv_coord_t
     ...
     * @param par pointer to an object, it will be the parent of the new text
     * area
     * @param copy pointer to a text area object, if not NULL then the new
