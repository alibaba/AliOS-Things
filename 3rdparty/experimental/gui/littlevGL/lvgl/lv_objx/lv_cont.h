...
#include "../lv_core/lv_obj.h"
    ...
    typedef struct
    {
        ...
        uint8_t
          hor_fit : 1; /*1: Enable horizontal fit to involve all children*/
        uint8_t
          ver_fit : 1; /*1: Enable horizontal fir to involve all children*/
    } lv_cont_ext_t;
     ...
     * container
     * @param copy pointer to a container object, if not NULL then the new
