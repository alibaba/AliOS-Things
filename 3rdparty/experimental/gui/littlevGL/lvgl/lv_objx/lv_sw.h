...
#include "lv_slider.h"
    ...
    typedef struct
    {
        ...
        lv_style_t *style_knob_on;  /*Style of the knob when the switch is ON
                                       (NULL to use the same as OFF)*/
    ...
    /**
     * Set a function which will be called when the switch is toggled by the
     * user
