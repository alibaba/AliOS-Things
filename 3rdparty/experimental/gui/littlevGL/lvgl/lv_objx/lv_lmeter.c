                             ...
                             lv_design_mode_t mode)
{
    ...
    /*Draw the object*/
        ...
        int16_t level = (int32_t)((int32_t)(ext->cur_value - ext->min_value) *
                                  ext->line_cnt) /
        ...
        for (i = 0; i < ext->line_cnt; i++) {
            ...
            int16_t angle =
              (i * ext->scale_angle) / (ext->line_cnt - 1) + angle_ofs;

            lv_coord_t y_out =
              (int32_t)((int32_t)lv_trigo_sin(angle) * r_out) >> LV_TRIGO_SHIFT;
            lv_coord_t x_out =
              (int32_t)((int32_t)lv_trigo_sin(angle + 90) * r_out) >>
              LV_TRIGO_SHIFT;
            lv_coord_t y_in =
              (int32_t)((int32_t)lv_trigo_sin(angle) * r_in) >> LV_TRIGO_SHIFT;
            lv_coord_t x_in =
              (int32_t)((int32_t)lv_trigo_sin(angle + 90) * r_in) >>
              LV_TRIGO_SHIFT;
