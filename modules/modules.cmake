...
include("${CMAKE_CURRENT_LIST_DIR}/modules-config.cmake")
...
if(MICROPY_PY_DRIVER)
    ...
    list(APPEND MICROPY_INC_MODULES_PORT ${MICROPY_MODULES_PORT_DIR}/../external/amp_adapter/include/peripheral)
    if(HAAS_PLATFORM)
...
if(MICROPY_PY_NETMGR)
    ...
    list(APPEND MICROPY_INC_MODULES_PORT ${MICROPY_MODULES_PORT_DIR}/../external/amp_adapter/include)
endif()
