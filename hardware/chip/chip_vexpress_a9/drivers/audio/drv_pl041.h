...
struct reg_pl041
{
volatile unsigned int  rxcr1;    /* 0x000 */
volatile unsigned int  txcr1;    /* 0x004 */
volatile unsigned int  sr1;      /* 0x008 */
volatile unsigned int  isr1;     /* 0x00c */
volatile unsigned int  iie1;     /* 0x010 */
volatile unsigned int  rxcr2;    /* 0x014 */
volatile unsigned int  txcr2;    /* 0x018 */
volatile unsigned int  sr2;      /* 0x01c */
volatile unsigned int  isr2;     /* 0x020 */
volatile unsigned int  iie2;     /* 0x024 */
volatile unsigned int  rxcr3;    /* 0x028 */
volatile unsigned int  txcr3;    /* 0x02c */
volatile unsigned int  sr3;      /* 0x030 */
volatile unsigned int  isr3;     /* 0x034 */
volatile unsigned int  iie3;     /* 0x038 */
volatile unsigned int  rxcr4;    /* 0x03c */
volatile unsigned int  txcr4;    /* 0x040 */
volatile unsigned int  sr4;      /* 0x044 */
volatile unsigned int  isr4;     /* 0x048 */
volatile unsigned int  iie4;     /* 0x04c */
volatile unsigned int  sl1rx;    /* 0x050 */
volatile unsigned int  sl1tx;    /* 0x054 */
volatile unsigned int  sl2rx;    /* 0x058 */
volatile unsigned int  sl2tx;    /* 0x05c */
volatile unsigned int  sl12rx;   /* 0x060 */
volatile unsigned int  sl12tx;   /* 0x064 */
volatile unsigned int  slfr;     /* 0x068 */
volatile unsigned int  slistat;  /* 0x06c */
volatile unsigned int  slien;    /* 0x070 */
volatile unsigned int  intclr;   /* 0x074 */
volatile unsigned int  maincr;   /* 0x078 */
volatile unsigned int  reset;    /* 0x07c */
volatile unsigned int  sync;     /* 0x080 */
volatile unsigned int  allints;  /* 0x084 */
volatile unsigned int  mainfr;   /* 0x088 */
volatile unsigned int  res08c;
volatile unsigned int  dr1[8];   /* 0x090 */
volatile unsigned int  dr2[8];   /* 0x0b0 */
volatile unsigned int  dr3[8];   /* 0x0d0 */
volatile unsigned int  dr4[8];   /* 0x0f0 */
};
...
typedef void (*pl041_irq_fun_t)(unsigned int status, void * user_data);
