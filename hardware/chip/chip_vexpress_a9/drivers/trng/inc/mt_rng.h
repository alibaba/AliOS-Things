...
#define TRNG_CG_SET_REG      (IO_PHYS + 0x00001088)
#define TRNG_CG_CLR_REG      (IO_PHYS + 0x0000108C)// Enable clock
#define TRNG_CG_STA_REG      (IO_PHYS + 0x00001094)
#define TRNG_CG_FIELD        (0x1 << 9)
...
extern void trng_cli_register(void);
#endif
