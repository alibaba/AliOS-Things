...
BOOL PSRAM_calibration(VOID)
{
	...
	for(caltempN = 0; caltempN < PSRAM_CALIB_N_MAX; caltempN++){
		...
		HAL_WRITE32(PSRAM_BASE, 0x100000, tempdatawr[1]);
		HAL_WRITE32(PSRAM_BASE, 0x150000, tempdatawr[2]);
		HAL_WRITE32(PSRAM_BASE, 0x200000, tempdatawr[3]);
		HAL_WRITE32(PSRAM_BASE, 0x250000, tempdatawr[4]);
		HAL_WRITE32(PSRAM_BASE, 0x300000, tempdatawr[5]);
		tempdatard[0] = HAL_READ32(PSRAM_BASE, 0x0);
		tempdatard[1] = HAL_READ32(PSRAM_BASE, 0x100000);
		tempdatard[2] = HAL_READ32(PSRAM_BASE, 0x150000);
		tempdatard[3] = HAL_READ32(PSRAM_BASE, 0x200000);
		tempdatard[4] = HAL_READ32(PSRAM_BASE, 0x250000);
		tempdatard[5] = HAL_READ32(PSRAM_BASE, 0x300000);
