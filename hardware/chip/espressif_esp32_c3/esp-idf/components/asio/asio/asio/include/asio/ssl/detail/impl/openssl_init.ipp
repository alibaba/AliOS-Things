...
public:
  ...
  && (OPENSSL_VERSION_NUMBER >= 0x00908000L)
    ...
    ::SSL_COMP_free_compression_methods();
       ...
       // && (OPENSSL_VERSION_NUMBER < 0x10100000L)
       // && !defined(SSL_OP_NO_COMPRESSION)
#if !defined(OPENSSL_IS_BORINGSSL) && !defined(ASIO_USE_WOLFSSL) && !defined(ASIO_USE_ESP_OPENSSL)
    ::CONF_modules_unload(1);
#endif // !defined(OPENSSL_IS_BORINGSSL) && !defined(ASIO_USE_WOLFSSL) && !defined(ASIO_USE_ESP_OPENSSL)
