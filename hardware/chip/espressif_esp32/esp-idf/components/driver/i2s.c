...
static DRAM_ATTR i2s_obj_t *p_i2s_obj[I2S_NUM_MAX] = { 0 };
...
static i2s_dma_t *i2s_create_dma_queue(i2s_port_t i2s_num, int dma_buf_count, int dma_buf_len)
{
    ...
    i2s_dma_t *dma = (i2s_dma_t *)heap_caps_calloc(1, sizeof(i2s_dma_t), MALLOC_CAP_INTERNAL | MALLOC_CAP_8BIT);
    if (dma == NULL) {
    ...
    dma->buf = (char **)heap_caps_calloc(dma_buf_count, sizeof(char *), MALLOC_CAP_INTERNAL | MALLOC_CAP_8BIT);
    if (dma->buf == NULL) {
    ...
    dma->desc = (lldesc_t **)heap_caps_calloc(dma_buf_count, sizeof(lldesc_t *), MALLOC_CAP_INTERNAL | MALLOC_CAP_8BIT);
    if (dma->desc == NULL) {
...
esp_err_t i2s_driver_install(i2s_port_t i2s_num, const i2s_config_t *i2s_config, int queue_size, void* i2s_queue)
{
    ...
    if (p_i2s_obj[i2s_num] == NULL) {
        p_i2s_obj[i2s_num] = (i2s_obj_t *)heap_caps_calloc(1, sizeof(i2s_obj_t), MALLOC_CAP_INTERNAL | MALLOC_CAP_8BIT);
        if (p_i2s_obj[i2s_num] == NULL) {
