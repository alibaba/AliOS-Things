...
#define MALLOC_IRAM_CAP (MALLOC_CAP_EXEC | MALLOC_CAP_32BIT | MALLOC_CAP_IRAM_8BIT | MALLOC_CAP_DEFAULT)
#else
...
const soc_memory_type_desc_t soc_memory_types[] = {
    ...
    //Type 2: IRAM
    { "IRAM", { 0, 0, MALLOC_CAP_INTERNAL | MALLOC_IRAM_CAP }, false, false},
