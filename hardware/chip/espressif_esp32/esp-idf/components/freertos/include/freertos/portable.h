...
/*
 * HaaS Modify
 * pvPortMalloc changed from malloc to heap_caps_malloc in order to solve
 * CONFIG_SPIRAM_MALLOC_ALWAYSINTERNAL set to smaller value issue
 * ISR should use mem from DRAM and should not from SPIRAM
 */
#define pvPortMalloc(size) heap_caps_malloc((size), MALLOC_CAP_INTERNAL | MALLOC_CAP_8BIT)
