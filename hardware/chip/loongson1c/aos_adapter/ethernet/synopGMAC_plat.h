...
#define TR0(fmt, args...) //aos_debug_printf(fmt, ##args)		
#define TR(fmt, args...)  //aos_debug_printf(fmt, ##args) 
//#define TR aos_debug_printf
...
#endif
    //  aos_debug_printf("%s RegBase = 0x%08x RegOffset = 0x%08x RegData = 0x%08x\n", __FUNCTION__, (u32)RegBase, RegOffset, data );
    return data;
