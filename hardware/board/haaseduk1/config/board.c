...
hr_timer_t soc_hr_hw_cnt_get(void) { return DWT->CYCCNT; }

lr_timer_t soc_lr_hw_cnt_get(void) { return (lr_timer_t)hal_sys_timer_get(); }
...
tick_t soc_elapsed_ticks_get(void) { return 0; }
#endif
...
void board_network_init() { haas_wifi_init(); }
