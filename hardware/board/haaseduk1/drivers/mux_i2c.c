 ...
 * @rtn    0 : on success, EIO : error
 *********************************************************/
int32_t haas_mux_i2c_reg_write(i2c_dev_t *i2c,
                               uint16_t       dev_addr,
                               uint16_t       reg_addr,
                               uint16_t       reg_num,
                               const uint8_t *data,
                               ...
                               uint32_t       timeout)
{
    ...
    ret = hal_i2c_mem_write(i2c, dev_addr, reg_addr, reg_num, data, size,
                            timeout);
    if (ret) {
 ...
 * @rtn    0 : on success, EIO : error
 *********************************************************/
int32_t haas_mux_i2c_reg_read(i2c_dev_t *i2c,
                              uint16_t       dev_addr,
                              uint16_t       reg_addr,
                              uint16_t       reg_num,
                              const uint8_t *data,
                              ...
                              uint32_t       timeout)
{
    ...
    ret =
        hal_i2c_mem_read(i2c, dev_addr, reg_addr, reg_num, data, size, timeout);
    if (ret) {
        printf("mux_i2c reg write failed\r\n");
        return -1;
    }
 ...
 * @rtn    0 : on success, EIO : error
 *********************************************************/
int32_t haas_mux_i2c_data_send(i2c_dev_t *i2c,
                               uint16_t       dev_addr,
                               const uint8_t *data,
                               uint16_t       size,
                               uint32_t       timeout)
 ...
 * @rtn    0 : on success, EIO : error
 *********************************************************/
int32_t haas_mux_i2c_data_recv(i2c_dev_t *i2c,
                               uint16_t   dev_addr,
                               uint8_t *data,
                               uint16_t   size,
                               uint32_t   timeout)
