...
&emsp;&emsp;
如下图所示，打开VS Code之后在新建一个基于helloworld的python工程，设定好工程名称（“gas_detector”）及工作区路径之后，硬件类型选择ESP-C3-32S-Kit，解决方案选择“helloworld”，点击立即创建，创建一个Python轻应用的解决方案。

<div align="center">
<img src=./../../../images/2_ESP-C3-32S-Kit_创建gas_detector工程.png width=80%/>
</div>
