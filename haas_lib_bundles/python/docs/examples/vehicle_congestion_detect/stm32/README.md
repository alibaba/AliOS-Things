...
* 01Studio Columbus开发板  1套
* 杜邦线若干
* GNSS定位模块 HT2828Z3G5L

&emsp;&emsp;
其中，HT2828Z3G5L与01Studio Columbus的连接如下：

| 定位模块 |                                                   |    01Studio Columbus     |          |
| -------- | ------------------------------------------------- | :----------: | -------- |
| 引脚名   | 引脚功能                                          |  连接到引脚  | 引脚序号 |
...
如下图实物图所示：
<div align="center">
<img src=./../../../images/stm32-车辆定位系统硬件连线图.png width=90%/>
</div>
...
&emsp;&emsp;
对于 01Studio Columbus 等搭载 Wi-Fi 的设备而言，联网方式可以选择“Wi-Fi”。
...
### 3.1、开发环境
&emsp;&emsp;
在进行下一步之前请确保01Studio Columbus开发环境已经搭建完毕。详情请参考[ESP-C3-32S-Kit开发环境](../../../startup/ESP-C3-32S-Kit_startup.md)的说明。
<br>
...
### 4.1、设备端
&emsp;&emsp;
推送此脚本到01Studio Columbus之后，串口会输出获取到的定位信息，同时按照脚本中的逻辑，当定位信息发生变化时，会将更新的定位信息上报至物联网平台。如下面这段串口日志所示。
```log
...
