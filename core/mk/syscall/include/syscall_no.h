...
#define SYS_IOT_LINKKIT_ANSWERSERVICE (LINKKIT_BASE + 7)
#define SYS_IOT_SETLOGLEVEL           (LINKKIT_BASE + 8)
#define SYS_IOT_DUMPMEMORYSTATS       (LINKKIT_BASE + 9)
#define SYS_IOT_SETUPCONNINFO         (LINKKIT_BASE + 10)
#define SYS_IOT_IOCTL                 (LINKKIT_BASE + 11)
#define SYS_IOT_HAL_IOCTL             (LINKKIT_BASE + 12)
#define SYS_IOT_REGSITERCALLBACK      (LINKKIT_BASE + 13)
