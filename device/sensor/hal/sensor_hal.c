...
i2c_dev_t i2c = {
    ...
    .config.freq          = 400000,
    .config.dev_addr =
      0x00, /* the dev addr will be update in the sensor driver */
};
...
#if defined(AOS_SENSOR_TEMP_SENSIRION_SHTC1) || \
  defined(AOS_SENSOR_TEMP_SENSIRION_SHTC3)
    drv_temp_sensirion_shtc1_init();
#endif /* AOS_SENSOR_TEMP_SENSIRION_SHTC1 */

#if defined(AOS_SENSOR_HUMI_SENSIRION_SHTC1) || \
  defined(AOS_SENSOR_HUMI_SENSIRION_SHTC3)
