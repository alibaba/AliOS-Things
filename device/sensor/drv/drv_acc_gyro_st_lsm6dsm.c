...
static int drv_acc_st_lsm6dsm_read(void *buf, size_t len)
{
    ...
    ret  = sensor_i2c_read(&lsm6dsm_ctx, LSM6DSM_ACC_GYRO_OUTX_L_XL,  &reg[0], I2C_REG_LEN, I2C_OP_RETRIES);
    ret |= sensor_i2c_read(&lsm6dsm_ctx, LSM6DSM_ACC_GYRO_OUTX_H_XL,  &reg[1], I2C_REG_LEN, I2C_OP_RETRIES);
    ret |= sensor_i2c_read(&lsm6dsm_ctx, LSM6DSM_ACC_GYRO_OUTY_L_XL,  &reg[2], I2C_REG_LEN, I2C_OP_RETRIES);
    ret |= sensor_i2c_read(&lsm6dsm_ctx, LSM6DSM_ACC_GYRO_OUTY_H_XL,  &reg[3], I2C_REG_LEN, I2C_OP_RETRIES);
    ret |= sensor_i2c_read(&lsm6dsm_ctx, LSM6DSM_ACC_GYRO_OUTZ_L_XL,  &reg[4], I2C_REG_LEN, I2C_OP_RETRIES);
    ret |= sensor_i2c_read(&lsm6dsm_ctx, LSM6DSM_ACC_GYRO_OUTZ_H_XL,  &reg[5], I2C_REG_LEN, I2C_OP_RETRIES);
    if(unlikely(ret)){
        return -1;
    }
...
static int drv_acc_st_lsm6dsm_ioctl(int cmd, unsigned long arg)
{
	...
	case SENSOR_IOCTL_SELF_TEST:{
	   ret = drv_acc_st_lsm6dsm_self_test(&lsm6dsm_ctx, info->data);
...
static int drv_gyro_st_lsm6dsm_read(void *buf, size_t len)
{
    ...
    ret  = sensor_i2c_read(&lsm6dsm_ctx, LSM6DSM_ACC_GYRO_OUTX_L_G,  &reg[0], I2C_REG_LEN, I2C_OP_RETRIES);
    ret |= sensor_i2c_read(&lsm6dsm_ctx, LSM6DSM_ACC_GYRO_OUTX_H_G,  &reg[1], I2C_REG_LEN, I2C_OP_RETRIES);
    ret |= sensor_i2c_read(&lsm6dsm_ctx, LSM6DSM_ACC_GYRO_OUTY_L_G,  &reg[2], I2C_REG_LEN, I2C_OP_RETRIES);
    ret |= sensor_i2c_read(&lsm6dsm_ctx, LSM6DSM_ACC_GYRO_OUTY_H_G,  &reg[3], I2C_REG_LEN, I2C_OP_RETRIES);
    ret |= sensor_i2c_read(&lsm6dsm_ctx, LSM6DSM_ACC_GYRO_OUTZ_L_G,  &reg[4], I2C_REG_LEN, I2C_OP_RETRIES);
    ret |= sensor_i2c_read(&lsm6dsm_ctx, LSM6DSM_ACC_GYRO_OUTZ_H_G,  &reg[5], I2C_REG_LEN, I2C_OP_RETRIES);
    if(unlikely(ret)){
        return -1;
    }
...
static int drv_gyro_st_lsm6dsm_ioctl(int cmd, unsigned long arg)
{
    ...
    switch(cmd){
        ...
        case SENSOR_IOCTL_SELF_TEST:{
           ret = drv_gyro_st_lsm6dsm_self_test(&lsm6dsm_ctx, info->data);
           //printf("%d %d   %d\n",info->data[0],info->data[1],info->data[2]);
           LOG("%s %s: %d, %d, %d\n", SENSOR_STR, __func__, info->data[0],info->data[1],info->data[2]);
           return ret;
        }
