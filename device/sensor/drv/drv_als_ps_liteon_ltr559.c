...
static int drv_als_liteon_ltr559_is_ready(i2c_dev_t* drv)
{
    int     ret = 0;
    uint8_t value = 0;
...
static int drv_ps_liteon_ltr559_is_ready(i2c_dev_t* drv)
{
    int     ret = 0;
    uint8_t value = 0;
...
static int drv_als_liteon_ltr559_set_default_config(i2c_dev_t* drv)
{
    int     ret = 0;
    uint8_t value = 0;
...
static int drv_ps_liteon_ltr559_set_default_config(i2c_dev_t* drv)
{
    ...
    value = 0;
    value = LTR559_SET_BITSLICE(value, PS_N_PULSES_REG_PULSES, 1);
