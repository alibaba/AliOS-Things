...
const modbus_sensor_t modbus_sensors[] = {
    ...
    { "MTMicrosystems", "MSTH1000", "humi", dev_humi_path, TAG_DEV_HUMI,
      SENSOR_OPEN, 0x01, 0x0000, 1, 0, 50 },
