...
// for demo only
#if 0
#define PRODUCT_KEY "a1uGDbTnSGW"
#define PRODUCT_SECRET "CSog02F64jl34LjG"
#define DEVICE_NAME "HaaS_Auto001"
#define DEVICE_SECRET "57e1cb42be03ac2b84e16f363d044b20"
#else
#define PRODUCT_KEY "a1qp6dl5qS4"
#define PRODUCT_SECRET "vZLhzuAkEv2LGupT"
#define DEVICE_NAME "auto001"
#define DEVICE_SECRET "f2066effc39b527850746216aa2c3089"
#endif
extern void report_event2cloud(void);
...
extern void right_ctl(void);
extern void left_ctl(void);
extern void back_ctl(void);
extern void front_ctl(void);
...
void user_post_property(char type_t,uint8_t value)
{
    static int cnt = 0;
    static int temp = 0;
    int res = 0;
...
{
    int res = 0;
    char *event_id = "humidityTooHighEvent";
    char *event_payload;

    if(type_t == 0){
        event_payload = "{\"water\": 0}";
    }
    else{
        event_payload = "{\"water\": 1}";
    }
...
#if 1
extern void Utral_ctrl(void);
extern void OLED_Show_String( uint8_t x, uint8_t y, const uint8_t *p, uint8_t size, uint8_t mode );
uint8_t dis_flag = 0;
#endif
