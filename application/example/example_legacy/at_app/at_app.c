 ...
 * @file at_app.c
 *
 * This file includes sample code of how to use at
...
#include <at/at.h>
/**
 * @note **DO** include below line to use the platform 
...
int application_start(int argc, char *argv[])
{
    ...
    /* Initialize at core via at_init(). */
    at_init();
     ...
     * The UART configurations are subject to changel, according to the
     * AT module you are using (in this sample, the AT module is M5310A,
     * NBIoT module from China Mobile IoT).
     *
