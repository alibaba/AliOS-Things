...
```sh
knxctl
├── knxctl.c        # knx stack demo source code
...
The **knxctl** example will print `hello world` and other information every 5 seconds, the example is simple.
