...
SUITE(MQTT_PUB) = {
    ADD_CASE(MQTT_PUB, case_01),
    ADD_CASE(MQTT_PUB, case_02),
    ADD_CASE(MQTT_PUB, case_03),
    ADD_CASE(MQTT_PUB, case_04),
    ADD_CASE(MQTT_PUB, case_05),
    ADD_CASE(MQTT_PUB, case_06),
    ADD_CASE(MQTT_PUB, case_07),
    ADD_CASE_NULL
};
#endif
