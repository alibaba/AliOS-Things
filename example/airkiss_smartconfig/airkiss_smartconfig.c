...
static void start_airkiss(void);
...
static void wifi_connect(char *ssid, char *pw)
{
    ...
    hal_wifi_start(&aos_wifi_esp8266, &type);
}
...
static void wifi_scan_compeleted(hal_wifi_module_t *m, hal_wifi_scan_result_t *result, void *arg)
{
	...
	printf("AIRKISS_STATUS_GETTING_SSID_PSWD\r\n");
	printf("T|pswd : %s\r\n", wifi_ssid);
	printf("T|ssid : %s\r\n", wifi_pwd);
	printf("AIRKISS_STATUS_LINK\r\n");
...
static void start_airkiss(void)
{
	...
	printf("AIRKISS_STATUS_FIND_CHANNEL\r\n");
