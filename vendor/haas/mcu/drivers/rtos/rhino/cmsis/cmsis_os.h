...
typedef kbuf_queue_t *osMessageQId;
...
#else                            // define the object
#define osSemaphoreDef(name)  \
const osSemaphoreDef_t os_semaphore_def_##name = {(0), (0), (0)}
#endif
...
{ {(queue_sz), sizeof(type), (os_mailQ_m_##name)}, NULL}
#endif
#endif
