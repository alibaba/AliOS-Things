...
ifneq ($(CPU),a7)
KBUILD_CPPFLAGS += \
    -Irtos/rhino/arch/arm/armv8m-mk/include
else
KBUILD_CPPFLAGS += \
...
ifeq ($(CMSIS_AOS), 1)
ifeq ($(CHIP_HAS_SPI),1)
KBUILD_CPPFLAGS += -DCHIP_HAS_SPI
endif
ifeq ($(CHIP_HAS_SPILCD),1)
KBUILD_CPPFLAGS += -DCHIP_HAS_SPILCD
endif
ifeq ($(CHIP_HAS_SPIPHY),1)
KBUILD_CPPFLAGS += -DCHIP_HAS_SPIPHY
endif
ifeq ($(CHIP_HAS_SPIDPD),1)
KBUILD_CPPFLAGS += -DCHIP_HAS_SPIDPD
endif
endif
