...
ifeq ($(CMSIS_AOS),1)
KBUILD_CPPFLAGS += -D__CMSIS_AOS__ -DAOS_COMP_IRQ -DUSER_SPACE_DRIVER=1
endif

KBUILD_CPPFLAGS += -DMIC_SAMPLERATE=48000 -DMIC_PERIOD_MS=48

KBUILD_CPPFLAGS += -DBUSY_PRINT_THRESHOLD=80

ifeq ($(SDK),1)
KBUILD_CPPFLAGS += -D__SDK_BUILD__
endif
...
export DSP_PSRAMUHS_SIZE ?= 0x000000
export RSV_PSRAMUHS_SIZE ?= 0x800000
export MCU_PSRAMUHS_SIZE ?= 0x000000
export PSRAMUHS_SPEED ?= 1000
else
export PSRAMUHS_SIZE ?= 0x1000000
export DSP_PSRAMUHS_SIZE ?= 0x5D4000
export MCU_PSRAMUHS_SIZE ?= 0xA2C000
...
KBUILD_CPPFLAGS += -DDSP_PSRAMUHS_SIZE=$(DSP_PSRAMUHS_SIZE) -DRSV_PSRAMUHS_SIZE=$(RSV_PSRAMUHS_SIZE)
endif
...
KBUILD_CPPFLAGS += -Wno-unused-variable -Wno-double-promotion -Wno-unused-function -Wno-unused-but-set-variable -Wno-float-conversion -Wno-deprecated -Wno-format

C_ONLY_FLAGS    := -std=gnu11 -Wno-implicit-function-declaration -Wno-incompatible-pointer-types -Wno-int-conversion -Wno-discarded-qualifiers -Wno-pointer-sign
