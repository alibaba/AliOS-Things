...
MODULE             := common driver

$(NAME)_PREBUILT_LIBRARY := libhaas1000_cmsis.a
$(NAME)_PREBUILT_LIBRARY += libhaas1000_common.a
$(NAME)_PREBUILT_LIBRARY += libhaas1000_dma.a

CPU_FLAGS := -mcpu=cortex-m33 -mthumb -mfpu=fpv5-sp-d16 -mfloat-abi=hard -DCORTEX_DEBUG_V8M

COM_FLAGS := -g -O2 -Wall #-Werror

COM_MACROS := -DCHIP=haas1000 -DKERNEL=RHINO -DCHIP_HAAS1000_ARCH_ENHANCE -DCHIP_HAAS1000 -DMIC_SAMPLERATE=48000 -DMIC_PERIOD_MS=48 -DCHIP_HAS_DMA=1
