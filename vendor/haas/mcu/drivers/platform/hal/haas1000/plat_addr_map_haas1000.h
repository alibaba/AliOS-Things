...
#define MCU_PSRAMUHS_BASE		(PSRAMUHS_BASE + DSP_PSRAMUHS_SIZE + RSV_PSRAMUHS_SIZE)
#define MCU_PSRAMUHS_NC_BASE		(PSRAMUHS_NC_BASE + DSP_PSRAMUHS_SIZE + RSV_PSRAMUHS_SIZE)
#define MCU_PSRAMUHSX_BASE		(PSRAMUHSX_BASE + DSP_PSRAMUHS_SIZE + RSV_PSRAMUHS_SIZE)
