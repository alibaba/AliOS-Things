...
#ifdef AOS_COMP_IRQ
#define ASSERT(cond, str, ...)      { if (!(cond)) { printf(__FILE__, __FUNCTION__, __LINE__, str, ##__VA_ARGS__); printf("\r\n"); assert(0); } }
#else
...
#ifdef AOS_COMP_IRQ
#define ASSERT(cond, str, ...)      { if (!(cond)) { printf(__FILE__, __LINE__, str, ##__VA_ARGS__); printf("\r\n"); assert(0); } }
#else
...
#ifdef AOS_COMP_IRQ
#define ASSERT(cond, str, ...)      { if (!(cond)) { printf(__FUNCTION__, __LINE__, str, ##__VA_ARGS__); printf("\r\n"); assert(0); } }
#else
...
#ifdef AOS_COMP_IRQ
#define ASSERT(cond, str, ...)      { if (!(cond)) { printf(str, ##__VA_ARGS__); printf("\r\n"); assert(0); } }
#else
...
#else
#ifdef AOS_COMP_IRQ
#define ASSERT(cond, str, ...)      { if (!(cond)) { assert(0); } }
#else
...
TRACE_FUNC_DECLARE(void hal_trace_set_txdma(bool onoff), return);
