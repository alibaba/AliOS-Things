...
$(NAME)_COMPONENTS += arch_armv8m-mk rhino cli cplusplus
...
$(NAME)_INCLUDES += aos/aos_vendor_cli_cmd

GLOBAL_INCLUDES += aos
GLOBAL_INCLUDES += aos/arch
GLOBAL_INCLUDES += aos/dsp
...
GLOBAL_INCLUDES += drivers/rtos/rhino/cmsis
...
GLOBAL_DEFINES += SWD_ENABLE_AS_DEFAULT CLI_CONFIG_MAX_COMMANDS=256

CMSIS_AOS ?= 1
ifeq ($(CMSIS_AOS), 1)
GLOBAL_DEFINES += __CMSIS_AOS__ USER_SPACE_DRIVER=1
endif
...
$(NAME)_PREBUILT_LIBRARY += drivers/libhaas1000_audio.a
$(NAME)_PREBUILT_LIBRARY += drivers/libhaas1000_wifi.a
$(NAME)_PREBUILT_LIBRARY += drivers/libhaas1000_cmsis.a
$(NAME)_PREBUILT_LIBRARY += drivers/libhaas1000_bt.a
$(NAME)_PREBUILT_LIBRARY += drivers/libhaas1000_common.a
$(NAME)_PREBUILT_LIBRARY += drivers/libhaas1000_dma.a
$(NAME)_PREBUILT_LIBRARY += drivers/libhaas1000_wpa.a
$(NAME)_PREBUILT_LIBRARY += drivers/libhaas1000_usb.a
