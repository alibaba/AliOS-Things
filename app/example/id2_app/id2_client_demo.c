...
static void test_id2_client_decrypt(void)
{
    ...
    const uint8_t ciphertext[] = {
        ...
        0xDE, 0xCF, 0xB0, 0x4D, 0xE5, 0x25, 0x63, 0x1E,
#elif (ID2_CRYPTO_TYPE_CONFIG == ID2_CRYPTO_TYPE_AES)
        0x1C, 0xC5, 0x65, 0xA1, 0x91, 0xCF, 0xCE, 0xA5,   0x9F, 0x99, 0x7D, 0xC9, 0x19, 0x5C, 0x15, 0x4D,
#else
...
int test_id2_client_get_otp_auth_code(int type)
{
    ...
    if (type == 0x01) {
        ...
        otp_auth =
            "AAABACQOSl8KZrYD5hPmp3Ln4ssZ4KHv9vIDYdq3264F3kLH6Ma6B6L/RmkocBtMR+0KRiSRRDhBIuvP0RNFxNtMO3sEGDJO7knIDlWKQ7wQoNR/xFW3Tpd2W8WQTa+YrMYtFqAne+PU9hZPmL7gH69HmrY=";
    }
#elif (ID2_CRYPTO_TYPE_CONFIG == ID2_CRYPTO_TYPE_3DES)
    if (type == 0x04) {
        token = "i14ejGyODBUwsjKTWri789E01AAD601E";
        otp_auth =
            "AAABAGtpp3AyqRqSbOTyqBeM4G2SHUqk7eo35w5CrwAUX032NTAh8KIhX1ZenldVnU9fFkPeQTyl5CJAPF90wZzKbLMjsY0t+9TTMUuunbErnsvH19aIS+7JnB8FP/Dy5OEDxq84kz6fNm0j";
    }
#else
