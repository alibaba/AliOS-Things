...
void CASE2(void *pclient)
{
    ...
    int stack_used = 0;
    ret = HAL_ThreadCreate(&pid3, thread_subscribe1, (void *)pclient, NULL, &stack_used);
    ...
    ret = HAL_ThreadCreate(&pid4, thread_subscribe2, (void *)pclient, NULL, &stack_used);
...
void CASE1(void *pclient)
{
    ...
    int stack_used = 0;
    ret = HAL_ThreadCreate(&pid1, thread_publish1, (void *)pclient, NULL, &stack_used);
    //ret = pthread_create(&pid1, NULL, thread_publish1, (void*)pclient);
    if (ret != 0) {
        printf("pthread_create failed!\n");
        return;
    }
    ret = HAL_ThreadCreate(&pid2, thread_publish2, (void *)pclient, NULL, &stack_used);
...
int mqtt_client(void)
{
    ...
    int stack_used = 0;
    rc = HAL_ThreadCreate(&yield_thread, thread_yield, (void *)pclient, NULL, &stack_used);
