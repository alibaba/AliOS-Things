...
#define PRODUCT_KEY     "a1no6KQPtQW"
#define PRODUCT_SECRET  "EDdYTN86huK1TnVV"
#define DEVICE_NAME     "alios_linkkit1_device3"
#define DEVICE_SECRET   "cTb1gNfsACdHNd2GbENbhvjeR2fra1LK"

//#define PRODUCT_KEY     "a1no6KQPtQW"
//#define PRODUCT_SECRET  "EDdYTN86huK1TnVV"
//#define DEVICE_NAME     "alios_linkkit1_device1"
//#define DEVICE_SECRET   "eN6RufqtlOfQSjtn21ZBJjYLYm0Sh1J8"

// raw data
//#define PRODUCT_KEY     "a1qsBer87Uj"
//#define PRODUCT_SECRET  "p1boDp8If70Qnkqj"
//#define DEVICE_NAME     "_iotx_raw_instance_no1"
//#define DEVICE_SECRET   "8COqTBbSEJ1l30DxbqbGkrsvtoX49QRU"
                              ...
                              void *ctx)
{
	...
	int light;
        ...
        snprintf(property_buf, sizeof(property_buf), "%s.%s", property, "1");
        /* get value by linkkit_get_value */
        linkkit_get_value(linkkit_method_get_property_value, thing_id,
