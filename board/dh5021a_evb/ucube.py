...
linux_only_targets="coapapp helloworld httpapp linkkit_gateway linkkitapp mqttapp otaapp tls udata_demo.sensor_cloud_demo udata_demo.sensor_local_demo udataapp udevapp ulocationapp yts"
