...
linux_only_targets="wifihalapp ldapp yts helloworld_nocli tls kernel_test netmgrapp cryptotest hdlcapp.hdlcserver helloworld networkapp nano mqttapp linkkitapp otaapp linkkit_gateway coapapp"
