...
void board_init(void)
{
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_1].partition_start_addr       = 0x0007C000;
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_2].partition_start_addr       = 0x0007E000;
    ...
    hal_partitions[HAL_PARTITION_OTA_TEMP].partition_length              = 0x7C000; //496k bytes
