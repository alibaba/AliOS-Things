...
GLOBAL_LDFLAGS += --config board/stm32f429zi-mk/STM32F429.icf
else
ifeq ($(MBINS),)
GLOBAL_LDFLAGS += -T board/stm32f429zi-mk/STM32F429ZITx_FLASH.ld
else ifeq ($(MBINS),kernel)
GLOBAL_LDFLAGS += -T board/stm32f429zi-mk/STM32F429ZITx_FLASH_kernel.ld
else ifeq ($(MBINS),app)
ifeq ($(ENABLE_USPACE),1)
GLOBAL_LDFLAGS += -T board/stm32f429zi-mk/$(MBINS_APP).ld
else
GLOBAL_LDFLAGS += board/stm32f429zi-mk/STM32F429ZITx_FLASH_app.ld
endif
endif
endif
