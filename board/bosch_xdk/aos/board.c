...
static void board_partition_init()
{
    ...
    hal_partitions[HAL_PARTITION_APPLICATION].partition_start_addr       = 0x00020200;
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_1].partition_start_addr       = 0x0005C200;
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_2].partition_start_addr       = 0x0005D200;
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_4].partition_start_addr       = 0x0005F200;
