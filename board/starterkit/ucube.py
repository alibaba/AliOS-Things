...
linux_only_targets="helloworld mqttapp acapp nano tls alinkapp coapapp hdlcapp.hdlcserver udataapp networkapp littlevgl_starterkit wifihalapp hdlcapp.hdlcclient atapp linuxapp helloworld_nocli vflashdemo netmgrapp blink yts kernel_test i2c_hts221_test ldapp cryptotest http2app otaapp"
