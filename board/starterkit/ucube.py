...
linux_only_targets="helloworld mqttapp acapp nano tls coapapp hdlcapp.hdlcserver udataapp networkapp wifihalapp hdlcapp.hdlcclient atapp helloworld_nocli vflashdemo netmgrapp blink yts kernel_test i2c_hts221_test cryptotest http2app benchmark.footprint_test devkit.dk_ld startkit.sk_gui"
