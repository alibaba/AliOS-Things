...
linux_only_targets="blink coapapp helloworld http2app modbus_demo mqttapp otaapp sk.sk_gui tls udata_demo.sensor_cloud_demo udata_demo.sensor_local_demo udata_demo.udata_cloud_demo udata_demo.udata_local_demo udataapp udevapp yts"
