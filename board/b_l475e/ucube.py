...
linux_only_targets="nano helloworld mqttapp alinkapp tls uDataapp networkapp acapp vflashdemo atapp emwinapp hdlcapp.hdlcclient wifihalapp linuxapp netmgrapp hdlcapp.hdlcserver coapapp helloworld_nocli linkkitapp ldapp otaapp linkkit_gateway cryptotest kernel_test yts"
