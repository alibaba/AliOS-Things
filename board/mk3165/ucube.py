...
linux_only_targets="wifimonitor linkkitapp udataapp kernel_test nano otaapp yts networkapp vflashdemo netmgrapp linkkit_gateway wifihalapp hdlcapp.hdlcserver cryptotest tls mqttapp helloworld_nocli acapp coapapp helloworld http2app devkit.dk_ld benchmark.footprint_test"
