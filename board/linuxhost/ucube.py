...
linux_only_targets=" coapapp das_app helloworld http2app httpapp id2_app itls_app linkkit_gateway linkkitapp meshapp mqttapp otaapp prov_app tls udata_demo.sensor_local_demo udataapp udevapp ulocationapp yts"
