...
linux_only_targets="alinkapp networkapp helloworld linuxapp tls yts linkkitapp acapp alinkapp|vcall=posix networkapp|vcall=posix helloworld|vcall=posix linuxapp|vcall=posix tls|vcall=posix linkkitapp|vcall=posix"
