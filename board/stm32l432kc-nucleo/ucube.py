...
linux_only_targets="networkapp blink linuxapp helloworld_nocli vflashdemo netmgrapp coapapp atapp tls mqttapp helloworld acapp nano hdlcapp.hdlcclient hdlcapp.hdlcserver alinkapp wifihalapp uDataapp otaapp yts i2c_hts221_test kernel_test cryptotest ldapp"
