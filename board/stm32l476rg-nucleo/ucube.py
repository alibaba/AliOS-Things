...
linux_only_targets="netmgrapp acapp linkkit_gateway nano networkapp linuxapp hdlcapp.hdlcserver alinkapp helloworld coapapp linkkit_sched tls helloworld_nocli blink atapp hdlcapp.hdlcclient linkkitapp vflashdemo mqttapp wifihalapp uDataapp yts i2c_hts221_test cryptotest otaapp kernel_test ldapp"
