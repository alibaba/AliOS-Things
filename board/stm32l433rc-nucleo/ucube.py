...
linux_only_targets="hdlcapp.hdlcclient coapapp mqttapp blink hdlcapp.hdlcserver alinkapp wifihalapp acapp uDataapp helloworld netmgrapp linuxapp helloworld_nocli nano atapp vflashdemo tls networkapp otaapp i2c_hts221_test cryptotest yts kernel_test ldapp"
