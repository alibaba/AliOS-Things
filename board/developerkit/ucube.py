...
linux_only_targets="blink coapapp dk.dk_gui dk.dk_ld dk.dk_qr helloworld http2app linkkit_gateway linkkitapp modbus_demo mqttapp otaapp tls udataapp udevapp yts"
