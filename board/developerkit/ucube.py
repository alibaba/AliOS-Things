...
linux_only_targets="blink coapapp dk.dk_gui dk.dk_ld dk.dk_qr helloworld http2app linkkit_gateway linkkitapp mqttapp otaapp tinyengine_app tls udataapp yts"
