...
linux_only_targets="helloworld mqttapp acapp udataapp tls netmgrapp networkapp linkkit_gateway littlevgl_developerkit linuxapp cameraapp hdlcapp.hdlcclient developerkitgui alinkapp blink linkkitapp hdlcapp.hdlcserver qr coapapp vflashdemo littlevgl_starterkit atapp wifihalapp helloworld_nocli modbus_test otaapp yts i2c_hts221_test cryptotest benchmark.realtime_test ldapp benchmark.pwr_test kernel_test http2app developerkitaudio"
