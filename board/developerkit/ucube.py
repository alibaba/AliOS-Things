...
linux_only_targets="helloworld mqttapp acapp uDataapp tls netmgrapp networkapp linkkit_gateway littlevgl_developerkit linuxapp cameraapp hdlcapp.hdlcclient developerkitgui blink linkkitapp hdlcapp.hdlcserver qr coapapp vflashdemo littlevgl_starterkit emwinapp atapp wifihalapp helloworld_nocli modbus_test"
