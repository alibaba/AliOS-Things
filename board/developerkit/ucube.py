...
linux_only_targets="helloworld mqttapp acapp udataapp tls netmgrapp networkapp linkkit_gateway hdlcapp.hdlcclient blink linkkitapp hdlcapp.hdlcserver coapapp vflashdemo atapp wifihalapp helloworld_nocli modbus_test otaapp yts i2c_hts221_test cryptotest benchmark.realtime_test benchmark.pwr_test kernel_test http2app  startkit.sk_gui devkit.dk_audio devkit.dk_ld devkit.dk_camera devkit.dk_qr devkit.dk_gui benchmark.footprint_test tinyengine_app"
