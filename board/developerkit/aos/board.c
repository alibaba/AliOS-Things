...
static void board_partition_init()
{
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_1].partition_start_addr       = 0x0805C000;
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_2].partition_start_addr       = 0x0805D000;
    ...
    hal_partitions[HAL_PARTITION_OTA_TEMP].partition_start_addr          = 0x08060000;
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_3].partition_start_addr       = 0x080BC000;
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_4].partition_start_addr       = 0x080BD000;
