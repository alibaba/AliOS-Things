...
#include "hal_uart_HK32f1.h"

#ifndef SYSINFO_ARCH
#define SYSINFO_ARCH        "ARM COTEX M3"
#endif
#ifndef SYSINFO_MCU
#define SYSINFO_MCU         "HK32F103RB"
#endif
...
#define TEST_CONFIG_MALLOC_MAX_SIZE             (512)
...
{
    unsigned int size1 = 256;
    unsigned int size2 = 512;
    unsigned char *ptr = NULL;
    int i = 0;
