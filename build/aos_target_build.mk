...
$(LIBS_DIR)/$(notdir $($(1)_SELF_BUIlD_COMP_targets)): $(OUTPUT_DIR)/config.mk
	echo "#------ this file is auto generated by scons ------#" > $($(1)_LOCATION)aos_board_conf.mk
	echo "CONFIG_ENV_CFLAGS += $(RESOURCE_CFLAGS)" >> $($(1)_LOCATION)aos_board_conf.mk
	echo "CROSS_PREFIX := $(TOOLCHAIN_PREFIX)" >> $($(1)_LOCATION)aos_board_conf.mk
