...
compdirs = [
    ...
    ['security/alicrypto', 'src/security/alicrypto'],
    ['security/id2', 'src/security/id2'],
    ['security/irot', 'src/security/irot'],
    ['security/isst', 'src/security/isst'],
    ['security/itls', 'src/security/itls'],
    ['security/mbedtls', 'src/security/mbedtls'],
    ['security/prov', 'src/security/prov'],
    ['security/tee', 'src/security/tee'],
...
for example in examples:
    ...
    for filename in os.listdir('app/example/' + example):
        if (filename.find('example') != -1 and filename.endswith('.c')) or filename == "newapi" or filename == "data":
