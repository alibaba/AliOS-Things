...
#ifndef _SMART_BT_SMART_ATTRIBUTE_H_
#define _SMART_BT_SMART_ATTRIBUTE_H_
...
#define ATTR_COMMON_FIELDS_SIZE         ( sizeof(aos_bt_smart_attribute_t*) + sizeof(uint16_t) + sizeof(aos_bt_uuid_t) + sizeof(uint8_t) + sizeof(uint32_t) + + sizeof(uint32_t))
 ...
 */
typedef enum {
    AOS_ATTRIBUTE_TYPE_NO_VALUE,                                        /* Attribute with no value                         */
    AOS_ATTRIBUTE_TYPE_LONG_VALUE,                                      /* Attribute with long value                       */
    AOS_ATTRIBUTE_TYPE_PRIMARY_SERVICE,                                 /* Primary service                                 */
    AOS_ATTRIBUTE_TYPE_INCLUDE,                                         /* Included Service                                */
    AOS_ATTRIBUTE_TYPE_CHARACTERISTIC,                                  /* Characteristic                                  */
    AOS_ATTRIBUTE_TYPE_CHARACTERISTIC_VALUE,                            /* Characteristic Value                            */
    AOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_EXTENDED_PROPERTIES,   /* Characteristic Descriptor: Extended Properties  */
    AOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_USER_DESCRIPTION,      /* Characteristic Descriptor: User Description     */
    AOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_CLIENT_CONFIGURATION,  /* Characteristic Descriptor: Client Configuration */
    AOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_SERVER_CONFIGURATION,  /* Characteristic Descriptor: Server Configuration */
    AOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_PRESENTATION_FORMAT,   /* Characteristic Descriptor: Presentation Format  */
    AOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_AGGREGATE_FORMAT       /* Characteristic Descriptor: Aggregate Format     */
} aos_bt_smart_attribute_type_t;
 ...
 * Attribute Structure
 */
typedef struct aos_bt_attribute {
    struct aos_bt_attribute
...
typedef struct {
    ...
    aos_bt_smart_attribute_t  *list;  /* Pointer to attribute linked-list */
 ...
 *                               used.
 *
 * @return AOS_BT_SUCCESS：success，AOS_BT_BADARG：input argument error
 */
