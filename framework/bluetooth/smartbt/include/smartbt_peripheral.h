...
#ifndef _SMART_BT_PERIPHERAL_H_
#define _SMART_BT_PERIPHERAL_H_
...
} aos_bt_peripheral_socket_status_t;
...
} aos_bt_peripheral_adv_filter_policy_t;
...
typedef struct _bt_ext_attribute_value_t aos_bt_ext_attribute_value_t;

/*
 * Socket to create a BT smart peripheral connection
 */
typedef struct aos_bt_peripheral_socket aos_bt_peripheral_socket_t;

/*
 * Socket connection callback
 */
typedef OSStatus (* aos_bt_peripheral_connection_callback_t) ( aos_bt_peripheral_socket_t *socket );

/*
 * Socket disconnection callback
 */
typedef OSStatus (* aos_bt_peripheral_disconnection_callback_t) ( aos_bt_peripheral_socket_t *socket );

/*
 * Attrubute request callback
 */
typedef aos_bt_gatt_status_t (* aos_bt_peripheral_attribute_handler)( aos_bt_ext_attribute_value_t *attribute,
...
struct _bt_ext_attribute_value_t {
    ...
    aos_bt_peripheral_attribute_handler    attribute_handler;
};
 ...
 */
struct aos_bt_peripheral_socket {
    aos_bt_smart_device_t
    remote_device;                  /* Remote Bluetooth device AOS is connected with (BLE server)   */
    uint16_t
    ...
    aos_bt_peripheral_connection_callback_t
    connection_callback;            /* Callback for handling connection event by remote device       */
    aos_bt_peripheral_disconnection_callback_t
...
/* Initialise the AOS BT peripheral
 *
 * @note
 ...
 *
 *
 * @return AOS_BT_SUCCESS: success , else @ref OSStatus
 */
...
/* Deinitialise the AOS BT peripheral
 *
 * @note
 ...
 *
 * @return AOS_BT_SUCCESS: success
 *         AOS_BT_SMART_APPL_UNINITIALISED: Smart peripheral framework is uninitialized
 */
 ...
 * sould be set first use aos_bt_ble_set_advertisement_data().
 *
 * @warning
 ...
 *                                            complete，running under AOS_BT_EVT_WORKER_THREAD
 *
 * @return AOS_BG_SUCCESS, else @ref OSStatus
 */
 ...
 */
aos_bt_ext_attribute_value_t *aos_bt_peripheral_ext_attribute_add( uint16_t handle, uint16_t length,
 ...
 * @return @ref OSStatus
 */
OSStatus aos_bt_peripheral_ext_attribute_remove_all( void );
