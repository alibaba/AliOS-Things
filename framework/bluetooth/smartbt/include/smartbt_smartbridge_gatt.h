...
#ifndef _SMART_BT_SMART_BRIDGE_GATT_H_
#define _SMART_BT_SMART_BRIDGE_GATT_H_
 ...
 *
 * @note
 * Additional information of the Descriptors can be read using @ref aos_bt_smartbridge_gatt_read_characteristic_descriptor()
 * and @ref aos_bt_smartbridge_gatt_read_long_characteristic_descriptor()
 *
 * @param[in]  socket          : socket that is connected to the server to discover
