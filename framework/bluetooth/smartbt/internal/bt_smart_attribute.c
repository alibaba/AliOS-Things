...
static const uint16_t fixed_attribute_size_list[] = {
    [AOS_ATTRIBUTE_TYPE_NO_VALUE                                      ] =  ATTR_NO_VALUE_SIZE,
    [AOS_ATTRIBUTE_TYPE_LONG_VALUE                                    ] =  ATTR_LONG_VALUE_SIZE,
    [AOS_ATTRIBUTE_TYPE_PRIMARY_SERVICE                               ] =  ATTR_SERVICE_SIZE,
    [AOS_ATTRIBUTE_TYPE_INCLUDE                                       ] =  ATTR_INCLUDE_SIZE,
    [AOS_ATTRIBUTE_TYPE_CHARACTERISTIC                                ] =  ATTR_CHARACTERISTIC_SIZE,
    [AOS_ATTRIBUTE_TYPE_CHARACTERISTIC_VALUE                          ] =  0, // Variable length
    [AOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_EXTENDED_PROPERTIES ] =  ATTR_EXTENDED_PROPERTIES_SIZE,
    [AOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_USER_DESCRIPTION    ] =  0, // Variable length
    [AOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_CLIENT_CONFIGURATION] =  ATTR_CLIENT_CONFIG_SIZE,
    [AOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_SERVER_CONFIGURATION] =  ATTR_SERVER_CONFIG_SIZE,
    [AOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_PRESENTATION_FORMAT ] =  ATTR_PRESENTATION_FORMAT_SIZE,
    [AOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_AGGREGATE_FORMAT    ] =  0, // Variable length
};
...
static OSStatus print_uuid( const aos_bt_uuid_t *uuid );
static OSStatus print_type( const aos_bt_uuid_t *uuid );
...
OSStatus aos_bt_smart_attribute_create( aos_bt_smart_attribute_t **attribute, aos_bt_smart_attribute_type_t type,
                                        uint16_t variable_length )
{
    ...
    switch ( type ) {
        case AOS_ATTRIBUTE_TYPE_CHARACTERISTIC_VALUE: {
            size = ATTR_CHARACTERISTIC_VALUE_SIZE( variable_length );
            break;
        }
        case AOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_USER_DESCRIPTION: {
            size = ATTR_USER_DESCRIPTION_SIZE( variable_length );
            break;
        }
        case AOS_ATTRIBUTE_TYPE_CHARACTERISTIC_DESCRIPTOR_AGGREGATE_FORMAT: {
    ...
    *attribute = (aos_bt_smart_attribute_t *)malloc_named("attribute", size );
...
OSStatus aos_bt_smart_attribute_delete( aos_bt_smart_attribute_t *attribute )
{
    if ( attribute == NULL ) {
        return AOS_BT_BADARG;
    }
...
OSStatus aos_bt_smart_attribute_create_list( aos_bt_smart_attribute_list_t *list )
{
    if ( list == NULL ) {
        return AOS_BT_BADARG;
    }
...
OSStatus aos_bt_smart_attribute_add_to_list( aos_bt_smart_attribute_list_t *list, aos_bt_smart_attribute_t *attribute )
{
    ...
    if ( list->count == 0 ) {
        ...
        aos_bt_smart_attribute_t *curr = list->list;
        aos_bt_smart_attribute_t *prev = NULL;
...
OSStatus aos_bt_smart_attribute_remove_from_list( aos_bt_smart_attribute_list_t *list, uint16_t handle )
{
    if ( list == NULL ) {
        return AOS_BT_BADARG;
    }
    ...
    if ( list->count == 0 ) {
        ...
        while ( curr != NULL ) {
            if ( curr->handle == handle ) {
                ...
                aos_bt_smart_attribute_delete( curr );
    ...
    return AOS_BT_ITEM_NOT_IN_LIST;
}

OSStatus aos_bt_smart_attribute_delete_list( aos_bt_smart_attribute_list_t *list )
{
    aos_bt_smart_attribute_t *curr;
    ...
    while ( curr != NULL ) {
        ...
        aos_bt_smart_attribute_t *next = curr->next;
...
OSStatus aos_bt_smart_attribute_search_list_by_handle( const aos_bt_smart_attribute_list_t *list, uint16_t handle,
...
OSStatus aos_bt_smart_attribute_search_list_by_uuid( const aos_bt_smart_attribute_list_t *list,
...
OSStatus aos_bt_smart_attribute_merge_lists( aos_bt_smart_attribute_list_t *trunk_list,
                                             aos_bt_smart_attribute_list_t *branch_list )
{
    aos_bt_smart_attribute_t *curr;
    ...
    while ( curr != NULL ) {
        aos_bt_smart_attribute_t *prev = curr;
        ...
        aos_bt_smart_attribute_add_to_list( trunk_list, prev );
    }
...
OSStatus aos_bt_smart_attribute_print( const aos_bt_smart_attribute_t *attribute )
{
    aos_bt_smart_attribute_t *curr_attr = (aos_bt_smart_attribute_t *)attribute;
...
OSStatus aos_bt_smart_attribute_print_list( const aos_bt_smart_attribute_list_t *list )
{
    aos_bt_smart_attribute_t *curr_attr = (aos_bt_smart_attribute_t *)list->list;

    while ( curr_attr != NULL ) {
        aos_bt_smart_attribute_print( curr_attr );
...
OSStatus aos_bt_smart_attribute_get_list_head( const aos_bt_smart_attribute_list_t *list,
                                               aos_bt_smart_attribute_t **head )
{
    if ( list == NULL ) {
        return AOS_BT_BADARG;
    }
...
OSStatus aos_bt_smart_attribute_get_list_count( const aos_bt_smart_attribute_list_t *list, uint32_t *count )
{
    if ( list == NULL ) {
        return AOS_BT_BADARG;
    }
