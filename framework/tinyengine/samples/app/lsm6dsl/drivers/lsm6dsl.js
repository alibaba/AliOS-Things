...
var lsm6dsl = new LSM6DSL();

lsm6dsl.read_one = function(addr){
    var reg=[0];
    reg[0] = addr;
...
lsm6dsl.read_two = function(addr){
...
lsm6dsl.write_one = function(addr,val){
    var data = [0,0];
    data[0]=addr; 
    data[1]=val; 
...
module.exports.lsm6dsl = lsm6dsl;