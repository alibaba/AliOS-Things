...
#define MEET_ASSIGNMENT_OP          (vm.lex->tk=='=' || vm.lex->tk==BE_TOKEN_OP_PLUS_EQUAL || vm.lex->tk==BE_TOKEN_OP_MINUS_EQUAL|| vm.lex->tk==BE_TOKEN_OP_MUL_EQUAL|| vm.lex->tk==BE_TOKEN_OP_DIV_EQUAL)
