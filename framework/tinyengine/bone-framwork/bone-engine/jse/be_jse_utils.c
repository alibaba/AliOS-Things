...
NO_INLINE void be_jse_error_at(const char *message, be_jse_lexer_ctx_t *lex, int tokenPos)
{
    int line,col;
...
NO_INLINE void be_jse_warn_at(const char *message, be_jse_lexer_ctx_t *lex, int tokenPos)
{
    int line,col;
    lexer_dump_line_and_col(lex, tokenPos, &line, &col);
    be_jse_execute_error();
