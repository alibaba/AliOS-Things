...
static const char string_dm_thing_manager_class_name[] __DM_READ_ONLY__ =
  "dm_thg_mng_cls";
static const char string_thing_service_property_set[] __DM_READ_ONLY__ =
  "thing.service.property.set";
static const char string_thing_service_property_get[] __DM_READ_ONLY__ =
  "thing.service.property.get";
static const char string_thing_event_property_post[] __DM_READ_ONLY__ =
  "thing.event.property.post";
static const char string_method_name_thing_enable[] __DM_READ_ONLY__ =
  METHOD_NAME_THING_ENABLE;
static const char string_method_name_thing_disable[] __DM_READ_ONLY__ =
...
static const char string_method_name_thing_tsl_get_reply[] __DM_READ_ONLY__ =
  METHOD_NAME_THING_TSL_GET_REPLY;
static const char string_method_name_down_raw[] __DM_READ_ONLY__ =
  METHOD_NAME_DOWN_RAW;
static const char string_method_name_down_raw_reply[] __DM_READ_ONLY__ =
  METHOD_NAME_DOWN_RAW_PEPLY;
static const char string_method_name_up_raw[] __DM_READ_ONLY__ =
  METHOD_NAME_UP_RAW;
static const char string_method_name_up_raw_reply[] __DM_READ_ONLY__ =
  METHOD_NAME_UP_RAW_REPLY;
static const char string_method_name_property_set[] __DM_READ_ONLY__ =
  METHOD_NAME_PROPERTY_SET;
static const char string_method_name_property_get[] __DM_READ_ONLY__ =
  METHOD_NAME_PROPERTY_GET;
#ifdef SUBDEV_ENABLE
static const char string_method_name_topo_add[] __DM_READ_ONLY__ =
  METHOD_NAME_TOPO_ADD;
static const char string_method_name_topo_add_reply[] __DM_READ_ONLY__ =
  METHOD_NAME_TOPO_ADD_REPLY;
static const char string_method_name_topo_del[] __DM_READ_ONLY__ =
  METHOD_NAME_TOPO_DEL;
static const char string_method_name_topo_del_reply[] __DM_READ_ONLY__ =
  METHOD_NAME_TOPO_DEL_REPLY;
static const char string_method_name_topo_get[] __DM_READ_ONLY__ =
  METHOD_NAME_TOPO_GET;
static const char string_method_name_topo_get_reply[] __DM_READ_ONLY__ =
  METHOD_NAME_TOPO_GET_REPLY;
static const char string_method_name_sub_register[] __DM_READ_ONLY__ =
  METHOD_NAME_SUB_REGISTER;
static const char string_method_name_sub_register_reply[] __DM_READ_ONLY__ =
  METHOD_NAME_SUB_REGISTER_REPLY;
static const char string_method_name_sub_unregister[] __DM_READ_ONLY__ =
  METHOD_NAME_SUB_UNREGISTER;
static const char string_method_name_sub_unregister_reply[] __DM_READ_ONLY__ =
  METHOD_NAME_SUB_UNREGISTER_REPLY;
static const char string_method_name_sub_login[] __DM_READ_ONLY__ =
  METHOD_NAME_SUB_LOGIN;
static const char string_method_name_sub_login_reply[] __DM_READ_ONLY__ =
  METHOD_NAME_SUB_LOGIN_REPLY;
static const char string_method_name_sub_logout[] __DM_READ_ONLY__ =
  METHOD_NAME_SUB_LOGOUT;
static const char string_method_name_sub_logout_reply[] __DM_READ_ONLY__ =
  METHOD_NAME_SUB_LOGOUT_REPLY;
static const char string_method_name_sub_gw_permit[] __DM_READ_ONLY__ =
  METHOD_NAME_SUB_GW_PERMIT;
static const char string_method_name_sub_gw_permit_reply[] __DM_READ_ONLY__ =
  METHOD_NAME_SUB_GW_PERMIT_REPLY;
#endif
#ifdef EXTENDED_INFO_ENABLED
static const char string_method_name_deviceinfo_update[] __DM_READ_ONLY__ =
  METHOD_NAME_DEVICEINFO_UPDATE;
static const char
  string_method_name_deviceinfo_update_reply[] __DM_READ_ONLY__ =
    METHOD_NAME_DEVICEINFO_UPDATE_REPLY;
static const char string_method_name_deviceinfo_delete[] __DM_READ_ONLY__ =
  METHOD_NAME_DEVICEINFO_DELETE;
static const char
  string_method_name_deviceinfo_delete_reply[] __DM_READ_ONLY__ =
    METHOD_NAME_DEVICEINFO_DELETE_REPLY;
#endif /* EXTENDED_INFO_ENABLED */
#ifdef RRPC_ENABLED
static const char string_method_name_rrpc_request_plus[] __DM_READ_ONLY__ =
  METHOD_NAME_RRPC_REQUEST_PLUS;
...
static const char string_cm_event_handler_prompt_end[] __DM_READ_ONLY__ =
  "\n###\n";
static const char string_cm_event_type_cloud_connected[] __DM_READ_ONLY__ =
  "cloud connected";
static const char string_cm_event_type_cloud_disconnect[] __DM_READ_ONLY__ =
  "cloud disconnect";
static const char string_cm_event_type_cloud_reconnect[] __DM_READ_ONLY__ =
  "cloud reconnect";
#ifdef LOCAL_CONN_ENABLE
static const char string_cm_event_type_local_connected[] __DM_READ_ONLY__ =
  "local connected";
static const char string_cm_event_type_local_disconnect[] __DM_READ_ONLY__ =
  "local disconnect";
static const char string_cm_event_type_local_reconnect[] __DM_READ_ONLY__ =
  "local reconnect";
static const char string_dev_core_service_dev[] __DM_READ_ONLY__ =
  "/dev/core/service/dev";
static const char string_method_name_property_post[] __DM_READ_ONLY__ =
  METHOD_NAME_PROPERTY_POST;
static const char string_method_name_property_post_reply[] __DM_READ_ONLY__ =
  METHOD_NAME_PROPERTY_POST_REPLY;
#endif
static const char string_cm_event_type_found_device[] __DM_READ_ONLY__ =
  "found device";
static const char string_cm_event_type_remove_device[] __DM_READ_ONLY__ =
  "remove device";
static const char string_cm_event_type_register_result[] __DM_READ_ONLY__ =
  "register result";
static const char string_cm_event_type_unregister_result[] __DM_READ_ONLY__ =
  "unregister result";
static const char string_cm_event_type_send_result[] __DM_READ_ONLY__ =
  "send result";
static const char string_cm_event_type_new_data_received[] __DM_READ_ONLY__ =
  "new data received";
...
#ifdef SUBDEV_ENABLE
static const char string_subdev_callback_list[] __DM_READ_ONLY__ =
  "subdev callback list";
static const char string_subdev_request_list[] __DM_READ_ONLY__ =
  "subdev request list";
#endif
static const char
  string_service_property_get_identifier_list[] __DM_READ_ONLY__ =
    "service property get id list";
...
static void  generate_subscribe_uri(void *_dm_thing_manager, void *_thing,
                                    int cloud, int subdev, char *pk, char *dn);
static void  send_request_to_uri(void *_dm_thing_manager, const char *_uri);
static void  clear_and_set_message_info(message_info_t **   _message_info,
                                        dm_thing_manager_t *_dm_thing_manager);
static void  get_product_key_device_name(char *_product_key, char *_device_name,
                                         void *_thing, void *_dm_thing_manager);
static void *dm_thing_manager_generate_new_local_thing(void *      _self,
                                                       const char *tsl,
                                                       int         tsl_len);
static int   dm_thing_manager_set_thing_property_value(void *      _self,
                                                       const void *thing_id,
                                                       const void *identifier,
                                                       const void *value,
                                                       const char *value_str);
static int   dm_thing_manager_install_product_key_device_name(
    void *_self, const void *thing_id, char *product_key, char *device_name);
static int dm_thing_manager_trigger_event(void *_self, const void *thing_id,
                                          const void *event_identifier,
                                          const char *property_identifier);

#ifdef LOCAL_CONN_ENABLE
static void dm_cm_local_conn_register_handler(iotx_cm_send_peer_t *   _source,
                                              iotx_cm_message_info_t *_msg,
                                              void *user_data);
#endif

#ifdef SUBDEV_ENABLE
static int  send_subdev_login_message(void *_self, const char *subdev_pk,
                                      const char *subdev_dn,
                                      const char *subdev_ds, int _clean_session,
                                      char *hmac_method);
static int  send_subdev_topo_add_message(void *_self, const char *subdev_pk,
                                         const char *subdev_dn,
                                         const char *subdev_ds,
                                         char *      hmac_method);
static void invoke_subdev_callback_func(void *   _subdev_callback_fp,
                                        va_list *params);
static void subdev_callback_list_iterator(const void *_self,
                                          handle_fp_t handle_fp);
static request_info_t *find_topo_add_request_info_by_id(void *_dm_thing_manager,
                                                        int   request_id);
static request_info_t *find_topo_delete_request_info_by_id(
  void *_dm_thing_manager, int request_id);
static void            free_sub_request_node(void *          _dm_thing_manager,
                                             request_info_t *node);
static request_info_t *find_subdev_login_request_info_by_id(
  void *_dm_thing_manager, int request_id);
static request_info_t *find_subdev_logout_request_info_by_id(
  void *_dm_thing_manager, int request_id);
static request_info_t *find_subdev_register_request_info_by_id(
  void *_dm_thing_manager, int request_id);
...
static int   check_update_subdev_permit_time(
    dm_thing_manager_t *_dm_thing_manager);
extern void dm_lltoa(long long n, char *str, int radix);
void *      dm_thing_manager_query_thing_id(void *_self, const char *pk,
                                            const char *dn, int *is_subthing);
#endif

#ifdef RRPC_ENABLED
static int dm_thing_manager_answer_service(void *_self, const void *thing_id,
                                           const void *identifier,
...
static void dm_cm_register_handler(iotx_cm_send_peer_t *   _source,
                                   iotx_cm_message_info_t *_msg,
                                   void *                  user_data);
...
static void invoke_callback_list(void *             _dm_thing_manager,
                                 dm_callback_type_t dm_callback_type)
{
...
#ifdef SUBDEV_ENABLE
static void invoke_subdev_callback_list(
  void *_dm_thing_manager, dm_subdev_callback_type_t dm_subdev_callback_type)
{
    dm_thing_manager_t *dm_thing_manager = _dm_thing_manager;
    list_t **           list;
    ...
    if (list && !(*list)->empty(list)) {
        ...
        subdev_callback_list_iterator(dm_thing_manager,
                                      invoke_subdev_callback_func);
    }
}
#endif
                                ...
                                void *user_data)
{
    ...
    if (IOTX_CM_EVENT_REGISTER_RESULT == msg->event_id) {
        iotx_cm_event_result_t *cm_event_result =
          (iotx_cm_event_result_t *)msg->msg;

        dm_log_info("register result:\tresult: %d(%s)\tURI: %s\t",
                    cm_event_result->result,
        ...
        dm_log_info("un-register result:\tresult: %s,\tURI: %s,\t",
                    cm_event_result->result, cm_event_result->URI);
        ...
        if (dm_thing_manager->_cloud_connected == 0) {
            ...
            generate_subscribe_uri(dm_thing_manager, NULL, 1, 0,
                                   ...
                                   dm_thing_manager->_device_name);
#ifdef _PLATFORM_IS_LINUX_
            dm_snprintf(file_name, sizeof(file_name), string_tsl_file_pattern,
                        dm_thing_manager->_product_key,
                        dm_thing_manager->_device_name);
            file_content = read_file(file_name);
            if (file_content) {
                thing = dm_thing_manager_generate_new_local_thing(
                  dm_thing_manager, file_content, strlen(file_content));
                if (NULL == thing) {
            ...
            list_iterator(list, local_thing_generate_subscribe_uri,
                          dm_thing_manager, 1);
        ...
        if (strstr(new_data->message_info->URI, string_dev_core_service_dev)) {
            dm_cm_local_conn_register_handler(
              new_data->peer, new_data->message_info, dm_thing_manager);
        } else {
            dm_cm_register_handler(new_data->peer, new_data->message_info,
                                   dm_thing_manager);
        }
#else
        dm_cm_register_handler(new_data->peer, new_data->message_info,
    ...
    dm_printf("\nevent %d(%s)%s", msg->event_id, event_str,
              string_cm_event_handler_prompt_end);
    HAL_MutexUnlock(g_dm_thing_manager_usercall_mutex);
    HAL_MutexUnlock(g_dm_thing_manager_callback_mutex);
}
...
static void print_iotx_cm_message_info(const void *_source, const void *_msg)
{
    ...
    dm_printf("***\nsource\t%s:%s\n", iotx_cm_send_peer->product_key,
              iotx_cm_send_peer->device_name);

    dm_printf("type\t%s\n",
              iotx_cm_message_info->message_type == IOTX_CM_MESSAGE_RAW
                ? "RAW"
                : (iotx_cm_message_info->message_type == IOTX_CM_MESSAGE_REQUEST
                     ? string_request
                     : string_response));
...
static int check_set_lite_property_for_struct(cJSON *          cjson_obj,
...
static void find_and_set_array_item(dm_thing_manager_t *dm_thing_manager,
                                    thing_t **thing, cJSON *cjson_arr_obj,
                                    int              item_index,
                                    lite_property_t *lite_property,
                                    data_type_type_t type)
{
    ...
    if (item_index > lite_property->data_type.value.data_type_array_t.size) {
        dm_printf("input json array item:%d > lite json array size:%d ",
                  item_index,
                  lite_property->data_type.value.data_type_array_t.size);
        return;
    }
    ...
    switch (lite_property->data_type.value.data_type_array_t.item_type) {
        ...
        case data_type_type_text: {
            string_val =
              dm_lite_calloc(1, strlen(arr_json_item->valuestring) + 1);
            assert(string_val);
            if (string_val == NULL) {
                dm_printf("NO memory...");
                return;
        ...
        default: {
            dm_log_err(
              "don't support %d type",
              lite_property->data_type.value.data_type_array_t.item_type);
            goto do_exit;
        }
    }
    ...
    if (string_val) {
        ...
        dm_thing_manager->_property_identifier_value_set =
          dm_lite_calloc(1, strlen(temp_buf) + 1);
        assert(dm_thing_manager->_property_identifier_value_set);
        strcpy(dm_thing_manager->_property_identifier_value_set, temp_buf);
    }

    if (dm_thing_manager->_property_identifier_set &&
        dm_thing_manager->_property_identifier_value_set) {
        dm_snprintf(identifier, sizeof(identifier), "%s[%d]",
                    (char *)dm_thing_manager->_property_identifier_set,
                    item_index);
        dm_thing_manager_set_thing_property_value(
          dm_thing_manager, thing, identifier, NULL,
          dm_thing_manager->_property_identifier_value_set);
...
static void find_and_set_lite_property_struct_for_service_property_set(
  void *_item, ...);
static void find_and_set_lite_property_for_service_property_set(void *   _item,
                                                                int      _index,
                                                                va_list *params)
{
    ...
    assert(property && dm_thing_manager && property_set_param_obj && thing &&
           *thing);

    lite_property = (lite_property_t *)property;

    temp_cjson_obj =
      cJSON_GetObjectItem(property_set_param_obj, lite_property->identifier);
    if (temp_cjson_obj) {
        if (identifier_prefix) {
            dm_snprintf(identifier_buff, sizeof(identifier_buff), "%s%c%s",
                        identifier_prefix, DEFAULT_TSL_DELIMITER,
                        lite_property->identifier);
        ...
        if (lite_property->data_type.type == data_type_type_text) {
            ...
            string_val =
              dm_lite_calloc(1, strlen(temp_cjson_obj->valuestring) + 1);
            assert(string_val);
            if (string_val == NULL) {
                dm_printf("NO memory...");
                return;
...
#else
            string_val =
              dm_lite_calloc(1, temp_cjson_obj->valuestring_length + 1);
            assert(string_val);
            if (string_val == NULL) {
                dm_printf("NO memory...");
                return;
            }
            strncpy(string_val, temp_cjson_obj->valuestring,
                    temp_cjson_obj->valuestring_length);
#endif
            ...
            if (temp_cjson_obj->type == cJSON_String) {
                dm_snprintf(temp_buf, sizeof(temp_buf), "%s",
                            temp_cjson_obj->valuestring);
            } else if (temp_cjson_obj->type == cJSON_Number) {
                dm_snprintf(temp_buf, sizeof(temp_buf), "%lf",
                            temp_cjson_obj->valuedouble);
            }
            ...
            for (index = 0;
                 index < lite_property->data_type.data_type_specs_number;
                 ++index) {
                lite_property_struct =
                  (lite_property_t *)lite_property->data_type.specs + index;
                find_and_set_lite_property_struct_for_service_property_set(
                  lite_property_struct, dm_thing_manager, temp_cjson_obj, thing,
                  lite_property->identifier);
            }
            ...
            if (arrsize >
                lite_property->data_type.value.data_type_array_t.size) {
                dm_printf(
                  "input json array item:%d > lite json array item:%d ",
                  arrsize,
                  lite_property->data_type.value.data_type_array_t.size);
                return;
            }
            for (index = 0; index < arrsize; index++) {
                find_and_set_array_item(dm_thing_manager, thing, temp_cjson_obj,
                                        index, lite_property,
                                        lite_property->data_type.type);
            }
            dm_thing_manager->_identifier = lite_property->identifier;
            invoke_callback_list(dm_thing_manager,
                                 dm_callback_type_property_value_set);
    ...
    if (dm_thing_manager->_property_identifier_set &&
        dm_thing_manager->_property_identifier_value_set) {
        dm_thing_manager_set_thing_property_value(
          dm_thing_manager, thing, dm_thing_manager->_property_identifier_set,
...
static void find_thing_via_product_key_and_device_name(void *   _thing,
                                                       va_list *params)
{
    thing_t **           thing = _thing;
    dm_thing_manager_t * dm_thing_manager;
    ...
    if (strcmp(product_key, iotx_cm_send_peer->product_key) == 0 &&
        strcmp(device_name, iotx_cm_send_peer->device_name) == 0) {
        dm_thing_manager->_thing_id = thing;
    }
}

static int set_service_array_input(dm_thing_manager_t *_dm_thing_manager,
                                   thing_t **thing, cJSON *cjson_arr_obj,
                                   int              item_index,
                                   lite_property_t *lite_property,
                                   data_type_type_t type, char *_identifier)
{
    int    ret = -1;
    int    int_val;
    float  float_val;
    ...
    if (!_dm_thing_manager || !thing || !cjson_arr_obj || item_index < 0 ||
        !lite_property || !_identifier) {
    ...
    if (strlen(temp_buf) > 0) {
        dm_snprintf(identifier, sizeof(identifier), "%s[%d]", _identifier,
                    item_index);
        (*thing)->set_service_input_output_data_value_by_identifier(
          thing, identifier, NULL, temp_buf);
        ret = 0;
    }
do_exit:
    return ret;
...
static int parse_and_set_service_input(dm_thing_manager_t *_dm_thing_manager,
                                       thing_t **thing, service_t *service,
                                       char *parameter)
{
    cJSON *          obj = NULL;
    cJSON *          item;
    ...
    for (i = 0; i < service->service_input_data_num; i++) {
        ...
        switch (property->data_type.type) {
            case data_type_type_text: {
                ...
                strncpy(string_val, item->valuestring,
                        item->valuestring_length);
#endif /* CJSON_STRING_ZEROCOPY */
                (*thing)->set_service_input_output_data_value_by_identifier(
                  thing, identifier, NULL, string_val);
            ...
            case data_type_type_int:
                (*thing)->set_service_input_output_data_value_by_identifier(
                  thing, identifier, &item->valueint, NULL);
                break;
            case data_type_type_float:
            case data_type_type_double:
            case data_type_type_date:
                (*thing)->set_service_input_output_data_value_by_identifier(
                  thing, identifier, &item->valuedouble, NULL);
                break;
            case data_type_type_array:
                arr_size = cJSON_GetArraySize(item);
                for (arr_index = 0; arr_index < arr_size; arr_index++) {
                    set_service_array_input(
                      dm_thing_manager, thing, item, arr_index, property,
                      property->data_type.type, identifier);
                }
                break;
            default:
                break;
...
typedef void (*dm_cm_register_uri_handler_fp_t)(
  dm_thing_manager_t *    _dm_thing_manager,
  iotx_cm_message_info_t *_cm_message_info);

static void dm_cm_register_uri_handler_tsl_get_reply(
  dm_thing_manager_t *    _dm_thing_manager,
  iotx_cm_message_info_t *_cm_message_info)
{
    dm_thing_manager_t *    dm_thing_manager = _dm_thing_manager;
    ...
    if (dm_thing_manager->_is_subthing && dm_thing_manager->_sub_thing_id) {
        ...
        (*thing)->set_tsl_string(thing, cm_message_info->parameter,
        ...
        thing = dm_thing_manager_generate_new_local_thing(
          dm_thing_manager, cm_message_info->parameter,
          cm_message_info->parameter_length);
        if (NULL == thing) {
            dm_log_err("generate new thing failed");
            return;
...
#ifdef _PLATFORM_IS_LINUX_
    dm_snprintf(file_name, sizeof(file_name), string_tsl_file_pattern,
                (*thing)->return_product_key(thing),
                (*thing)->return_device_name(thing));
...
static void dm_cm_register_uri_handler_property_set(
  dm_thing_manager_t *    _dm_thing_manager,
  iotx_cm_message_info_t *_cm_message_info)
{
    dm_thing_manager_t *    dm_thing_manager = _dm_thing_manager;
    ...
    dm_thing_manager_answer_service(
      dm_thing_manager, thing, dm_thing_manager->_service_identifier_requested,
...
static void dm_cm_register_uri_handler_property_get(
  dm_thing_manager_t *    _dm_thing_manager,
  iotx_cm_message_info_t *_cm_message_info)
{
    dm_thing_manager_t *    dm_thing_manager = _dm_thing_manager;
    ...
    if (property_get_param_obj == NULL ||
        cJSON_IsArray(property_get_param_obj) == 0) {
        dm_log_err("UNABLE to resolve %s params format",
                   string_method_name_property_get);
        return;
    }

    array_size = cJSON_GetArraySize(property_get_param_obj);
    for (index = 0; index < array_size; ++index) {
        property_get_param_item_obj =
          cJSON_GetArrayItem(property_get_param_obj, index);
        assert(cJSON_IsString(property_get_param_item_obj));
#ifndef CJSON_STRING_ZEROCOPY
        property_get_param_identifier = dm_lite_calloc(
          1, strlen(property_get_param_item_obj->valuestring) + 1);
        strcpy(property_get_param_identifier,
               property_get_param_item_obj->valuestring);
#else
        property_get_param_identifier = dm_lite_calloc(
          1, property_get_param_item_obj->valuestring_length + 1);
        strncpy(property_get_param_identifier,
                property_get_param_item_obj->valuestring,
...
static void dm_cm_register_uri_handler_thing_enable(
  dm_thing_manager_t *    _dm_thing_manager,
  iotx_cm_message_info_t *_cm_message_info)
{
    dm_thing_manager_t *dm_thing_manager = _dm_thing_manager;
...
static void dm_cm_register_uri_handler_thing_disable(
  dm_thing_manager_t *    _dm_thing_manager,
  iotx_cm_message_info_t *_cm_message_info)
{
    dm_thing_manager_t *dm_thing_manager = _dm_thing_manager;
...
#ifdef RRPC_ENABLED
static void dm_cm_register_uri_handler_rrpc_request(
  dm_thing_manager_t *    _dm_thing_manager,
  iotx_cm_message_info_t *_cm_message_info)
{
    dm_thing_manager_t *    dm_thing_manager = _dm_thing_manager;
...
#endif /* RRPC_NEW */
    /* invoke callback funtions. */
    dm_thing_manager->_identifier =
      dm_thing_manager->_service_identifier_requested;
#ifdef SUBDEV_ENABLE
...
static void dm_cm_register_uri_handler_deviceinfo_update_reply(
  dm_thing_manager_t *    _dm_thing_manager,
  iotx_cm_message_info_t *_cm_message_info)
{}

static void dm_cm_register_uri_handler_deviceinfo_delete_reply(
  dm_thing_manager_t *    _dm_thing_manager,
  iotx_cm_message_info_t *_cm_message_info)
{}
...
#ifdef SUBDEV_ENABLE
static void dm_cm_register_uri_handler_topo_add_reply(
  dm_thing_manager_t *    _dm_thing_manager,
  iotx_cm_message_info_t *_cm_message_info)
{
    dm_thing_manager_t *    dm_thing_manager = _dm_thing_manager;
    ...
    request_info =
      find_topo_add_request_info_by_id(dm_thing_manager, cm_message_info->id);

    if (!request_info) {
        dm_log_err("cannot find node from topo_add_request_info, request_id:%d",
                   cm_message_info->id);
    } else {
...
static void dm_cm_register_uri_handler_topo_delete_reply(
  dm_thing_manager_t *    _dm_thing_manager,
  iotx_cm_message_info_t *_cm_message_info)
{
    dm_thing_manager_t *    dm_thing_manager = _dm_thing_manager;
    ...
    /* invoke callback functions. */
    request_info = find_topo_delete_request_info_by_id(dm_thing_manager,
                                                       cm_message_info->id);

    if (!request_info) {
        dm_log_err(
          "cannot find node from topo_delete_request_info, request_id:%d",
          cm_message_info->id);
    } else {
        dm_thing_manager->_code         = cm_message_info->code;
        dm_thing_manager->_sub_thing_id = request_info->thing_id;
        ...
        if (dm_thing_manager->_code == 200) {
            invoke_subdev_callback_list(
              dm_thing_manager, dm_subdev_callback_type_topo_delete_success);
        } else {
            invoke_subdev_callback_list(
              dm_thing_manager, dm_subdev_callback_type_topo_delete_fail);
        }
        free_sub_request_node(dm_thing_manager, request_info);
        dm_lite_free(request_info);
    }
...
static void dm_cm_register_uri_handler_permit_join(
  dm_thing_manager_t *    _dm_thing_manager,
  iotx_cm_message_info_t *_cm_message_info)
{
    dm_thing_manager_t *    dm_thing_manager = _dm_thing_manager;
    ...
    if (pk) {
        ...
        memset(dm_thing_manager->_permit_pk, 0,
               sizeof(dm_thing_manager->_permit_pk));
    }

    dm_thing_manager->_permit_time_ms = time_s * 1000;
    dm_thing_manager->_uptime_ms      = HAL_UptimeMs();

    dm_log_debug("permit_pk:%s, time:%d",
                 dm_thing_manager->_permit_pk ? dm_thing_manager->_permit_pk
                                              : "NULL",
                 time_s);
    ...
    dm_snprintf(uri_buff, sizeof(uri_buff), "/sys/%s/%s/%s_reply",
                dm_thing_manager->_product_key, dm_thing_manager->_device_name,
                string_method_name_sub_gw_permit);
    (*message_info)
      ->set_product_key(message_info, dm_thing_manager->_product_key);
    (*message_info)
      ->set_device_name(message_info, dm_thing_manager->_device_name);
    (*message_info)->set_uri(message_info, uri_buff);
    (*message_info)
      ->set_message_type(message_info, DM_CM_MSG_INFO_MESSAGE_TYPE_RESPONSE);
...
static void dm_cm_register_uri_handler_sub_login_reply(
  dm_thing_manager_t *    _dm_thing_manager,
  iotx_cm_message_info_t *_cm_message_info)
{
    dm_thing_manager_t *    dm_thing_manager = _dm_thing_manager;
    ...
    request_info = find_subdev_login_request_info_by_id(dm_thing_manager,
                                                        cm_message_info->id);

    if (!request_info) {
        dm_log_err("cannot find node from subdev_login_request, request_id:%d",
                   cm_message_info->id);
    } else {
        dm_thing_manager->_code     = cm_message_info->code;
        dm_thing_manager->_message  = cm_message_info->message;
        dm_thing_manager->_thing_id = dm_thing_manager->_sub_thing_id =
          request_info->thing_id;
        ...
        if ((*sub_thing)->get_property_number(sub_thing) == 0 &&
            ...
            (*sub_thing)->get_event_number(sub_thing) == 0) {
            /* get tsl template. */
            dm_thing_manager->_thing_id = sub_thing;
            /* subscribe uris not related to tsl. */
            generate_subscribe_uri(dm_thing_manager, NULL, 1, 1,
                                   (*sub_thing)->return_product_key(sub_thing),
            ...
            if (file_content) {
                (*sub_thing)
                  ->set_tsl_string(sub_thing, file_content,
                                   strlen(file_content));
                dm_lite_free(file_content);
            } else
#endif /* _PLATFORM_IS_LINUX_ */
...
static void dm_cm_register_uri_handler_sub_logout_reply(
  dm_thing_manager_t *    _dm_thing_manager,
  iotx_cm_message_info_t *_cm_message_info)
{
    dm_thing_manager_t *    dm_thing_manager = _dm_thing_manager;
    ...
    request_info = find_subdev_logout_request_info_by_id(dm_thing_manager,
                                                         cm_message_info->id);
    if (!request_info) {
        dm_log_err("cannot find node from subdev_logout_request, request_id:%d",
                   cm_message_info->id);
    } else {
        dm_thing_manager->_code     = cm_message_info->code;
        dm_thing_manager->_message  = cm_message_info->message;
...
static void dm_cm_register_uri_handler_sub_register_reply(
  dm_thing_manager_t *    _dm_thing_manager,
  iotx_cm_message_info_t *_cm_message_info)
{
    dm_thing_manager_t *    dm_thing_manager = _dm_thing_manager;
    ...
    request_info = find_subdev_register_request_info_by_id(dm_thing_manager,
                                                           cm_message_info->id);

    if (!request_info) {
        dm_log_err(
          "cannot find node from subdev_register_request, request_id:%d",
          cm_message_info->id);
    } else {
        dm_thing_manager->_code     = cm_message_info->code;
        dm_thing_manager->_message  = cm_message_info->message;
        ...
        if (dm_thing_manager->_code == 200) {
            register_response_data_obj =
              cJSON_Parse(cm_message_info->parameter);

            assert(register_response_data_obj &&
                   cJSON_IsArray(register_response_data_obj));

            if (register_response_data_obj == NULL ||
                cJSON_IsArray(register_response_data_obj) == 0) {
                dm_log_err("UNABLE to resolve %s params format",
                           string_method_name_sub_register);
                return;
            }
            ...
            assert(array_size == 1);
            for (index = 0; index < array_size; ++index) {
                register_response_data_item_obj =
                  cJSON_GetArrayItem(register_response_data_obj, index);
                assert(cJSON_IsObject(register_response_data_item_obj));

                product_key_obj = cJSON_GetObjectItem(
                  register_response_data_item_obj, "productKey");

                device_namet_obj = cJSON_GetObjectItem(
                  register_response_data_item_obj, "deviceName");

                assert(product_key_obj && device_namet_obj &&
                       strcmp(product_key_obj->valuestring,
                              request_info->product_key) == 0 &&
                       strcmp(device_namet_obj->valuestring,
                              request_info->device_name) == 0);

                device_secret_obj = cJSON_GetObjectItem(
...
#else
                strncpy(subdev_secret, device_secret_obj->valuestring,
                        device_secret_obj->valuestring_length);
#endif
            }
            ...
            dm_thing_manager->_subdev_pk_from_register =
              request_info->product_key;
            dm_thing_manager->_subdev_dn_from_register =
              request_info->device_name;
            invoke_subdev_callback_list(
              dm_thing_manager, dm_subdev_callback_type_register_success);
            invoke_callback_list(dm_thing_manager,
                                 dm_callback_type_subthing_registered);

            send_subdev_topo_add_message(
              dm_thing_manager, request_info->product_key,
              request_info->device_name, subdev_secret, "hmacsha1");
        } else {
            thing_t **sub_thing;
            int       is_sub_thing;
            dm_thing_manager->_subdev_pk_from_register =
            ...
            sub_thing = dm_thing_manager_query_thing_id(
              dm_thing_manager, dm_thing_manager->_subdev_pk_from_register,
              dm_thing_manager->_subdev_dn_from_register, &is_sub_thing);
...
#ifdef LOCAL_CONN_ENABLE
static void dm_cm_register_uri_handler_property_post(
  dm_thing_manager_t *    _dm_thing_manager,
  iotx_cm_message_info_t *_cm_message_info)
{
    dm_thing_manager_t *    dm_thing_manager = _dm_thing_manager;
...
static void dm_cm_register_uri_handler_normal_service(
  dm_thing_manager_t *    _dm_thing_manager,
  iotx_cm_message_info_t *_cm_message_info)
{
    dm_thing_manager_t *dm_thing_manager = _dm_thing_manager;
...
static void dm_cm_register_uri_handler_event_response(
  dm_thing_manager_t *    _dm_thing_manager,
  iotx_cm_message_info_t *_cm_message_info)
{}

static dm_cm_register_uri_handler_fp_t dm_cm_register_uri_handler_choose(
  dm_thing_manager_t *    _dm_thing_manager,
  iotx_cm_message_info_t *_cm_message_info)
{
    ...
    if (
      ...
      strstr(cm_message_info->URI,
        ...
        dm_cm_register_uri_handler_fp = dm_cm_register_uri_handler_property_get;
                 ...
                 cm_message_info->URI,
                 string_method_name_thing_enable)) { /* thing/enable match */
        dm_cm_register_uri_handler_fp = dm_cm_register_uri_handler_thing_enable;
    } else if (strstr(
                 cm_message_info->URI,
                 string_method_name_thing_disable)) { /* thing/disable match */
        dm_cm_register_uri_handler_fp =
          dm_cm_register_uri_handler_thing_disable;
#ifdef RRPC_ENABLED
    } else if (strstr(cm_message_info->URI, string_method_name_rrpc_request) ||
               strstr(cm_message_info->URI,
                      "/ext/rrpc/")) { /* rrpc/request match */
      ...
      strstr(
        ...
        dm_cm_register_uri_handler_fp =
          dm_cm_register_uri_handler_topo_add_reply;
    } else if (strstr(cm_message_info->URI,
                      string_method_name_sub_login_reply)) {
        dm_cm_register_uri_handler_fp =
          dm_cm_register_uri_handler_sub_login_reply;
    } else if (strstr(cm_message_info->URI,
                      string_method_name_sub_logout_reply)) {
        dm_cm_register_uri_handler_fp =
          dm_cm_register_uri_handler_sub_logout_reply;
    } else if (strstr(cm_message_info->URI,
                      string_method_name_topo_del_reply)) {
        dm_cm_register_uri_handler_fp =
          dm_cm_register_uri_handler_topo_delete_reply;
    } else if (strstr(cm_message_info->URI,
                      string_method_name_sub_register_reply)) {
        dm_cm_register_uri_handler_fp =
          dm_cm_register_uri_handler_sub_register_reply;
        ...
        dm_cm_register_uri_handler_fp =
          dm_cm_register_uri_handler_property_post;
#endif
    } else if (cm_message_info->message_type ==
               IOTX_CM_MESSAGE_REQUEST) { /* normal service. */
        dm_cm_register_uri_handler_fp =
          dm_cm_register_uri_handler_normal_service;
    } else if (cm_message_info->message_type ==
               IOTX_CM_MESSAGE_RESPONSE) { /* event resonse. */
        dm_cm_register_uri_handler_fp =
          dm_cm_register_uri_handler_event_response;
    }

    return dm_cm_register_uri_handler_fp;
}

static void dm_cm_register_handler_clear_message_info(
  iotx_cm_message_info_t *_cm_message_info)
{
    iotx_cm_message_info_t *cm_message_info = _cm_message_info;
...
static void dm_cm_register_handler_message_type_process(
  dm_thing_manager_t *    _dm_thing_manager,
  iotx_cm_message_info_t *_cm_message_info)
{
    dm_thing_manager_t *    dm_thing_manager = _dm_thing_manager;
    ...
    if (cm_message_info->message_type == IOTX_CM_MESSAGE_REQUEST) {
        ...
        service_iterator(thing, find_and_set_service_input, dm_thing_manager,
                         cm_message_info, thing);
        ...
        if (!strstr(cm_message_info->URI,
                    string_method_name_thing_tsl_get_reply)) {
                                   ...
                                   void *                  user_data)
{
    ...
    dm_thing_manager->_thing_id =
      query_thing_id_by_uri(dm_thing_manager, cm_message_info->URI);
#else
    dm_thing_manager->_thing_id = NULL;
    list_iterator(dm_thing_manager->_local_thing_list,
                  find_thing_via_product_key_and_device_name, dm_thing_manager,
                  iotx_cm_send_peer);
#endif
    if (dm_thing_manager->_thing_id == NULL &&
        strstr(cm_message_info->URI, string_method_name_thing_tsl_get_reply) ==
          NULL) {
    ...
    dm_cm_register_handler_message_type_process(dm_thing_manager,
                                                cm_message_info);
...
static void send_request_to_uri(void *_dm_thing_manager, const char *_uri)
{
    ...
    dm_snprintf(uri_buff, sizeof(uri_buff), "/sys/%s/%s/%s", product_key,
                device_name, uri);
    ...
    (*message_info)->set_uri(message_info, uri_buff);
    (*message_info)
      ->set_message_type(message_info, DM_CM_MSG_INFO_MESSAGE_TYPE_REQUEST);
                                              ...
                                              void *                  user_data)
{
    ...
    if (strstr(cm_message_info->URI, string_dev_core_service_dev)) {
        ...
        dm_snprintf(response_data, sizeof(response_data),
                    "{\"deviceModel\":{\"profile\":{\"productKey\":\"%s\","
                    "\"deviceName\":\"%s\",\"addr\":\"%s\",\"port\":%d}}}",
                    product_key, device_name, ip_addr, port);

        clear_and_set_message_info(message_info, dm_thing_manager);
        (*message_info)
          ->set_message_type(message_info,
                             DM_CM_MSG_INFO_MESSAGE_TYPE_RESPONSE);
...
static void *dm_thing_manager_ctor(void *_self, va_list *params)
{
    ...
    self->_local_thing_list =
      new_object(DM_SLIST_CLASS, string_local_thing_list);
    self->_local_thing_name_list =
      new_object(DM_SLIST_CLASS, string_local_thing_name_list);
    self->_sub_thing_list = new_object(DM_SLIST_CLASS, string_sub_thing_list);
#ifdef SUBDEV_ENABLE
    self->_sub_thing_name_list =
      new_object(DM_SLIST_CLASS, string_sub_thing_name_list);
    self->_subdev_callback_list =
      new_object(DM_SLIST_CLASS, string_subdev_callback_list);
    self->_sub_thing_cnt = 0;
    self->_sub_request_list =
      new_object(DM_SLIST_CLASS, string_subdev_request_list);
#endif
    self->_callback_list = new_object(DM_SLIST_CLASS, string_callback_list);
    self->_service_property_get_identifier_list =
      new_object(DM_SLIST_CLASS, string_service_property_get_identifier_list);
    ...
    assert(self->_product_key && self->_device_name && self->_device_secret &&
           self->_device_id);

    cm = self->_cm;

    if (FAIL_RETURN == (*cm)->init(cm, self->_product_key, self->_device_name,
                                   self->_device_secret, self->_device_id,
                                   self->_cm_event_handle_func_fp, self,
                                   self->_cloud_domain)) {
        dm_log_err("cm init failed");
    } else {
#ifdef LOCAL_CONN_ENABLE
        (*cm)->add_service(cm, (char *)string_dev_core_service_dev,
                           self->_cm_local_conn_register_func_fp, self, 0);
#endif
    }
    ...
    assert(g_dm_thing_manager_callback_mutex &&
           g_dm_thing_manager_usercall_mutex);
    return self;
}
...
static void *dm_thing_manager_dtor(void *_self)
{
    ...
    assert(self->_local_thing_list && self->_local_thing_name_list &&
           self->_sub_thing_list && self->_callback_list &&
           self->_message_info);
...
static void generate_thing_event_service_subscribe_uri(void *_item, int index,
                                                       va_list *params)
{
    event_t *           event   = NULL;
...
sub_uri:
    ...
    dm_sprintf(method_buff, (cloud && event) ? "%s_reply" : "%s",
               event ? event->method : service->method);
    ...
    if (cloud) {
        (*cm)->regist(cm, uri_buff, dm_thing_manager->_cm_register_func_fp,
                      dm_thing_manager);
#if defined(RRPC_ENABLED) && defined(RRPC_NEW)
        if (service && rrpc) {
        ...
        (*cm)->add_service(cm, uri_buff, dm_thing_manager->_cm_register_func_fp,
                           dm_thing_manager, 1);
#endif
    }
}
                                   ...
                                   int cloud, int subdev, char *pk, char *dn)
{
    ...
    const char **uri;
    char         uri_buff[URI_MAX_LENGTH] = { 0 };
    const char * cloud_uri_array[]        = {
        string_method_name_thing_tsl_get_reply,
        string_method_name_down_raw,
        string_method_name_up_raw_reply,
#ifdef EXTENDED_INFO_ENABLED
        string_method_name_deviceinfo_update_reply,
...
#ifdef SUBDEV_ENABLE
    const char *cloud_gw_uri_array[] = { string_method_name_topo_add_reply,
                                         string_method_name_topo_del_reply,
                                         string_method_name_sub_register_reply,
                                         string_method_name_sub_gw_permit };
#endif
    const char *common_uri_array[] = {
        string_method_name_thing_enable,
        string_method_name_thing_delete,
    ...
    if (thing) {
        event_iterator(thing, generate_thing_event_service_subscribe_uri,
                       dm_thing_manager, thing, uri_buff, string_event, cloud);
        service_iterator(thing, generate_thing_event_service_subscribe_uri,
                         dm_thing_manager, thing, uri_buff, string_service,
                         cloud);
    } else {
        for (index = 0; index < sizeof(common_uri_array) / sizeof(char *);
             ++index) {
            ...
            if (cloud) {
                (*cm)->regist(cm, uri_buff,
                              dm_thing_manager->_cm_register_func_fp,
                              dm_thing_manager);
#ifdef LOCAL_CONN_ENABLE
            } else {
                (*cm)->add_service(cm, uri_buff,
                                   dm_thing_manager->_cm_register_func_fp,
                                   dm_thing_manager, 1);
#endif
            }
        ...
        if (cloud) {
            for (index = 0; index < sizeof(cloud_uri_array) / sizeof(char *);
                 ++index) {
            ...
            if (!subdev) {
                for (index = 0;
                     index < sizeof(cloud_gw_uri_array) / sizeof(char *);
                     ++index) {
                    uri = cloud_gw_uri_array + index;
                    dm_snprintf(uri_buff, sizeof(uri_buff), "/sys/%s/%s/", pk,
                                dn);
                    strcat(uri_buff, *uri);
                                                       ...
                                                       int         tsl_len)
{
    ...
    dm_sprintf(thing_name, DM_LOCAL_THING_NAME_PATTERN,
               self->_local_thing_id++);
    ...
    if (0 == (*thing)->set_tsl_string(thing, tsl, tsl_len)) {
        ...
        if (!product_key || strcmp(product_key, hal_product_key)) {
            dm_log_err("tsl_pk(%s) != hal_pk(%s)",
                       product_key ? product_key : "NULL", hal_product_key);
        }
        if (!device_name || strcmp(device_name, hal_device_name)) {
            dm_log_err("tsl_dn(%s) != hal_dn(%s),using hal_dn",
                       device_name ? device_name : "NULL", hal_device_name);
...
static int dm_thing_manager_add_callback_function(
  void *_self, handle_dm_callback_fp_t callback_func)
{
    dm_thing_manager_t *self = _self;
    list_t **           list;
...
static void get_service_input_output_value(void *_thing, va_list *params)
{
    ...
    assert(dm_thing_manager && thing && *thing &&
           (*thing)->get_service_input_output_data_value_by_identifier);

    if (dm_thing_manager->_thing_id == thing) {
        dm_thing_manager->_ret =
          (*thing)->get_service_input_output_data_value_by_identifier(
            thing, dm_thing_manager->_identifier, dm_thing_manager->_get_value,
    ...
    if (dm_thing_manager->_thing_id == thing) {
        dm_thing_manager->_ret =
          (*thing)->set_service_input_output_data_value_by_identifier(
            ...
            dm_thing_manager->_set_value_str);
    }
}
...
static void get_event_output_value(void *_thing, va_list *params)
{
    ...
    assert(dm_thing_manager && thing && *thing &&
           (*thing)->get_event_value_by_identifier);

    if (dm_thing_manager->_thing_id == thing) {
        dm_thing_manager->_ret = (*thing)->get_event_value_by_identifier(
          thing, dm_thing_manager->_identifier, dm_thing_manager->_get_value,
          &dm_thing_manager->_get_value_str);
    }
}
...
static void set_event_output_value(void *_thing, va_list *params)
{
    ...
    assert(dm_thing_manager && thing && *thing &&
           (*thing)->set_event_value_by_identifier);

    if (dm_thing_manager->_thing_id == thing) {
        dm_thing_manager->_ret = (*thing)->set_event_value_by_identifier(
          thing, dm_thing_manager->_identifier, dm_thing_manager->_set_value,
          dm_thing_manager->_set_value_str);
    }
}
...
static void invoke_callback_func(void *_callback_fp, va_list *params)
{
    ...
    if (callback_fp && dm_thing_manager) {
        callback_fp(
          dm_thing_manager->_callback_type, dm_thing_manager->_thing_id,
          dm_thing_manager->_identifier,
          dm_thing_manager->_callback_type != dm_callback_type_response_arrived
            ? dm_thing_manager->_request_id
            : dm_thing_manager->_response_id_received,
                                        ...
                                        va_list *params)
{
    ...
    if (subdev_callback_fp && dm_thing_manager) {
        subdev_callback_fp(dm_thing_manager->_subcallback_type,
                           dm_thing_manager->_sub_thing_id,
                           dm_thing_manager->_id, dm_thing_manager->_code,
                           dm_thing_manager->_message,
                           dm_thing_manager->_subdev_pk_from_register,
                           dm_thing_manager->_subdev_dn_from_register,
                           dm_thing_manager->_subdev_ds_from_register);
    }
...
static void set_property_value(void *_thing, va_list *params)
{
    ...
    assert(dm_thing_manager && thing && *thing &&
           (*thing)->set_property_value_by_identifier);

    if (dm_thing_manager->_thing_id == thing) {
        dm_thing_manager->_ret = (*thing)->set_property_value_by_identifier(
          thing, dm_thing_manager->_identifier, dm_thing_manager->_set_value,
          dm_thing_manager->_set_value_str);
...
static void get_property_value(void *_thing, va_list *params)
{
    ...
    assert(dm_thing_manager && thing && *thing &&
           (*thing)->get_property_value_by_identifier);

    if (dm_thing_manager->_thing_id == thing) {
        dm_thing_manager->_ret = (*thing)->get_property_value_by_identifier(
          thing, dm_thing_manager->_identifier, dm_thing_manager->_get_value,
          &dm_thing_manager->_get_value_str);
    }
}
...
static int dm_thing_manager_get_thing_property_value(void *      _self,
                                                     const void *thing_id,
                                                     const void *identifier,
                                                     void *      value,
                                                     char **     value_str)
...
static int dm_thing_manager_set_thing_event_output_value(void *      _self,
                                                         const void *thing_id,
                                                         const void *identifier,
                                                         const void *value,
                                                         const char *value_str)
...
static int dm_thing_manager_get_thing_event_output_value(void *      _self,
                                                         const void *thing_id,
                                                         const void *identifier,
                                                         void *      value,
                                                         char **     value_str)
...
static int dm_thing_manager_get_thing_service_input_value(
  void *_self, const void *thing_id, const void *identifier, void *value,
  char **value_str)
{
    dm_thing_manager_t *self = _self;
...
static int dm_thing_manager_get_thing_service_output_value(
  void *_self, const void *thing_id, const void *identifier, void *value,
  char **value_str)
{
    dm_thing_manager_t *self = _self;

    return dm_thing_manager_get_thing_service_input_value(
      self, thing_id, identifier, value, value_str);
}

static int dm_thing_manager_set_thing_service_output_value(
  void *_self, const void *thing_id, const void *identifier, const void *value,
  const char *value_str)
{
    dm_thing_manager_t *self = _self;
...
static int install_lite_property_to_message_info(
  dm_thing_manager_t *_thing_manager, message_info_t **_message_info,
  lite_property_t *_lite_property)
{
    ...
    ret = (*thing)->get_lite_property_value(thing, lite_property, NULL,
                                            &dm_thing_manager->_get_value_str);

    if ((lite_property->data_type.type == data_type_type_text ||
         lite_property->data_type.type == data_type_type_date) &&
        dm_thing_manager->_get_value_str) {
    ...
    if (ret != 0 && lite_property->data_type.type == data_type_type_array) {
        ...
        for (i = 0; i < lite_property->data_type.value.data_type_array_t.size;
             i++) {
            dm_thing->_arr_index             = i;
            dm_thing_manager->_get_value_str = NULL;
            ret = (*thing)->get_lite_property_value(
              thing, lite_property, NULL, &dm_thing_manager->_get_value_str);
            params_val_len = strlen(property_key_value_buff);

            if (ret != 0 || !dm_thing_manager->_get_value_str) {
                dm_thing_manager->_get_value_str = NULL;
            }
            if (lite_property->data_type.value.data_type_array_t.item_type ==
                data_type_type_text) {
                dm_snprintf(property_key_value_buff + params_val_len,
                            params_buffer_len - params_val_len, "\"%s\",",
                            dm_thing_manager->_get_value_str
                              ? dm_thing_manager->_get_value_str
                              : "");
            } else {
        ...
        (*message_info)
          ->add_params_data_item(message_info, lite_property->identifier,
                                 property_key_value_buff);

        return 0;
    }

    if (ret == 0 && lite_property->identifier &&
        dm_thing_manager->_get_value_str) {
        (*message_info)
          ->add_params_data_item(message_info, lite_property->identifier,
                                 dm_thing_manager->_get_value_str);
                                        ...
                                        void *_thing, void *_dm_thing_manager)
{
    ...
    if (thing && *thing) {
        dm_thing_manager_install_product_key_device_name(
          dm_thing_manager, thing, product_key, device_name);
    } else {
...
static void install_property_to_message_info(void *_item, int index,
                                             va_list *params)
{
    property_t *        property = _item;
    lite_property_t *   lite_property;
    ...
    assert(property && dm_thing_manager && thing && *thing && message_info &&
           *message_info);
    ...
    if (property &&
        (target_property_identifier == NULL ||
         (property->identifier &&
          strcmp(property->identifier, target_property_identifier) == 0))) {
        ret = install_lite_property_to_message_info(
          dm_thing_manager, message_info, lite_property);
        ...
        if (ret == -1) {
            if (property->data_type.type == data_type_type_struct) {
                property_key_value_buff[0] = '{';
                property_key_value_buff[1] = '\0';
                for (i = 0; i < property->data_type.data_type_specs_number;
                     ++i) {
                    struct_lite_property =
                      (lite_property_t *)property->data_type.specs + i;
                    ret = (*thing)->get_lite_property_value(
                      thing, struct_lite_property, NULL,
                      &dm_thing_manager->_get_value_str);
                    if (ret == 0 && dm_thing_manager->_get_value_str) {
                        params_val_len = strlen(property_key_value_buff);
                        ...
                        if (struct_lite_property->data_type.type ==
                            ...
                            dm_thing_manager->_get_value_str) {
                            q = dm_lite_calloc(
                              1, strlen(dm_thing_manager->_get_value_str) + 3);
                            assert(q);

                            dm_snprintf(
                              q, strlen(dm_thing_manager->_get_value_str) + 3,
                              "\"%s\"", dm_thing_manager->_get_value_str);
                            dm_thing_manager->_get_value_str = q;
                        }

                        dm_snprintf(property_key_value_buff + params_val_len,
                                    params_buffer_len - params_val_len,
                                    "\"%s\":%s}",
                                    struct_lite_property->identifier,
                                    dm_thing_manager->_get_value_str);
            ...
            (*message_info)
              ->add_params_data_item(message_info, property->identifier,
                                     property_key_value_buff);
        }
...
static void handle_event_key_value(void *_item, int index, va_list *params)
{
    ...
    assert(dm_thing_manager && message_info && *message_info &&
    ...
    dm_snprintf(uri_buff, sizeof(uri_buff), "/sys/%s/%s/%s", product_key,
                device_name, method_buff);
    (*message_info)->set_uri(message_info, uri_buff);

    if (strcmp(dm_thing_manager->_method, string_thing_event_property_post) !=
        0) {
        ...
        for (i = 0; i < output_data_numb; ++i) {
            ...
            install_lite_property_to_message_info(dm_thing_manager,
                                                  message_info, lite_property);
        }
        dm_thing_manager->_ret = 0;
    } else {
        property_iterator(thing, install_property_to_message_info,
                          dm_thing_manager, thing,
                          dm_thing_manager->_message_info,
                          dm_thing_manager->_property_identifier_post);
    }
}

static void install_service_property_get_to_message_info(void *   _string,
                                                         va_list *params)
{
    ...
    property_iterator(thing, install_property_to_message_info, dm_thing_manager,
                      thing, message_info, identifier_to_get);
}
...
static void handle_service_key_value(void *_item, int index, va_list *params)
{
    ...
    assert(dm_thing_manager && message_info && *message_info && thing &&
           *thing);
    ...
    if (dm_thing_manager->_rrpc) {
        ...
        dm_snprintf(uri_buff, sizeof(uri_buff), "/ext/rrpc/%s/sys/%s/%s/%s",
                    rrpc_message_id, product_key, device_name, method_buff);
#else
        dm_snprintf(uri_buff, sizeof(uri_buff), "/sys/%s/%s/rrpc/response/%d",
                    product_key, device_name,
                    dm_thing_manager->_rrpc_message_id);
#endif
    } else {
        dm_snprintf(uri_buff, sizeof(uri_buff), "/sys/%s/%s/%s_reply",
                    product_key, device_name, method_buff);
    }
#else
    dm_snprintf(uri_buff, sizeof(uri_buff), "/sys/%s/%s/%s_reply", product_key,
                device_name, method_buff);
#endif /* RRPC_ENABLED */
    ...
    if (strcmp(dm_thing_manager->_method, string_thing_service_property_set) ==
        0) {
        /* set property */
    } else if (strcmp(dm_thing_manager->_method,
                      string_thing_service_property_get) == 0) {
        assert((*list)->get_size(list));
        /* get property */
        list_iterator(list, install_service_property_get_to_message_info,
                      dm_thing_manager, thing, dm_thing_manager->_message_info);
        /* clear after use. */
...
static void get_event_key_value(void *_thing, va_list *params)
{
    ...
    if (dm_thing_manager->_thing_id == thing) {
        event_iterator(thing, handle_event_key_value, dm_thing_manager,
                       dm_thing_manager->_message_info, thing);
    }
}
...
static void get_service_key_value(void *_thing, va_list *params)
{
    ...
    if (dm_thing_manager->_thing_id == thing) {
        service_iterator(thing, handle_service_key_value, dm_thing_manager,
                         dm_thing_manager->_message_info, thing);
    }
}
...
#endif
    if (-1 != self->_ret) {
        dm_log_debug("event(%s) triggered, method(%s)", self->_identifier,
                     self->_method);
        ret = (*message_info)->serialize_to_payload_request(message_info);
        if (ret == -1) {
            dm_log_err("serialize_to_payload_request FAIL");
...
static int dm_thing_manager_trigger_extended_info_update(void *      _self,
                                                         const void *thing_id,
                                                         const char *params)
{
    dm_thing_manager_t *self         = _self;
    ...
    dm_thing_manager_install_product_key_device_name(self, thing, product_key,
                                                     device_name);

    dm_snprintf(uri_buff, sizeof(uri_buff), "/sys/%s/%s/%s", product_key,
                device_name, string_method_name_deviceinfo_update);
    (*message_info)->set_uri(message_info, uri_buff);
...
static int dm_thing_manager_trigger_extended_info_delete(void *      _self,
                                                         const void *thing_id,
                                                         const char *params)
{
    dm_thing_manager_t *self         = _self;
    ...
    dm_snprintf(uri_buff, sizeof(uri_buff), "/sys/%s/%s/%s", product_key,
                device_name, string_method_name_deviceinfo_delete);
    (*message_info)->set_uri(message_info, uri_buff);
...
#endif /* EXTENDED_INFO_ENABLED*/
static int generate_raw_message_info(void *_dm_thing_manager, void *_thing,
                                     void *_message_info, const char *raw_topic)
{
    dm_thing_manager_t *dm_thing_manager = _dm_thing_manager;
    thing_t **          thing            = _thing;
    message_info_t **   message_info     = _message_info;
...
static int generate_raw_up_message_info(void *_dm_thing_manager, void *_thing,
                                        void *_message_info)
{
    return generate_raw_message_info(_dm_thing_manager, _thing, _message_info,
                                     string_method_name_up_raw);
}

static int generate_raw_down_reply_message_info(void *_dm_thing_manager,
                                                void *_thing,
                                                void *_message_info)
{
    return generate_raw_message_info(_dm_thing_manager, _thing, _message_info,
                                     string_method_name_down_raw_reply);
}
...
#endif /* RRPC_ENABLED */
{
    ...
    if (self->_usr_response_id == self->_request_id) {
        dm_log_debug("response id(%d) matches request id(%d).",
                     self->_usr_response_id, self->_request_id);
        self->_request_id = 0;
    } else {
        dm_log_warning("response id(%d) not matche request id(%d).",
                       self->_usr_response_id, self->_request_id);
    }
#ifdef RRPC_ENABLED
    self->_rrpc = rrpc;
...
#endif
    dm_log_debug("answer normal service(%s), method(%s)", self->_identifier,
                 self->_method ? self->_method : "NULL");
...
static int dm_thing_manager_invoke_raw_service(void *      _self,
                                               const void *thing_id,
                                               void *      raw_data,
                                               int         raw_data_length)
{
    ...
    if (generate_raw_up_message_info(self, self->_thing_id, message_info) ==
        -1) {
...
static int dm_thing_manager_answer_raw_service(void *      _self,
                                               const void *thing_id,
                                               void *      raw_data,
                                               int         raw_data_length)
{
    ...
    if (generate_raw_down_reply_message_info(self, self->_thing_id,
                                             message_info) == -1) {
  ...
  void *_self, const void *thing_id, char *product_key, char *device_name)
{
...
#endif
    {
        ...
        if (tsl_product_key &&
            (0 == strcmp(tsl_product_key, hal_product_key))) {
            strcpy(product_key, tsl_product_key);
        } else {
            dm_log_err("hal pk(%s) != tsl pk(%s)", hal_product_key,
                       tsl_product_key ? tsl_product_key : "NULL");
            strcpy(product_key, hal_product_key);
        }

        if (tsl_device_name &&
            (0 == strcmp(tsl_device_name, hal_device_name))) {
            strcpy(device_name, tsl_device_name);
        } else {
            dm_log_err("hal dn(%s) != tsl dn(%s)", hal_device_name,
                       tsl_device_name ? tsl_device_name : "NULL");
...
#ifdef SUBDEV_ENABLE
static void subdev_request_list_iterator(const void *_dm_thing_manager,
                                         handle_fp_t handle_fp)
{
...
#define SUB_LOGIN_PACKET_FMT                                            \
    "{\"productKey\":\"%s\",\"deviceName\":\"%s\",\"clientId\":\"%s\"," \
    "\"timestamp\":\"%s\",\"signMethod\":\"%s\",\"sign\":\"%s\","       \
    "\"cleanSession\":\"%s\"}"
    dm_thing_manager_t *self = _self;
    message_info_t **   message_info;
    thing_t **          sub_thing;
    ...
    dm_snprintf(client_id, sizeof(client_id), "%s.%s", sub_product_key,
                sub_device_name);
    ...
    dm_snprintf(hmac_source, sizeof(hmac_source),
                "clientId%s"
                "deviceName%s"
                "productKey%s"
                "timestamp%s",
                client_id, subdev_dn, subdev_pk, timestamp);

    if (strcmp(hmac_method, "hmacmd5") == 0) {
        utils_hmac_md5(hmac_source, strlen(hmac_source), sign,
                       sub_device_secret, strlen(sub_device_secret));
    } else if (strcmp(hmac_method, "hmacsha1") == 0) {
        utils_hmac_sha1(hmac_source, strlen(hmac_source), sign,
                        sub_device_secret, strlen(sub_device_secret));
    } else {
    ...
    dm_snprintf(method_buff, sizeof(method_buff), "%s",
                string_method_name_sub_login);
    ...
    dm_snprintf(uri_buff, sizeof(uri_buff), SUB_LOGIN_URI_FMT,
                self->_product_key, self->_device_name);
    (*message_info)->set_uri(message_info, uri_buff);
    dm_snprintf(params_buff, sizeof(params_buff), SUB_LOGIN_PACKET_FMT,
                sub_product_key, sub_device_name, client_id, timestamp,
                strcmp(hmac_method, "hmacmd5") == 0 ? "hmacmd5" : "hmacsha1",
                sign, clean_session);
    ...
    sub_thing = dm_thing_manager_query_thing_id(self, sub_product_key,
                                                sub_device_name, &is_sub_thing);
...
#define TOPO_ADD_PACKET_FMT                                              \
    ...
    assert(_self && subdev_pk && subdev_dn && subdev_ds && hmac_method &&
           (strcmp(hmac_method, "hmacmd5") == 0 ||
            strcmp(hmac_method, "hmacsha1") == 0));
    ...
    dm_snprintf(hmac_source, sizeof(hmac_source),
                ...
                "productKey%s"
                "timestamp%s",
                client_id, sub_device_name, sub_product_key, timestamp);
    if (strcmp(hmac_method, "hmacmd5") == 0) {
        utils_hmac_md5(hmac_source, strlen(hmac_source), sign,
                       sub_device_secret, strlen(sub_device_secret));
    } else if (strcmp(hmac_method, "hmacsha1") == 0) {
    ...
    dm_snprintf(uri_buff, sizeof(uri_buff), "/sys/%s/%s/%s", self->_product_key,
                self->_device_name, string_method_name_topo_add);
    (*message_info)->set_uri(message_info, uri_buff);
    dm_snprintf(params_buff, sizeof(params_buff), TOPO_ADD_PACKET_FMT,
                sub_product_key, sub_device_name, client_id, timestamp,
                strcmp(hmac_method, "hmacmd5") == 0 ? "hmacmd5" : "hmacsha1",
                sign);
    (*message_info)->set_params_data(message_info, params_buff);
    ...
    request_info->request_id = (*message_info)->get_id(message_info);
    dm_snprintf(request_info->product_key, sizeof(request_info->product_key),
                "%s", sub_product_key);
    dm_snprintf(request_info->device_name, sizeof(request_info->device_name),
                "%s", sub_device_name);
    dm_snprintf(request_info->device_secret,
                sizeof(request_info->device_secret), "%s", subdev_ds);
    list_insert(self->_sub_request_list, request_info);

    return (*cm)->send(cm, message_info);
}

static int send_subdev_register_message(void *_self, const char *subdev_pk,
                                        const char *subdev_dn)
{
#define REGISTER_PACKET_FMT "[{\"productKey\":\"%s\",\"deviceName\":\"%s\"}]"
    ...
    dm_snprintf(uri_buff, sizeof(uri_buff), "/sys/%s/%s/%s", self->_product_key,
                self->_device_name, string_method_name_sub_register);
    (*message_info)->set_uri(message_info, uri_buff);
    dm_snprintf(params_buff, sizeof(params_buff), REGISTER_PACKET_FMT,
                sub_product_key, sub_device_name);
    (*message_info)->set_params_data(message_info, params_buff);
  ...
  dm_thing_manager_t *_dm_thing_manager)
{
    ...
    if (dm_thing_manager->_permit_time_ms) {
        ...
        if (current_time_ms == dm_thing_manager->_uptime_ms) {
            ...
            time_duration_ms =
              current_time_ms > dm_thing_manager->_uptime_ms
                ? current_time_ms - dm_thing_manager->_uptime_ms
                : current_time_ms + __LONG_LONG_MAX__ * 2ULL + 1ULL -
                    dm_thing_manager->_uptime_ms;
        }

        /* time out of permit time */
        if (time_duration_ms > dm_thing_manager->_permit_time_ms) {
            dm_log_debug("permit join out of time(%d)",
                         dm_thing_manager->_permit_time_ms / 1000);
...
#endif
{
    ...
    if (strlen(self->_permit_pk) &&
        strcmp(self->_permit_pk, _product_key) != 0) {
        dm_log_debug("permit pk not match(%s)(%s)", self->_permit_pk,
                     _product_key);
        return NULL;
    }
    ...
    if (ret != 0) {
        ...
        if (strcmp(product_key, _product_key) != 0) {
            dm_log_err("pk(%s) of tsl != pk(%s) input", product_key,
                       _product_key);
        }
    }
...
#define TOPO_DELETE_PACKET_FMT "[{\"productKey\":\"%s\",\"deviceName\":\"%s\"}]"
    ...
    assert(dm_thing_manager && sub_product_key && sub_device_name &&
           message_info && cm);

    dm_snprintf(method_buff, sizeof(method_buff), "%s",
                string_method_name_topo_del);
    ...
    dm_snprintf(uri_buff, sizeof(uri_buff), "/sys/%s/%s/%s",
                dm_thing_manager->_product_key, dm_thing_manager->_device_name,
                string_method_name_topo_del);
    (*message_info)->set_uri(message_info, uri_buff);
    dm_snprintf(params_buff, sizeof(params_buff), TOPO_DELETE_PACKET_FMT,
                sub_product_key, sub_device_name);
    (*message_info)->set_params_data(message_info, params_buff);
...
#define SUB_LOGOUT_PACKET_FMT "{\"productKey\":\"%s\",\"deviceName\":\"%s\"}"
    ...
    dm_snprintf(uri_buff, sizeof(uri_buff), SUB_LOGOUT_URI_FMT,
                self->_product_key, self->_device_name);
    (*message_info)->set_uri(message_info, uri_buff);
    dm_snprintf(params_buff, sizeof(params_buff), SUB_LOGOUT_PACKET_FMT,
                sub_product_key, sub_device_name);
    (*message_info)->set_params_data(message_info, params_buff);
...
static int dm_thing_manager_remove_sub_thing(void *      _self,
                                             const void *sub_thing_id)
{
    dm_thing_manager_t *self      = _self;
    const thing_t **    sub_thing = (const thing_t **)sub_thing_id;
    list_t **           list;
...
static int dm_thing_manager_topo_delete_sub_thing(void *      _self,
                                                  const void *sub_thing_id)
{
    dm_thing_manager_t *self      = _self;
    const thing_t **    sub_thing = (const thing_t **)sub_thing_id;
...
static int dm_thing_manager_bind_sub_thing(void *_self, const char *pk,
...
static int dm_thing_manager_unbind_sub_thing(void *_self, const char *pk,
                                             const char *dn)
{
    dm_thing_manager_t *self = _self;
    thing_t **          sub_thing;
...
static int dm_thing_manager_login_sub_thing(void *      _self,
                                            const void *sub_thing_id,
                                            const char *ds)
{
    dm_thing_manager_t *self = _self;
    ...
    ret = send_subdev_login_message(
      self, (*sub_thing)->return_product_key(sub_thing),
      (*sub_thing)->return_device_name(sub_thing), ds, 1, "hmacsha1");

    return ret;
}

static int dm_thing_manager_logout_sub_thing(void *      _self,
                                             const void *sub_thing_id)
{
    dm_thing_manager_t *self = _self;
    thing_t **          sub_thing;
...
static int dm_thing_manager_add_subdev_callback_function(
  void *_self, handle_dm_subdev_callback_fp_t subdev_callback_func)
{
    dm_thing_manager_t *self = _self;
    list_t **           list;
                                      ...
                                      const char *dn, int *is_subthing)
{
    ...
    list_iterator(list, find_thing_via_product_key_and_device_name,
                  dm_thing_manager, &send_peer);
