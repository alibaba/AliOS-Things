...
typedef void (*handle_dm_subdev_callback_fp_t)(dm_subdev_callback_type_t callback_type, void *sub_thing_id, int id,
                                               int code, char *response_message,
...
#ifdef SUBDEV_ENABLE
    void *(*generate_new_subthing)(void *_self, const char *product_key, const char *device_name, const char *tsl,
                                   int tsl_len);
...
#endif
    int   (*set_property_value)(void *_self, const void *thing_id, const void *identifier, const void *value,
                                const char *value_str);
    int   (*set_event_output_value)(void *_self, const void *thing_id, const void *identifier, const void *value,
                                    const char *value_str);
    int   (*set_service_output_value)(void *_self, const void *thing_id, const void *identifier, const void *value,
                                      const char *value_str);
    int   (*get_property_value)(const void *_self, const void *thing_id, const void *identifier, void *value,
                                char **value_str);
    int   (*get_service_input_value)(const void *_self, const void *thing_id, const void *identifier, void *value,
                                     char **value_str);
    int   (*get_service_output_value)(const void *_self, const void *thing_id, const void *identifier, void *value,
                                      char **value_str);
    int   (*get_event_output_value)(const void *_self, const void *thing_id, const void *identifier, void *value,
                                    char **value_str);
    int   (*install_callback_function)(void *_self, handle_dm_callback_fp_t linkkit_callback_fp);
    int   (*trigger_event)(const void *_self, const void *thing_id, const void *event_identifier,
