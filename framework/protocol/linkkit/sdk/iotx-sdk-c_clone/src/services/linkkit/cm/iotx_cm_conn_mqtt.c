    ...
    switch (msg->event_type) {
        ...
        case IOTX_MQTT_EVENT_PUBLISH_RECEIVED: {
            ...
            if (strstr(topic_info->ptopic,"thing/awss/enrollee/match_reply")) {
                awss_report_token_reply(topic_info->ptopic,topic_info->topic_len,topic_info->payload,topic_info->payload_len,NULL);
            }else if (strstr(topic_info->ptopic,"thing/reset_reply")) {
                awss_report_reset_reply(topic_info->ptopic,topic_info->topic_len,topic_info->payload,topic_info->payload_len,NULL);
            }else if (strstr(topic_info->ptopic,"thing/awss/enrollee/checkin")) {
                awss_enrollee_checkin(topic_info->ptopic,topic_info->topic_len,topic_info->payload,topic_info->payload_len,NULL);
            }else if (strstr(topic_info->ptopic,"thing/awss/enrollee/found_reply")) {
                awss_report_enrollee_reply(topic_info->ptopic,topic_info->topic_len,topic_info->payload,topic_info->payload_len,NULL);
            }else if (strstr(topic_info->ptopic,"thing/cipher/get_reply")) {
                awss_get_cipher_reply(topic_info->ptopic,topic_info->topic_len,topic_info->payload,topic_info->payload_len,NULL);
            }else if (strstr(topic_info->ptopic,"thing/awss/device/switchap")) {
                awss_online_switchap(topic_info->ptopic,topic_info->topic_len,topic_info->payload,topic_info->payload_len,NULL);
            }
