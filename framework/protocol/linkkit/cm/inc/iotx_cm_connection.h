...
typedef int (*iotx_connection_subscribe_fp_t)(void *connection, const char *topic_filter,
                                              iotx_cm_message_ack_types_t ack_type);

typedef int (*iotx_connection_unsubscribe_fp_t)(void *connection, const char *topic_filter);

typedef int (*iotx_connection_add_service_fp_t)(void *connection, const char *topic_filter,
