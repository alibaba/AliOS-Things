...
int tjpeg2rgb(unsigned char* jpeg_buffer, int jpeg_size, unsigned char** rgb_buffer, int* size)
{
    ...
    LOGI(TAG, "jpeg_info.image_width: %d, jpeg_info.image_height: %d, jpeg_info.num_components: %d", jpeg_info.image_width, jpeg_info.image_height, jpeg_info.num_components);
