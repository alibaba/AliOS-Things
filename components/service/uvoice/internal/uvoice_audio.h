...
typedef enum {
	...
	SND_DEVICE_OUT_END = SND_DEVICE_OUT_SPEAKER_AND_HEADSET,
	SND_DEVICE_IN_BEGIN,
...
#define snd_info(fmt, ...)
#else
#define snd_debug(fmt, ...)		printf("%s: "fmt, __func__, ##__VA_ARGS__)
#define snd_info(fmt, ...)		printf("%s: "fmt, __func__, ##__VA_ARGS__)
#endif
#define snd_warn(fmt, ...)		printf("%s: "fmt, __func__, ##__VA_ARGS__)
#define snd_err(fmt, ...)		printf("%s: "fmt, __func__, ##__VA_ARGS__)
