...
std::string CreateConsumerGroupResult::getErrorMessage()const
{
	return errorMessage_;
}

std::string CreateConsumerGroupResult::getCode()const
{
	return code_;
}
...
std::string CreateConsumerGroupResult::getGroupId()const
{
	return groupId_;
}
