...
#ifndef ALIBABACLOUD_LIVE_MODEL_EDITHTMLRESOURCEREQUEST_H_
#define ALIBABACLOUD_LIVE_MODEL_EDITHTMLRESOURCEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Live
	{
		namespace Model
		{
			class ALIBABACLOUD_LIVE_EXPORT EditHtmlResourceRequest : public RpcServiceRequest
			{

			public:
				EditHtmlResourceRequest();
				~EditHtmlResourceRequest();
...
#endif // !ALIBABACLOUD_LIVE_MODEL_EDITHTMLRESOURCEREQUEST_H_