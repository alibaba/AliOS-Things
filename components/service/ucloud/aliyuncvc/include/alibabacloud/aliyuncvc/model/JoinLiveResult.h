...
#ifndef ALIBABACLOUD_ALIYUNCVC_MODEL_JOINLIVERESULT_H_
#define ALIBABACLOUD_ALIYUNCVC_MODEL_JOINLIVERESULT_H_
...
namespace AlibabaCloud
{
	namespace Aliyuncvc
	{
		namespace Model
		{
			class ALIBABACLOUD_ALIYUNCVC_EXPORT JoinLiveResult : public ServiceResult
			{
			public:
				struct MeetingInfo
				{
...
#endif // !ALIBABACLOUD_ALIYUNCVC_MODEL_JOINLIVERESULT_H_