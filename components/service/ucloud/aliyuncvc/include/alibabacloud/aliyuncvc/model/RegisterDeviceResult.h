...
#ifndef ALIBABACLOUD_ALIYUNCVC_MODEL_REGISTERDEVICERESULT_H_
#define ALIBABACLOUD_ALIYUNCVC_MODEL_REGISTERDEVICERESULT_H_
...
namespace AlibabaCloud
{
	namespace Aliyuncvc
	{
		namespace Model
		{
			class ALIBABACLOUD_ALIYUNCVC_EXPORT RegisterDeviceResult : public ServiceResult
			{
			public:
				struct DeviceInfo
				{
...
#endif // !ALIBABACLOUD_ALIYUNCVC_MODEL_REGISTERDEVICERESULT_H_