...
/* relate to YOC_IO_CAP_xxx in yoc_gap_ble_api.h */
...
*/
/* relate to YOC_LE_KEY_xxx in yoc_gap_ble_api.h */
#if (SMP_INCLUDED == TRUE)
...
/* relate to YOC_LE_AUTH_xxx in yoc_gap_ble_api.h */
#if (SMP_INCLUDED == TRUE)
...
typedef struct {
    ...
    tBTM_LE_KEY_TYPE    ryoc_keys;      /* keys to be distributed, bit mask */
} tBTM_LE_IO_REQ;
