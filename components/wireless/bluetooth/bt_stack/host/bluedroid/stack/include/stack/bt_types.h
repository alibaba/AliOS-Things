...
#define EXT_INQ_RYOC_LEN   3
typedef UINT8 EXT_INQ_RESP[EXT_INQ_RYOC_LEN];/* Extended Inquiry Response */
typedef UINT8 *EXT_INQ_RYOC_PTR;             /* Pointer to Extended Inquiry Response */
