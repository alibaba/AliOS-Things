...
typedef union {
    ...
    struct set_bt_scan_mode_args {
        yoc_bt_connection_mode_t c_mode;
        yoc_bt_discovery_mode_t d_mode;
    } set_scan_mode;

    // BTC_GAP_BT_ACT_START_DISCOVERY
    struct start_disc_args {
        yoc_bt_inq_mode_t mode;
        uint8_t inq_len;
        uint8_t num_rsps;
    } start_disc;
    ...
    struct set_pin_type_args {
        yoc_bt_pin_type_t pin_type;
        uint8_t pin_code_len;
        yoc_bt_pin_code_t pin_code;
    } set_pin_type;
