...
yoc_bt_uuid_t           uuid = {LEN_UUID_16, {UUID_SERVCLASS_DEVICE_INFO}};
UINT16                  i = 0;
...
*******************************************************************************/
UINT8 dis_write_attr_value(tGATT_WRITE_REQ *p_data, yoc_gatt_status_t *p_status)
{
    UNUSED(p_data);
...
void dis_s_read_attr_value (tGATTS_DATA *p_data, tGATT_VALUE *p_value, UINT32 trans_id, UINT16 conn_id)
{
    ...
    tGATT_STATUS    st = YOC_GATT_NOT_FOUND;
...
**
*******************************************************************************/
void DIS_Init (yoc_gatts_if_t gatt_if, tDIS_ATTR_MASK dis_attr_mask)
{
    ...
    yoc_ble_gatts_create_srvc (gatt_if , &uuid, 0, DIS_MAX_ATTR_NUM, TRUE);
...
void dis_AddChar(UINT16 service_id)
{
    ...
    while (dis_mask != 0 && i < DIS_MAX_CHAR_NUM) {
        ...
        yoc_ble_gatts_add_char(dis_cb.service_handle, &uuid, GATT_PERM_READ,
    ...
    /*start service*/
    yoc_ble_gatts_start_srvc(dis_cb.service_handle);
    dis_cb.enabled = TRUE;
}
/*******************************************************************************
**
