...
#define TG_INITIAL_TRACE_LEVEL              UC_BT_LOG_TG_TRACE_LEVEL
// btla-specific --
...
#else
#define BT_LOG_ERROR(format, ... )            printf("[E]BT_LOG:"format"\n", ##__VA_ARGS__)
#define BT_LOG_WARN(format, ... )             printf("[W]BT_LOG:"format"\n", ##__VA_ARGS__)
#define BT_LOG_INFO(format, ... )             printf("[I]BT_LOG:"format"\n", ##__VA_ARGS__)
#define BT_LOG_DEBUG(format, ... )            printf("[D]BT_LOG:"format"\n", ##__VA_ARGS__)
#define BT_LOG_VERBOSE(format, ... )          printf("[V]BT_LOG:"format"\n", ##__VA_ARGS__)
#endif
...
/* define traces for TG_ADAPTER */
#define TG_TRACE_ERROR(fmt, args...)       {if (TG_INITIAL_TRACE_LEVEL >= BT_TRACE_LEVEL_ERROR && BT_LOG_LEVEL_CHECK(TG, ERROR)) BT_PRINT_E("TG_ADAPTER", fmt,## args);}
#define TG_TRACE_WARNING(fmt, args...)     {if (TG_INITIAL_TRACE_LEVEL >= BT_TRACE_LEVEL_WARNING && BT_LOG_LEVEL_CHECK(TG, WARNING)) BT_PRINT_W("TG_ADAPTER", fmt,## args);}
#define TG_TRACE_EVENT(fmt, args...)       {if (TG_INITIAL_TRACE_LEVEL >= BT_TRACE_LEVEL_EVENT && BT_LOG_LEVEL_CHECK(TG,EVENT)) BT_PRINT_D("TG_ADAPTER", fmt,## args);}
#define TG_TRACE_DEBUG(fmt, args...)       {if (TG_INITIAL_TRACE_LEVEL >= BT_TRACE_LEVEL_DEBUG && BT_LOG_LEVEL_CHECK(TG,DEBUG)) BT_PRINT_D("TG_ADAPTER", fmt,## args);}

#else
#define BT_LOG_ERROR(fmt, args...)
#define BT_LOG_WARN(fmt, args...)
#define BT_LOG_INFO(fmt, args...)
#define BT_LOG_DEBUG(fmt, args...)
#define BT_LOG_VERBOSE(fmt, args...)
...
/* define traces for TG_ADAPTER */
#define TG_TRACE_ERROR(fmt, args...)
#define TG_TRACE_WARNING(fmt, args...)
#define TG_TRACE_EVENT(fmt, args...)
#define TG_TRACE_DEBUG(fmt, args...)
