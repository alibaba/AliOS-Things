...
#ifdef CONFIG_BT_LOG_TG_TRACE_LEVEL
#define UC_BT_LOG_TG_TRACE_LEVEL            CONFIG_BT_LOG_TG_TRACE_LEVEL
#else
#define UC_BT_LOG_TG_TRACE_LEVEL            UC_TRACE_LEVEL_WARNING
#endif
