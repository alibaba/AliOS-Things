...
#ifdef CONFIG_BT_CONN_WINDOW
    bta_dm_cb.page_scan_window = CONFIG_BT_CONN_WINDOW;
#endif
#ifdef CONFIG_BT_CONN_INTERVAL
    bta_dm_cb.page_scan_interval = CONFIG_BT_CONN_INTERVAL;
#endif
#ifdef CONFIG_BT_DISC_WINDOW
    bta_dm_cb.inquiry_scan_window = CONFIG_BT_DISC_WINDOW;
#endif
#ifdef CONFIG_BT_DISC_INTERVAL
    bta_dm_cb.inquiry_scan_interval = CONFIG_BT_DISC_INTERVAL;
#endif
}
