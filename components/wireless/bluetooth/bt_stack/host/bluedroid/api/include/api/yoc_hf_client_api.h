...
#ifndef __YOC_HF_CLIENT_API_H__
#define __YOC_HF_CLIENT_API_H__

#include "bt_err.h"
#include "yoc_bt_defs.h"
#include "yoc_hf_defs.h"

#ifdef __cplusplus
extern "C" {
#endif

#define YOC_BT_HF_CLIENT_NUMBER_LEN           (32)
#define YOC_BT_HF_CLIENT_OPERATOR_NAME_LEN    (16)

/// Bluetooth HFP RFCOMM connection and service level connection status
typedef enum {
    YOC_HF_CLIENT_CONNECTION_STATE_DISCONNECTED = 0,     /*!< RFCOMM data link channel released */
    YOC_HF_CLIENT_CONNECTION_STATE_CONNECTING,           /*!< connecting remote device on the RFCOMM data link*/
    YOC_HF_CLIENT_CONNECTION_STATE_CONNECTED,            /*!< RFCOMM connection established */
    YOC_HF_CLIENT_CONNECTION_STATE_SLC_CONNECTED,        /*!< service level connection established */
    YOC_HF_CLIENT_CONNECTION_STATE_DISCONNECTING,        /*!< disconnecting with remote device on the RFCOMM dat link*/
} yoc_hf_client_connection_state_t;

/// Bluetooth HFP audio connection status
typedef enum {
    YOC_HF_CLIENT_AUDIO_STATE_DISCONNECTED = 0,          /*!< audio connection released */
    YOC_HF_CLIENT_AUDIO_STATE_CONNECTING,                /*!< audio connection has been initiated */
    YOC_HF_CLIENT_AUDIO_STATE_CONNECTED,                 /*!< audio connection is established */
    YOC_HF_CLIENT_AUDIO_STATE_CONNECTED_MSBC,            /*!< mSBC audio connection is established */
} yoc_hf_client_audio_state_t;

/// in-band ring tone state
typedef enum {
    YOC_HF_CLIENT_IN_BAND_RINGTONE_NOT_PROVIDED = 0,
    YOC_HF_CLIENT_IN_BAND_RINGTONE_PROVIDED,
} yoc_hf_client_in_band_ring_state_t;

/* features masks of AG */
#define YOC_HF_CLIENT_PEER_FEAT_3WAY       0x01        /* Three-way calling */
#define YOC_HF_CLIENT_PEER_FEAT_ECNR       0x02        /* Echo cancellation and/or noise reduction */
#define YOC_HF_CLIENT_PEER_FEAT_VREC       0x04        /* Voice recognition */
#define YOC_HF_CLIENT_PEER_FEAT_INBAND     0x08        /* In-band ring tone */
#define YOC_HF_CLIENT_PEER_FEAT_VTAG       0x10        /* Attach a phone number to a voice tag */
#define YOC_HF_CLIENT_PEER_FEAT_REJECT     0x20        /* Ability to reject incoming call */
#define YOC_HF_CLIENT_PEER_FEAT_ECS        0x40        /* Enhanced Call Status */
#define YOC_HF_CLIENT_PEER_FEAT_ECC        0x80        /* Enhanced Call Control */
#define YOC_HF_CLIENT_PEER_FEAT_EXTERR    0x100        /* Extended error codes */
#define YOC_HF_CLIENT_PEER_FEAT_CODEC     0x200        /* Codec Negotiation */

/* CHLD feature masks of AG */
#define YOC_HF_CLIENT_CHLD_FEAT_REL           0x01       /* 0  Release waiting call or held calls */
#define YOC_HF_CLIENT_CHLD_FEAT_REL_ACC       0x02       /* 1  Release active calls and accept other waiting or held call */
#define YOC_HF_CLIENT_CHLD_FEAT_REL_X         0x04       /* 1x Release specified active call only */
#define YOC_HF_CLIENT_CHLD_FEAT_HOLD_ACC      0x08       /* 2  Active calls on hold and accept other waiting or held call */
#define YOC_HF_CLIENT_CHLD_FEAT_PRIV_X        0x10       /* 2x Request private mode with specified call(put the rest on hold) */
#define YOC_HF_CLIENT_CHLD_FEAT_MERGE         0x20       /* 3  Add held call to multiparty */
#define YOC_HF_CLIENT_CHLD_FEAT_MERGE_DETACH  0x40       /* 4  Connect two calls and leave(disconnect from multiparty) */

/// HF CLIENT callback events
typedef enum {
    YOC_HF_CLIENT_CONNECTION_STATE_EVT = 0,          /*!< connection state changed event */
    YOC_HF_CLIENT_AUDIO_STATE_EVT,                   /*!< audio connection state change event */
    YOC_HF_CLIENT_BVRA_EVT,                          /*!< voice recognition state change event */
    YOC_HF_CLIENT_CIND_CALL_EVT,                     /*!< call indication */
    YOC_HF_CLIENT_CIND_CALL_SETUP_EVT,               /*!< call setup indication */
    YOC_HF_CLIENT_CIND_CALL_HELD_EVT,                /*!< call held indication */
    YOC_HF_CLIENT_CIND_SERVICE_AVAILABILITY_EVT,     /*!< network service availability indication */
    YOC_HF_CLIENT_CIND_SIGNAL_STRENGTH_EVT,          /*!< signal strength indication */
    YOC_HF_CLIENT_CIND_ROAMING_STATUS_EVT,           /*!< roaming status indication */
    YOC_HF_CLIENT_CIND_BATTERY_LEVEL_EVT,            /*!< battery level indication */
    YOC_HF_CLIENT_COPS_CURRENT_OPERATOR_EVT,         /*!< current operator information */
    YOC_HF_CLIENT_BTRH_EVT,                          /*!< call response and hold event */
    YOC_HF_CLIENT_CLIP_EVT,                          /*!< Calling Line Identification notification */
    YOC_HF_CLIENT_CCWA_EVT,                          /*!< call waiting notification */
    YOC_HF_CLIENT_CLCC_EVT,                          /*!< list of current calls notification */
    YOC_HF_CLIENT_VOLUME_CONTROL_EVT,                /*!< audio volume control command from AG, provided by +VGM or +VGS message */
    YOC_HF_CLIENT_AT_RESPONSE_EVT,                   /*!< AT command response event */
    YOC_HF_CLIENT_CNUM_EVT,                          /*!< subscriber information response from AG */
    YOC_HF_CLIENT_BSIR_EVT,                          /*!< setting of in-band ring tone */
    YOC_HF_CLIENT_BINP_EVT,                          /*!< requested number of last voice tag from AG */
    YOC_HF_CLIENT_RING_IND_EVT,                      /*!< ring indication event */
} yoc_hf_client_cb_event_t;

/// HFP client callback parameters
typedef union {
    /**
     * @brief  YOC_HF_CLIENT_CONNECTION_STATE_EVT
     */
    struct hf_client_conn_stat_param {
        yoc_hf_client_connection_state_t state;   /*!< HF connection state */
    ...
    } conn_stat;                                  /*!< HF callback param of YOC_HF_CLIENT_CONNECTION_STATE_EVT */

    /**
     * @brief YOC_HF_CLIENT_AUDIO_STATE_EVT
     */
    struct hf_client_audio_stat_param {
        yoc_hf_client_audio_state_t state;        /*!< audio connection state */
        yoc_bd_addr_t remote_bda;                 /*!< remote bluetooth device address */
    } audio_stat;                                 /*!< HF callback param of YOC_HF_CLIENT_AUDIO_STATE_EVT */

    /**
     * @brief YOC_HF_CLIENT_BVRA_EVT
     */
    struct hf_client_bvra_param {
        yoc_hf_vr_state_t value;                  /*!< voice recognition state */
    } bvra;                                       /*!< HF callback param of YOC_HF_CLIENT_BVRA_EVT */

    /**
     * @brief YOC_HF_CLIENT_CIND_SERVICE_AVAILABILITY_EVT
     */
    struct hf_client_service_availability_param {
        yoc_hf_service_availability_status_t status;     /*!< service availability status */
    } service_availability;                              /*!< HF callback param of YOC_HF_CLIENT_CIND_SERVICE_AVAILABILITY_EVT */

    /**
     * @brief YOC_HF_CLIENT_CIND_ROAMING_STATUS_EVT
     */
    struct hf_client_network_roaming_param {
        yoc_hf_roaming_status_t status;          /*!< roaming status */
    } roaming;                                   /*!< HF callback param of YOC_HF_CLIENT_CIND_ROAMING_STATUS_EVT */

    /**
     * @brief YOC_HF_CLIENT_CIND_SIGNAL_STRENGTH_EVT
     */
    struct hf_client_signal_strength_ind_param {
        int value;                               /*!< signal strength value, ranges from 0 to 5 */
    } signal_strength;                           /*!< HF callback param of YOC_HF_CLIENT_CIND_SIGNAL_STRENGTH_EVT */

    /**
     * @brief YOC_HF_CLIENT_CIND_BATTERY_LEVEL_EVT
     */
    struct hf_client_battery_level_ind_param {
        int value;                               /*!< battery charge value, ranges from 0 to 5 */
    } battery_level;                             /*!< HF callback param of YOC_HF_CLIENT_CIND_BATTERY_LEVEL_EVT */

    /**
     * @brief YOC_HF_CLIENT_COPS_CURRENT_OPERATOR_EVT
     */
    struct hf_client_current_operator_param {
        const char *name;                        /*!< name of the network operator */
    } cops;                                      /*!< HF callback param of YOC_HF_CLIENT_COPS_CURRENT_OPERATOR_EVT */

    /**
     * @brief YOC_HF_CLIENT_CIND_CALL_EVT
     */
    struct hf_client_call_ind_param {
        yoc_hf_call_status_t status;             /*!< call status indicator */
    } call;                                      /*!< HF callback param of YOC_HF_CLIENT_CIND_CALL_EVT */

    /**
     * @brief YOC_HF_CLIENT_CIND_CALL_SETUP_EVT
     */
    struct hf_client_call_setup_ind_param {
        yoc_hf_call_setup_status_t status;       /*!< call setup status indicator */
    } call_setup;                                /*!< HF callback param of YOC_HF_CLIENT_BVRA_EVT */

    /**
     * @brief YOC_HF_CLIENT_CIND_CALL_HELD_EVT
     */
    struct hf_client_call_held_ind_param {
        yoc_hf_call_held_status_t status;        /*!< bluetooth proprietary call hold status indicator */
    } call_held;                                 /*!< HF callback param of YOC_HF_CLIENT_CIND_CALL_HELD_EVT */

    /**
     * @brief YOC_HF_CLIENT_BTRH_EVT
     */
    struct hf_client_btrh_param {
        yoc_hf_btrh_status_t status;             /*!< call hold and response status result code */
    } btrh;                                      /*!< HF callback param of YOC_HF_CLIENT_BRTH_EVT */

    /**
     * @brief YOC_HF_CLIENT_CLIP_EVT
     */
    struct hf_client_clip_param {
        const char *number;                      /*!< phone number string of call */
    } clip;                                      /*!< HF callback param of YOC_HF_CLIENT_CLIP_EVT */

    /**
     * @brief YOC_HF_CLIENT_CCWA_EVT
     */
    struct hf_client_ccwa_param {
        const char *number;                      /*!< phone number string of waiting call */
    } ccwa;                                      /*!< HF callback param of YOC_HF_CLIENT_BVRA_EVT */

    /**
     * @brief YOC_HF_CLIENT_CLCC_EVT
     */
    struct hf_client_clcc_param {
        int idx;                                 /*!< numbering(starting with 1) of the call */
        yoc_hf_current_call_direction_t dir;     /*!< direction of the call */
        yoc_hf_current_call_status_t status;     /*!< status of the call */
        yoc_hf_current_call_mpty_type_t mpty;    /*!< multi-party flag */
        char *number;                            /*!< phone number(optional) */
    } clcc;                                      /*!< HF callback param of YOC_HF_CLIENT_CLCC_EVT */

    /**
     * @brief YOC_HF_CLIENT_VOLUME_CONTROL_EVT
     */
    struct hf_client_volume_control_param {
        yoc_hf_volume_control_target_t type;     /*!< volume control target, speaker or microphone */
        int volume;                              /*!< gain, ranges from 0 to 15 */
    } volume_control;                            /*!< HF callback param of YOC_HF_CLIENT_VOLUME_CONTROL_EVT */

    /**
     * @brief YOC_HF_CLIENT_AT_RESPONSE_EVT
     */
    struct hf_client_at_response_param {
        yoc_hf_at_response_code_t code;          /*!< AT response code */
        yoc_hf_cme_err_t cme;                    /*!< Extended Audio Gateway Error Result Code */
    } at_response;                               /*!< HF callback param of YOC_HF_CLIENT_AT_RESPONSE_EVT */

    /**
     * @brief YOC_HF_CLIENT_CNUM_EVT
     */
    struct hf_client_cnum_param {
        const char *number;                      /*!< phone number string */
        yoc_hf_subscriber_service_type_t type;   /*!< service type that the phone number relates to */
    } cnum;                                      /*!< HF callback param of YOC_HF_CLIENT_CNUM_EVT */

    /**
     * @brief YOC_HF_CLIENT_BSIR_EVT
     */
    struct hf_client_bsirparam {
        yoc_hf_client_in_band_ring_state_t state;  /*!< setting state of in-band ring tone */
    } bsir;                                        /*!< HF callback param of YOC_HF_CLIENT_BSIR_EVT */

    /**
     * @brief YOC_HF_CLIENT_BINP_EVT
     */
    struct hf_client_binp_param {
        const char *number;                      /*!< phone number corresponding to the last voice tag in the HF */
    } binp;                                      /*!< HF callback param of YOC_HF_CLIENT_BINP_EVT */

} yoc_hf_client_cb_param_t;
 ...
 */
typedef void (* yoc_hf_client_incoming_data_cb_t)(const uint8_t *buf, uint32_t len);
 ...
 */
typedef uint32_t (* yoc_hf_client_outgoing_data_cb_t)(uint8_t *buf, uint32_t len);
 ...
 */
typedef void (* yoc_hf_client_cb_t)(yoc_hf_client_cb_event_t event, yoc_hf_client_cb_param_t *param);

/**
 * @brief           Register application callback function to HFP client module. This function should be called
 *                  only after yoc_bluedroid_enable() completes successfully, used by HFP client
 *
...
/**
 *
 * @brief           Connect to remote bluetooth HFP audio gateway(AG) device, must after yoc_hf_client_init()
 *
 ...
 *                       YOC_HF_CHLD_TYPE_REL_X or YOC_HF_CHLD_TYPE_PRIV_X
 *
 * @return
 *                  - BT_OK: disconnect request is sent to lower layer
 *                  - YOC_INVALID_STATE: if bluetooth stack is not yet enabled
 ...
 *                  layer will invoke yoc_hf_client_outgoing_data_cb_t to fetch data
 *
 */
