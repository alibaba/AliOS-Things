...
#define YOC_AVRC_TRANS_LABEL_MAX        15       /*!< max transaction label */
...
typedef enum {
    YOC_AVRC_FEAT_FLAG_CAT1 = 0x0001,                             /*!< category 1 */
    YOC_AVRC_FEAT_FLAG_CAT2 = 0x0002,                             /*!< category 2 */
    YOC_AVRC_FEAT_FLAG_CAT3 = 0x0004,                             /*!< category 3 */
    YOC_AVRC_FEAT_FLAG_CAT4 = 0x0008,                             /*!< category 4 */
    YOC_AVRC_FEAT_FLAG_BROWSING = 0x0040,                         /*!< browsing */
    YOC_AVRC_FEAT_FLAG_COVER_ART_GET_IMAGE_PROP = 0x0080,         /*!< Cover Art GetImageProperties */
    YOC_AVRC_FEAT_FLAG_COVER_ART_GET_IMAGE = 0x0100,              /*!< Cover Art GetImage */
    YOC_AVRC_FEAT_FLAG_COVER_ART_GET_LINKED_THUMBNAIL = 0x0200,   /*!< Cover Art GetLinkedThumbnail */
} yoc_avrc_feature_flag_t;

/// AVRC passthrough command code
typedef enum {
    YOC_AVRC_PT_CMD_SELECT         =   0x00,    /*!< select */
    YOC_AVRC_PT_CMD_UP             =   0x01,    /*!< up */
    YOC_AVRC_PT_CMD_DOWN           =   0x02,    /*!< down */
    YOC_AVRC_PT_CMD_LEFT           =   0x03,    /*!< left */
    YOC_AVRC_PT_CMD_RIGHT          =   0x04,    /*!< right */
    YOC_AVRC_PT_CMD_RIGHT_UP       =   0x05,    /*!< right-up */
    YOC_AVRC_PT_CMD_RIGHT_DOWN     =   0x06,    /*!< right-down */
    YOC_AVRC_PT_CMD_LEFT_UP        =   0x07,    /*!< left-up */
    YOC_AVRC_PT_CMD_LEFT_DOWN      =   0x08,    /*!< left-down */
    YOC_AVRC_PT_CMD_ROOT_MENU      =   0x09,    /*!< root menu */
    YOC_AVRC_PT_CMD_SETUP_MENU     =   0x0A,    /*!< setup menu */
    YOC_AVRC_PT_CMD_CONT_MENU      =   0x0B,    /*!< contents menu */
    YOC_AVRC_PT_CMD_FAV_MENU       =   0x0C,    /*!< favorite menu */
    YOC_AVRC_PT_CMD_EXIT           =   0x0D,    /*!< exit */
    YOC_AVRC_PT_CMD_0              =   0x20,    /*!< 0 */
    YOC_AVRC_PT_CMD_1              =   0x21,    /*!< 1 */
    YOC_AVRC_PT_CMD_2              =   0x22,    /*!< 2 */
    YOC_AVRC_PT_CMD_3              =   0x23,    /*!< 3 */
    YOC_AVRC_PT_CMD_4              =   0x24,    /*!< 4 */
    YOC_AVRC_PT_CMD_5              =   0x25,    /*!< 5 */
    YOC_AVRC_PT_CMD_6              =   0x26,    /*!< 6 */
    YOC_AVRC_PT_CMD_7              =   0x27,    /*!< 7 */
    YOC_AVRC_PT_CMD_8              =   0x28,    /*!< 8 */
    YOC_AVRC_PT_CMD_9              =   0x29,    /*!< 9 */
    YOC_AVRC_PT_CMD_DOT            =   0x2A,    /*!< dot */
    YOC_AVRC_PT_CMD_ENTER          =   0x2B,    /*!< enter */
    YOC_AVRC_PT_CMD_CLEAR          =   0x2C,    /*!< clear */
    YOC_AVRC_PT_CMD_CHAN_UP        =   0x30,    /*!< channel up */
    YOC_AVRC_PT_CMD_CHAN_DOWN      =   0x31,    /*!< channel down */
    YOC_AVRC_PT_CMD_PREV_CHAN      =   0x32,    /*!< previous channel */
    YOC_AVRC_PT_CMD_SOUND_SEL      =   0x33,    /*!< sound select */
    YOC_AVRC_PT_CMD_INPUT_SEL      =   0x34,    /*!< input select */
    YOC_AVRC_PT_CMD_DISP_INFO      =   0x35,    /*!< display information */
    YOC_AVRC_PT_CMD_HELP           =   0x36,    /*!< help */
    YOC_AVRC_PT_CMD_PAGE_UP        =   0x37,    /*!< page up */
    YOC_AVRC_PT_CMD_PAGE_DOWN      =   0x38,    /*!< page down */
    YOC_AVRC_PT_CMD_POWER          =   0x40,    /*!< power */
    YOC_AVRC_PT_CMD_VOL_UP         =   0x41,    /*!< volume up */
    YOC_AVRC_PT_CMD_VOL_DOWN       =   0x42,    /*!< volume down */
    YOC_AVRC_PT_CMD_MUTE           =   0x43,    /*!< mute */
    YOC_AVRC_PT_CMD_PLAY           =   0x44,    /*!< play */
    YOC_AVRC_PT_CMD_STOP           =   0x45,    /*!< stop */
    YOC_AVRC_PT_CMD_PAUSE          =   0x46,    /*!< pause */
    YOC_AVRC_PT_CMD_RECORD         =   0x47,    /*!< record */
    YOC_AVRC_PT_CMD_REWIND         =   0x48,    /*!< rewind */
    YOC_AVRC_PT_CMD_FAST_FORWARD   =   0x49,    /*!< fast forward */
    YOC_AVRC_PT_CMD_EJECT          =   0x4A,    /*!< eject */
    YOC_AVRC_PT_CMD_FORWARD        =   0x4B,    /*!< forward */
    YOC_AVRC_PT_CMD_BACKWARD       =   0x4C,    /*!< backward */
    YOC_AVRC_PT_CMD_ANGLE          =   0x50,    /*!< angle */
    YOC_AVRC_PT_CMD_SUBPICT        =   0x51,    /*!< subpicture */
    YOC_AVRC_PT_CMD_F1             =   0x71,    /*!< F1 */
    YOC_AVRC_PT_CMD_F2             =   0x72,    /*!< F2 */
    YOC_AVRC_PT_CMD_F3             =   0x73,    /*!< F3 */
    YOC_AVRC_PT_CMD_F4             =   0x74,    /*!< F4 */
    YOC_AVRC_PT_CMD_F5             =   0x75,    /*!< F5 */
    YOC_AVRC_PT_CMD_VENDOR         =   0x7E,    /*!< vendor unique */
} yoc_avrc_pt_cmd_t;

/// AVRC passthrough command filter
typedef enum {
    YOC_AVRC_PSTH_FILTER_ALLOWED_CMD = 0,       /*!< all of the PASSTHROUGH commands that can possibly be used, immuateble */
    YOC_AVRC_PSTH_FILTER_SUPPORTED_CMD = 1,     /*!< PASSTHROUGH commands selectively supported according to the current configuration */
    YOC_AVRC_PSTH_FILTER_SUPPORT_MAX,
} yoc_avrc_psth_filter_t;

/// AVRC passthrough command bit mask
typedef struct {
    uint16_t bits[8];                           /*!< bit mask representation of PASSTHROUGH commands */
} yoc_avrc_psth_bit_mask_t;

typedef enum {
    YOC_AVRC_BIT_MASK_OP_TEST = 0,      /*!< operation code to test a specific bit */
    YOC_AVRC_BIT_MASK_OP_SET = 1,       /*!< operation code to set a specific bit  */
    YOC_AVRC_BIT_MASK_OP_CLEAR = 2,     /*!< operation code to clear a specific bit */
} yoc_avrc_bit_mask_op_t;
...
typedef enum {
    ...
    YOC_AVRC_CT_GET_RN_CAPABILITIES_RSP_EVT = 6,     /*!< supported notification events capability of peer device */
    YOC_AVRC_CT_SET_ABSOLUTE_VOLUME_RSP_EVT = 7, /*!< set absolute volume response event */
} yoc_avrc_ct_cb_event_t;

/// AVRC Target callback events
typedef enum {
    YOC_AVRC_TG_CONNECTION_STATE_EVT = 0,          /*!< connection state changed event */
    YOC_AVRC_TG_REMOTE_FEATURES_EVT = 1,           /*!< feature of remote device indication event */
    YOC_AVRC_TG_PASSTHROUGH_CMD_EVT = 2,           /*!< passthrough command event */
    YOC_AVRC_TG_SET_ABSOLUTE_VOLUME_CMD_EVT = 3,   /*!< set absolute volume command from remote device */
    YOC_AVRC_TG_REGISTER_NOTIFICATION_EVT = 4,     /*!< register notification event */
} yoc_avrc_tg_cb_event_t;
...
typedef enum {
    ...
    YOC_AVRC_RN_NOW_PLAYING_CHANGE = 0x09,        /*!< now playing content changed */
    YOC_AVRC_RN_AVAILABLE_PLAYERS_CHANGE = 0x0a,  /*!< available players changed */
    YOC_AVRC_RN_ADDRESSED_PLAYER_CHANGE = 0x0b,   /*!< the addressed player changed */
    YOC_AVRC_RN_UIDS_CHANGE = 0x0c,               /*!< UIDs changed */
    YOC_AVRC_RN_VOLUME_CHANGE = 0x0d,             /*!< volume changed locally on TG */
    YOC_AVRC_RN_MAX_EVT
} yoc_avrc_rn_event_ids_t;

/// AVRC target notification event notification capability
typedef enum {
    YOC_AVRC_RN_CAP_ALLOWED_EVT = 0,              /*!< all of the notification events that can possibly be supported, immutable */
    YOC_AVRC_RN_CAP_SUPPORTED_EVT = 1,            /*!< notification events selectively supported according to the current configuration */
    YOC_AVRC_RN_CAP_MAX,
} yoc_avrc_rn_evt_cap_t;

/// AVRC target notification event capability bit mask
typedef struct {
    uint16_t bits;                                /*!< bit mask representation of PASSTHROUGH commands */
} yoc_avrc_rn_evt_cap_mask_t;

/// AVRC notification response type
typedef enum {
    YOC_AVRC_RN_RSP_INTERIM = 13,     /*!< initial response to RegisterNotification, should be sent T_mtp(1000ms) from receiving the command */
    YOC_AVRC_RN_RSP_CHANGED = 15,     /*!< final response to RegisterNotification command */
} yoc_avrc_rn_rsp_t;
...
typedef enum {
    ...
    YOC_AVRC_PS_SHUFFLE_ALL = 0x2,                /*<! shuffle all tracks */
...
typedef enum {
    YOC_AVRC_RSP_NOT_IMPL   = 8,                  /*!< not implemented */
    YOC_AVRC_RSP_ACCEPT     = 9,                  /*!< accept */
    YOC_AVRC_RSP_REJECT     = 10,                 /*!< reject */
    YOC_AVRC_RSP_IN_TRANS   = 11,                 /*!< in transition */
    YOC_AVRC_RSP_IMPL_STBL  = 12,                 /*!< implemented/stable */
    YOC_AVRC_RSP_CHANGED    = 13,                 /*!< changed */
    YOC_AVRC_RSP_INTERIM    = 15,                 /*!< interim */
} yoc_avrc_rsp_t;

/// AVRCP battery status
typedef enum {
    YOC_AVRC_BATT_NORMAL       = 0,               /*!< normal state */
    YOC_AVRC_BATT_WARNING      = 1,               /*!< unable to operate soon */
    YOC_AVRC_BATT_CRITICAL     = 2,               /*!< cannot operate any more */
    YOC_AVRC_BATT_EXTERNAL     = 3,               /*!< plugged to external power supply */
    YOC_AVRC_BATT_FULL_CHARGE  = 4,               /*!< when completely charged from external power supply */
} yoc_avrc_batt_stat_t;

/// AVRCP current status of playback
typedef enum {
    YOC_AVRC_PLAYBACK_STOPPED = 0,                /*!< stopped */
    YOC_AVRC_PLAYBACK_PLAYING = 1,                /*!< playing */
    YOC_AVRC_PLAYBACK_PAUSED = 2,                 /*!< paused */
    YOC_AVRC_PLAYBACK_FWD_SEEK = 3,               /*!< forward seek */
    YOC_AVRC_PLAYBACK_REV_SEEK = 4,               /*!< reverse seek */
    YOC_AVRC_PLAYBACK_ERROR = 0xFF,               /*!< error */
} yoc_avrc_playback_stat_t;

/// AVRCP notification parameters
typedef union
{
    uint8_t volume;                          /*!< response data for YOC_AVRC_RN_VOLUME_CHANGE, ranges 0..127 */
    yoc_avrc_playback_stat_t playback;       /*!< response data for YOC_AVRC_RN_PLAY_STATUS_CHANGE */
    uint8_t elm_id[8];                       /*!< response data for YOC_AVRC_RN_TRACK_CHANGE */
    uint32_t play_pos;                       /*!< response data for YOC_AVRC_RN_PLAY_POS_CHANGED, in millisecond */
    yoc_avrc_batt_stat_t batt;               /*!< response data for YOC_AVRC_RN_BATTERY_STATUS_CHANGE */
} yoc_avrc_rn_param_t;
...
typedef union {
    ...
    struct avrc_ct_change_notify_param {
        ...
        yoc_avrc_rn_param_t event_parameter;     /*!< event notification parameter */
    ...
    /**
     * @brief YOC_AVRC_CT_GET_RN_CAPABILITIES_RSP_EVT
     */
    struct avrc_ct_get_rn_caps_rsp_param {
        ...
        yoc_avrc_rn_evt_cap_mask_t evt_set;      /*!< supported event_ids represented in bit-mask */
    } get_rn_caps_rsp;                           /*!< get supported event capabilities response from AVRCP target */

    /**
     * @brief YOC_AVRC_CT_SET_ABSOLUTE_VOLUME_RSP_EVT
     */
...
typedef union {
    /**
     * @brief YOC_AVRC_TG_CONNECTION_STATE_EVT
     */
    ...
    /**
     * @brief YOC_AVRC_TG_REMOTE_FEATURES_EVT
     */
    ...
    /**
     * @brief YOC_AVRC_TG_PASSTHROUGH_CMD_EVT
     */
    ...
    /**
     * @brief YOC_AVRC_TG_SET_ABSOLUTE_VOLUME_CMD_EVT
     */
    ...
    /**
     * @brief YOC_AVRC_TG_REGISTER_NOTIFICATION_EVT
     */
 ...
 * @param           param : Pointer to callback parameter union
 */
typedef void (* yoc_avrc_tg_cb_t)(yoc_avrc_tg_cb_event_t event, yoc_avrc_tg_cb_param_t *param);


/**
 * @brief           Register application callbacks to AVRCP module. This function should be
 *                  called after yoc_bluedroid_enable() completes successfully
 *
 ...
 * @param[in]       event_parameter : playback interval for YOC_AVRC_RN_PLAY_POS_CHANGED;
 *                                     For other events , value of this parameter is ignored.
 * @return
 *                  - BT_OK: success
 *                  - BT_ERR_INVALID_STATE: if bluetooth stack is not yet enabled
 *                  - BT_ERR_INVALID_SIZE: if the event_id is not supported in current implementation
 *                  - BT_FAIL: others
 */
 ...
 *                  after yoc_avrc_tg_init().
 *                  For filter type YOC_AVRC_PSTH_FILTER_ALLOWED_CMD, the retrieved command set is constant and
 *                  it covers all of the passthrough commands that can possibly be supported.
 *                  For filter type YOC_AVRC_PSTH_FILTER_SUPPORT_COMMANDS, the retrieved command set covers the
 *                  passthrough commands selected to be supported according to current configuration. The
 *                  configuration can be changed using yoc_avrc_tg_set_psth_cmd_filter()
 *
 * @return
 *                  - BT_OK: success
 *                  - BT_ERR_INVALID_STATE: if bluetooth stack is not enabled or AVRC TG is not initialized
 *                  - BT_ERR_INVALID_ARG: if filter type is invalid or cmd_set is NULL
 *                  - BT_FAIL: otherwise
 */
 ...
 *                  filter type and bit mask for the passthrough commands. This function should be called
 *                  after yoc_avrc_tg_init().
 *                  If filter type is YOC_AVRC_PSTH_FILTER_SUPPORT_CMD, the passthrough commands which
 *                  are set "1" as given in cmd_set will generate YOC_AVRC_CT_PASSTHROUGH_RSP_EVT callback
 ...
 *                  command set. The allowed command set can be retrieved using yoc_avrc_tg_get_psth_cmd_filter()
 *                  with filter type "YOC_AVRC_PSTH_FILTER_ALLOWED_CMD".
 *
 *                  Filter type "YOC_AVRC_PSTH_FILTER_ALLOWED_CMD" does not apply to this function
 * @return
 *                  - BT_OK: success
 *                  - BT_ERR_INVALID_STATE: if bluetooth stack is not enabled
 *                  - BT_ERR_INVALID_ARG: if filter type is invalid or cmd_set is NULL
 *                  - BT_ERR_INVALID_SIZE:: if filter type is YOC_AVRC_PSTH_FILTER_ALLOWED_CMD, or cmd_set
...
/**
 * @brief           Operate on the type yoc_avrc_psth_bit_mask_t with regard to a specific PASSTHROUGH command
 ...
 *
 * @return          For operation YOC_AVRC_BIT_MASK_OP_SET or YOC_AVRC_BIT_MASK_OP_CLEAR, return
 *                  true for a successful operation, otherwise return false
 *                  For operation YOC_AVRC_BIT_MASK_OP_TEST, return true if the corresponding bit
 ...
 *                  yoc_avrc_tg_init().
 *                  For capability type "YOC_AVRC_RN_CAP_ALLOWED_EVT, the retrieved event set is constant and
 *                  it covers all of the notifcation events that can possibly be supported with current
 *                  implementation.
 *                  For capability type YOC_AVRC_RN_CAP_SUPPORTED_EVT, the event set covers the notification
 *                  events selected to be supported under current configuration, The configuration can be
 *                  changed using yoc_avrc_tg_set_rn_evt_cap()
 *
 * @return
 *                  - BT_OK: success
 *                  - BT_ERR_INVALID_STATE: if bluetooth stack is not enabled or AVRC TG is not initialized
 *                  - BT_ERR_INVALID_ARG: if cap is invalid or evt_set is NULL
 *                  - BT_FAIL: otherwise
 */
 ...
 *                  implementation. This function should be called after yoc_avrc_tg_init().
 *
 * @return
 *                  - BT_OK: success
 *                  - BT_ERR_INVALID_STATE: if bluetooth stack is not enabled
 *                  - BT_ERR_INVALID_ARG: if evt_set is NULL
 *
 */
bt_err_t yoc_avrc_tg_set_rn_evt_cap(const yoc_avrc_rn_evt_cap_mask_t *evt_set);

/**
 * @brief           Operate on the type yoc_avrc_rn_evt_cap_mask_t with regard to a specific event
 * @param[in]       op: operation requested on the bit mask field
 ...
 *                  capability can be set using yoc_avrc_tg_set_rn_evt_cap(),
 *                  in a bit mask representation in evt_set. This function should be called after
 *                  yoc_avrc_tg_init()
