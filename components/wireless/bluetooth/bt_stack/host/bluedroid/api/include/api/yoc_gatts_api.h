...
#ifndef __YOC_GATTS_API_H__
#define __YOC_GATTS_API_H__
...
typedef enum {
    YOC_GATTS_REG_EVT                 = 0,       /*!< When register application id, the event comes */
    YOC_GATTS_READ_EVT                = 1,       /*!< When gatt client request read operation, the event comes */
    YOC_GATTS_WRITE_EVT               = 2,       /*!< When gatt client request write operation, the event comes */
    YOC_GATTS_EXEC_WRITE_EVT          = 3,       /*!< When gatt client request execute write, the event comes */
    YOC_GATTS_MTU_EVT                 = 4,       /*!< When set mtu complete, the event comes */
    YOC_GATTS_CONF_EVT                = 5,       /*!< When receive confirm, the event comes */
    YOC_GATTS_UNREG_EVT               = 6,       /*!< When unregister application id, the event comes */
    YOC_GATTS_CREATE_EVT              = 7,       /*!< When create service complete, the event comes */
    YOC_GATTS_ADD_INCL_SRVC_EVT       = 8,       /*!< When add included service complete, the event comes */
    YOC_GATTS_ADD_CHAR_EVT            = 9,       /*!< When add characteristic complete, the event comes */
    YOC_GATTS_ADD_CHAR_DESCR_EVT      = 10,      /*!< When add descriptor complete, the event comes */
    YOC_GATTS_DELETE_EVT              = 11,      /*!< When delete service complete, the event comes */
    YOC_GATTS_START_EVT               = 12,      /*!< When start service complete, the event comes */
    YOC_GATTS_STOP_EVT                = 13,      /*!< When stop service complete, the event comes */
    YOC_GATTS_CONNECT_EVT             = 14,      /*!< When gatt client connect, the event comes */
    YOC_GATTS_DISCONNECT_EVT          = 15,      /*!< When gatt client disconnect, the event comes */
    YOC_GATTS_OPEN_EVT                = 16,      /*!< When connect to peer, the event comes */
    YOC_GATTS_CANCEL_OPEN_EVT         = 17,      /*!< When disconnect from peer, the event comes */
    YOC_GATTS_CLOSE_EVT               = 18,      /*!< When gatt server close, the event comes */
    YOC_GATTS_LISTEN_EVT              = 19,      /*!< When gatt listen to be connected the event comes */
    YOC_GATTS_CONGEST_EVT             = 20,      /*!< When congest happen, the event comes */
    /* following is extra event */
    YOC_GATTS_RESPONSE_EVT            = 21,      /*!< When gatt send response complete, the event comes */
    YOC_GATTS_CREAT_ATTR_TAB_EVT      = 22,      /*!< When gatt create table complete, the event comes */
    YOC_GATTS_SET_ATTR_VAL_EVT        = 23,      /*!< When gatt set attr value complete, the event comes */
    YOC_GATTS_SEND_SERVICE_CHANGE_EVT = 24,      /*!< When gatt send service change indication complete, the event comes */
} yoc_gatts_cb_event_t;
...
typedef union {
    /**
     * @brief YOC_GATTS_REG_EVT
     */
    struct gatts_reg_evt_param {
        yoc_gatt_status_t status;       /*!< Operation status */
        uint16_t app_id;                /*!< Application id which input in register API */
    } reg;                              /*!< Gatt server callback param of YOC_GATTS_REG_EVT */

    /**
     * @brief YOC_GATTS_READ_EVT
     */
    struct gatts_read_evt_param {
        uint16_t conn_id;               /*!< Connection id */
        uint32_t trans_id;              /*!< Transfer id */
        yoc_bd_addr_t bda;              /*!< The bluetooth device address which been read */
        uint16_t handle;                /*!< The attribute handle */
        uint16_t offset;                /*!< Offset of the value, if the value is too long */
        bool is_long;                   /*!< The value is too long or not */
        bool need_rsp;                  /*!< The read operation need to do response */
    } read;                             /*!< Gatt server callback param of YOC_GATTS_READ_EVT */


    /**
     * @brief YOC_GATTS_WRITE_EVT
     */
    struct gatts_write_evt_param {
        uint16_t conn_id;               /*!< Connection id */
        uint32_t trans_id;              /*!< Transfer id */
        yoc_bd_addr_t bda;              /*!< The bluetooth device address which been written */
        uint16_t handle;                /*!< The attribute handle */
        uint16_t offset;                /*!< Offset of the value, if the value is too long */
    ...
    } write;                            /*!< Gatt server callback param of YOC_GATTS_WRITE_EVT */

    /**
     * @brief YOC_GATTS_EXEC_WRITE_EVT
     */
    struct gatts_exec_write_evt_param {
        uint16_t conn_id;               /*!< Connection id */
        uint32_t trans_id;              /*!< Transfer id */
        yoc_bd_addr_t bda;              /*!< The bluetooth device address which been written */
#define YOC_GATT_PREP_WRITE_CANCEL 0x00 /*!< Prepare write flag to indicate cancel prepare write */
#define YOC_GATT_PREP_WRITE_EXEC   0x01 /*!< Prepare write flag to indicate execute prepare write */
        uint8_t exec_write_flag;        /*!< Execute write flag */
    } exec_write;                       /*!< Gatt server callback param of YOC_GATTS_EXEC_WRITE_EVT */

    /**
     * @brief YOC_GATTS_MTU_EVT
     */
    struct gatts_mtu_evt_param {
        uint16_t conn_id;               /*!< Connection id */
        uint16_t mtu;                   /*!< MTU size */
    } mtu;                              /*!< Gatt server callback param of YOC_GATTS_MTU_EVT */

    /**
     * @brief YOC_GATTS_CONF_EVT
     */
    ...
    } conf;                             /*!< Gatt server callback param of YOC_GATTS_CONF_EVT (confirm) */

    /**
     * @brief YOC_GATTS_UNREG_EVT
     */

    /**
     * @brief YOC_GATTS_CREATE_EVT
     */
    struct gatts_create_evt_param {
        yoc_gatt_status_t status;       /*!< Operation status */
        uint16_t service_handle;        /*!< Service attribute handle */
        yoc_gatt_srvc_id_t service_id;  /*!< Service id, include service uuid and other information */
    } create;                           /*!< Gatt server callback param of YOC_GATTS_CREATE_EVT */

    /**
     * @brief YOC_GATTS_ADD_INCL_SRVC_EVT
     */
    struct gatts_add_incl_srvc_evt_param {
        yoc_gatt_status_t status;       /*!< Operation status */
        uint16_t attr_handle;           /*!< Included service attribute handle */
        uint16_t service_handle;        /*!< Service attribute handle */
    } add_incl_srvc;                    /*!< Gatt server callback param of YOC_GATTS_ADD_INCL_SRVC_EVT */

    /**
     * @brief YOC_GATTS_ADD_CHAR_EVT
     */
    struct gatts_add_char_evt_param {
        yoc_gatt_status_t status;       /*!< Operation status */
        uint16_t attr_handle;           /*!< Characteristic attribute handle */
        uint16_t service_handle;        /*!< Service attribute handle */
        yoc_bt_uuid_t char_uuid;        /*!< Characteristic uuid */
    } add_char;                         /*!< Gatt server callback param of YOC_GATTS_ADD_CHAR_EVT */

    /**
     * @brief YOC_GATTS_ADD_CHAR_DESCR_EVT
     */
    struct gatts_add_char_descr_evt_param {
        yoc_gatt_status_t status;       /*!< Operation status */
        uint16_t attr_handle;           /*!< Descriptor attribute handle */
        uint16_t service_handle;        /*!< Service attribute handle */
        yoc_bt_uuid_t descr_uuid;       /*!< Characteristic descriptor uuid */
    } add_char_descr;                   /*!< Gatt server callback param of YOC_GATTS_ADD_CHAR_DESCR_EVT */

    /**
     * @brief YOC_GATTS_DELETE_EVT
     */
    struct gatts_delete_evt_param {
        yoc_gatt_status_t status;       /*!< Operation status */
        uint16_t service_handle;        /*!< Service attribute handle */
    } del;                              /*!< Gatt server callback param of YOC_GATTS_DELETE_EVT */

    /**
     * @brief YOC_GATTS_START_EVT
     */
    struct gatts_start_evt_param {
        yoc_gatt_status_t status;       /*!< Operation status */
        uint16_t service_handle;        /*!< Service attribute handle */
    } start;                            /*!< Gatt server callback param of YOC_GATTS_START_EVT */

    /**
     * @brief YOC_GATTS_STOP_EVT
     */
    struct gatts_stop_evt_param {
        yoc_gatt_status_t status;       /*!< Operation status */
        uint16_t service_handle;        /*!< Service attribute handle */
    } stop;                             /*!< Gatt server callback param of YOC_GATTS_STOP_EVT */

    /**
     * @brief YOC_GATTS_CONNECT_EVT
     */
    ...
    } connect;                          /*!< Gatt server callback param of YOC_GATTS_CONNECT_EVT */

    /**
     * @brief YOC_GATTS_DISCONNECT_EVT
     */
    struct gatts_disconnect_evt_param {
        uint16_t conn_id;               /*!< Connection id */
        yoc_bd_addr_t remote_bda;       /*!< Remote bluetooth device address */
        yoc_gatt_conn_reason_t reason;  /*!< Indicate the reason of disconnection */
    } disconnect;                       /*!< Gatt server callback param of YOC_GATTS_DISCONNECT_EVT */

    /**
     * @brief YOC_GATTS_OPEN_EVT
     */
    struct gatts_open_evt_param {
        yoc_gatt_status_t status;       /*!< Operation status */
    } open;                             /*!< Gatt server callback param of YOC_GATTS_OPEN_EVT */

    /**
     * @brief YOC_GATTS_CANCEL_OPEN_EVT
     */
    struct gatts_cancel_open_evt_param {
        yoc_gatt_status_t status;       /*!< Operation status */
    } cancel_open;                      /*!< Gatt server callback param of YOC_GATTS_CANCEL_OPEN_EVT */

    /**
     * @brief YOC_GATTS_CLOSE_EVT
     */
    struct gatts_close_evt_param {
        yoc_gatt_status_t status;       /*!< Operation status */
        uint16_t conn_id;               /*!< Connection id */
    } close;                            /*!< Gatt server callback param of YOC_GATTS_CLOSE_EVT */

    /**
     * @brief YOC_GATTS_LISTEN_EVT
     */
    /**
     * @brief YOC_GATTS_CONGEST_EVT
     */
    struct gatts_congest_evt_param {
        uint16_t conn_id;               /*!< Connection id */
        bool congested;                 /*!< Congested or not */
    } congest;                          /*!< Gatt server callback param of YOC_GATTS_CONGEST_EVT */

    /**
     * @brief YOC_GATTS_RESPONSE_EVT
     */
    struct gatts_rsp_evt_param {
        yoc_gatt_status_t status;       /*!< Operation status */
        uint16_t handle;                /*!< Attribute handle which send response */
    } rsp;                              /*!< Gatt server callback param of YOC_GATTS_RESPONSE_EVT */

    /**
     * @brief YOC_GATTS_CREAT_ATTR_TAB_EVT
     */
    struct gatts_add_attr_tab_evt_param{
        yoc_gatt_status_t status;       /*!< Operation status */
        yoc_bt_uuid_t svc_uuid;         /*!< Service uuid type */
        uint8_t svc_inst_id;            /*!< Service id */
        uint16_t num_handle;            /*!< The number of the attribute handle to be added to the gatts database */
        uint16_t *handles;              /*!< The number to the handles */
    } add_attr_tab;                     /*!< Gatt server callback param of YOC_GATTS_CREAT_ATTR_TAB_EVT */


   /**
    * @brief YOC_GATTS_SET_ATTR_VAL_EVT
    */
    struct gatts_set_attr_val_evt_param{
        uint16_t srvc_handle;           /*!< The service handle */
        uint16_t attr_handle;           /*!< The attribute  handle */
        yoc_gatt_status_t status;       /*!< Operation status*/
    } set_attr_val;                     /*!< Gatt server callback param of YOC_GATTS_SET_ATTR_VAL_EVT */

    /**
    * @brief YOC_GATTS_SEND_SERVICE_CHANGE_EVT
    */
    struct gatts_send_service_change_evt_param{
        yoc_gatt_status_t status;       /*!< Operation status*/
    } service_change;                    /*!< Gatt server callback param of YOC_GATTS_SEND_SERVICE_CHANGE_EVT */

} yoc_ble_gatts_cb_param_t;
 ...
 */
typedef void (* yoc_gatts_cb_t)(yoc_gatts_cb_event_t event, yoc_gatt_if_t gatts_if, yoc_ble_gatts_cb_param_t *param);
 ...
 *                  'yoc_ble_gatts_create_service' and 'yoc_ble_gatts_add_char'.  After included
