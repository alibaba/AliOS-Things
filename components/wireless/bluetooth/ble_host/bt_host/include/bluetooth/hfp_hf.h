...
struct bt_hfp_hf_cb {
	 ...
	 */
	void (*service)(struct bt_conn *conn, bt_u32_t value);
	/** HF indicator Callback
	 *
	 ...
	 */
	void (*call)(struct bt_conn *conn, bt_u32_t value);
	/** HF indicator Callback
	 *
	 ...
	 */
	void (*call_setup)(struct bt_conn *conn, bt_u32_t value);
	/** HF indicator Callback
	 *
	 ...
	 */
	void (*call_held)(struct bt_conn *conn, bt_u32_t value);
	/** HF indicator Callback
	 *
	 ...
	 */
	void (*signal)(struct bt_conn *conn, bt_u32_t value);
	/** HF indicator Callback
	 *
	 ...
	 */
	void (*roam)(struct bt_conn *conn, bt_u32_t value);
	/** HF indicator Callback
	 *
	 ...
	 */
	void (*battery)(struct bt_conn *conn, bt_u32_t value);
