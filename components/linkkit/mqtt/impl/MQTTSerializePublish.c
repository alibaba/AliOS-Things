 ...
 * @return serialized length, or error if 0
 */
/*  int MQTTSerialize_puback(unsigned char* buf, int buflen, unsigned short
 * packetid) */
/*  { */
 ...
 * @return serialized length, or error if 0
 */
int MQTTSerialize_pubrel(unsigned char *buf, int buflen, unsigned char dup,
 ...
 * @return serialized length, or error if 0
 */
int MQTTSerialize_pubcomp(unsigned char *buf, int buflen,
                          unsigned short packetid)
{
