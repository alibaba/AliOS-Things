                                       ...
                                       coap_dtls_options_t *p_options)
{
    ...
    if (result == 0) {
        ...
        mbedtls_ssl_set_bio(&p_dtls_session->context,
                            (void *)&p_dtls_session->fd, _net_send, _net_recv,
                            _net_recv_timeout);
...
DTLSContext *HAL_DTLSSession_create(coap_dtls_options_t *p_options)
{
    ...
    if (NULL != p_dtls_session) {
        ...
        mbedtls_ssl_conf_rng(&p_dtls_session->conf, HAL_DTLS_Random,
        ...
        // mbedtls_ssl_conf_dtls_cookies(&p_dtls_session->conf,
        // mbedtls_ssl_cookie_write,
        //                               mbedtls_ssl_cookie_check,
        //                               &p_dtls_session->cookie_ctx);
        ...
        result = _net_connect(&p_dtls_session->fd, p_options->p_host, port,
