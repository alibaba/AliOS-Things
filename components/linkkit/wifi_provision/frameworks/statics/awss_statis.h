...
struct awss_statis_conn_router_t {
    ...
    uint32_t conn_router_time_mean; /* the mean time of success connection with
                                       router */
    uint32_t conn_router_time_max;  /* the max time of success connection with
                                       router */
    uint32_t conn_router_time_min;  /* the min time of success connection with
                                       router */
