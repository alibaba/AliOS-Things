...
#define TOPIC_AWSS_GET_CONNECTAP_INFO_MCAST \
    "/sys/awss/device/connectap/info/get"
#define TOPIC_AWSS_GET_CONNECTAP_INFO_UCAST \
    "/sys/%s/%s/awss/device/connectap/info/get"
...
#define AWSS_STATIS_FMT                                       \
    "{\"template\":\"timestamp logLevel module traceContext " \
    "logContent\",\"contents\":[\"%u %s %s %u %s\"]}"
