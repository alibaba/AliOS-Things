...
int CoAPSerialize_Header(CoAPMessage *msg, unsigned char *buf,
                         unsigned short buflen)
{
    ...
    buf[0] =
        (((msg->header.version & 0x3) << 6) | ((msg->header.type & 0x3) << 4)) |
...
int CoAPSerialize_Token(CoAPMessage *msg, unsigned char *buf,
                        unsigned short buflen)
{
    int i = 0;
...
static unsigned short CoAPSerialize_Option(CoAPMsgOption *option,
                                           unsigned char *buf)
{
...
unsigned short CoAPSerialize_Options(CoAPMessage *msg, unsigned char *buf,
                                     unsigned short buflen)
{
    int i = 0;
...
int CoAPSerialize_Message(CoAPMessage *msg, unsigned char *buf,
                          unsigned short buflen)
{
    unsigned char *ptr = buf;
    unsigned short count = 0;
