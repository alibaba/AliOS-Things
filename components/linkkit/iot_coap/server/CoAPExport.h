...
extern int CoAPMessage_send(CoAPContext *context, NetworkAddr *remote,
                            CoAPMessage *message);
...
/*CoAP observe APIs*/
extern int CoAPObsServer_add(CoAPContext *context, const char *path,
                             NetworkAddr *remote, CoAPMessage *request);

extern int CoAPObsServer_notify(CoAPContext *context, const char *path,
