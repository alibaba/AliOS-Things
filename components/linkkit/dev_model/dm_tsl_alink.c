...
typedef int (*dm_shw_data_parse)(_IN_ dm_shw_data_value_t *data_value,
                                 _IN_ lite_cjson_t *root);
typedef int (*dm_shw_array_parse)(_IN_ dm_shw_data_value_t *data_value,
                                  _IN_ lite_cjson_t *root);
...
/* Data Parse */
static int _dm_shw_int_parse(_IN_ dm_shw_data_value_t *data_value,
                             _IN_ lite_cjson_t *root);
static int _dm_shw_float_parse(_IN_ dm_shw_data_value_t *data_value,
                               _IN_ lite_cjson_t *root);
static int _dm_shw_double_parse(_IN_ dm_shw_data_value_t *data_value,
                                _IN_ lite_cjson_t *root);
static int _dm_shw_text_parse(_IN_ dm_shw_data_value_t *data_value,
                              _IN_ lite_cjson_t *root);
static int _dm_shw_enum_parse(_IN_ dm_shw_data_value_t *data_value,
                              _IN_ lite_cjson_t *root);
static int _dm_shw_date_parse(_IN_ dm_shw_data_value_t *data_value,
                              _IN_ lite_cjson_t *root);
static int _dm_shw_bool_parse(_IN_ dm_shw_data_value_t *data_value,
                              _IN_ lite_cjson_t *root);
static int _dm_shw_array_parse(_IN_ dm_shw_data_value_t *data_value,
                               _IN_ lite_cjson_t *root);
static int _dm_shw_struct_parse(_IN_ dm_shw_data_value_t *data_value,
                                _IN_ lite_cjson_t *root);
static int _dm_shw_property_parse(_IN_ dm_shw_data_t *property,
                                  _IN_ lite_cjson_t *root);

/* Array Data Parse */
static int _dm_shw_array_int_parse(_IN_ dm_shw_data_value_t *data_value,
                                   _IN_ lite_cjson_t *root);
static int _dm_shw_array_float_parse(_IN_ dm_shw_data_value_t *data_value,
                                     _IN_ lite_cjson_t *root);
static int _dm_shw_array_double_parse(_IN_ dm_shw_data_value_t *data_value,
                                      _IN_ lite_cjson_t *root);
static int _dm_shw_array_text_parse(_IN_ dm_shw_data_value_t *data_value,
                                    _IN_ lite_cjson_t *root);
static int _dm_shw_array_enum_parse(_IN_ dm_shw_data_value_t *data_value,
                                    _IN_ lite_cjson_t *root);
static int _dm_shw_array_date_parse(_IN_ dm_shw_data_value_t *data_value,
                                    _IN_ lite_cjson_t *root);
static int _dm_shw_array_bool_parse(_IN_ dm_shw_data_value_t *data_value,
                                    _IN_ lite_cjson_t *root);
static int _dm_shw_array_array_parse(_IN_ dm_shw_data_value_t *data_value,
                                     _IN_ lite_cjson_t *root);
static int _dm_shw_array_struct_parse(_IN_ dm_shw_data_value_t *data_value,
                                      _IN_ lite_cjson_t *root);
...
static dm_tsl_alink_mapping_t g_dm_tsl_alink_mapping[] = {
    ...
    { DM_SHW_DATA_TYPE_FLOAT, "float", _dm_shw_float_parse,
      _dm_shw_array_float_parse },
    { DM_SHW_DATA_TYPE_DOUBLE, "double", _dm_shw_double_parse,
      _dm_shw_array_double_parse },
    { DM_SHW_DATA_TYPE_TEXT, "text", _dm_shw_text_parse,
      _dm_shw_array_text_parse },
    { DM_SHW_DATA_TYPE_ENUM, "enum", _dm_shw_enum_parse,
      _dm_shw_array_enum_parse },
    { DM_SHW_DATA_TYPE_DATE, "date", _dm_shw_date_parse,
      _dm_shw_array_date_parse },
    { DM_SHW_DATA_TYPE_BOOL, "bool", _dm_shw_bool_parse,
      _dm_shw_array_bool_parse },
    { DM_SHW_DATA_TYPE_ARRAY, "array", _dm_shw_array_parse,
      _dm_shw_array_array_parse },
    { DM_SHW_DATA_TYPE_STRUCT, "struct", _dm_shw_struct_parse,
      _dm_shw_array_struct_parse }
};

static int _dm_shw_get_type(_IN_ const char *name, _IN_ int name_len,
                            _OU_ dm_shw_data_type_e *type)
{
    ...
    for (index = 0; index < sizeof(g_dm_tsl_alink_mapping) /
                                sizeof(dm_tsl_alink_mapping_t);
         index++) {
...
static int _dm_shw_array_int_parse(_IN_ dm_shw_data_value_t *data_value,
                                   _IN_ lite_cjson_t *root)
{
    dm_shw_data_value_complex_t *complex_array =
                                    ...
                                    _IN_ lite_cjson_t *root)
{
    ...
    for (index = 0; index < complex_array->size; index++) {
        ...
        *((char **)(complex_array->value) + index) =
            DM_malloc(strlen(temp) + 1);
        if (*((char **)(complex_array->value) + index) != NULL) {
            memset(*((char **)(complex_array->value) + index), 0,
                   strlen(temp) + 1);
            memcpy(*((char **)(complex_array->value) + index), temp,
                   strlen(temp));
        }
    }
#endif
                                      ...
                                      _IN_ lite_cjson_t *root)
{
    ...
    complex_array->value =
        DM_malloc((complex_array->size) * (sizeof(dm_shw_data_t)));
    if (complex_array->value == NULL) {
        return DM_MEMORY_NOT_ENOUGH;
    }
    memset(complex_array->value, 0,
           (complex_array->size) * (sizeof(dm_shw_data_t)));
                               ...
                               _IN_ lite_cjson_t *root)
{
    ...
    res = lite_cjson_object_item(root, DM_SHW_KEY_SIZE, strlen(DM_SHW_KEY_SIZE),
                                 &lite_item);
    ...
    memset(&lite_item, 0, sizeof(lite_cjson_t));
    res = lite_cjson_object_item(root, DM_SHW_KEY_ITEM, strlen(DM_SHW_KEY_ITEM),
                                 &lite_item);
    if (res != SUCCESS_RETURN && !lite_cjson_is_object(&lite_item)) {
        return DM_JSON_PARSE_FAILED;
    }
    memset(&lite_type, 0, sizeof(lite_cjson_t));
    res = lite_cjson_object_item(&lite_item, DM_SHW_KEY_TYPE,
                                 strlen(DM_SHW_KEY_TYPE), &lite_type);
    if (res != SUCCESS_RETURN && !lite_cjson_is_string(&lite_type)) {
        return DM_JSON_PARSE_FAILED;
    }
    res = _dm_shw_get_type(lite_type.value, lite_type.value_length,
                           &complex_array->type);
    if (res != SUCCESS_RETURN) {
        return FAIL_RETURN;
    }
    ...
    res = lite_cjson_object_item(&lite_item, DM_SHW_KEY_SPECS,
                                 strlen(DM_SHW_KEY_SPECS), &lite_specs);
    if ((complex_array->type == DM_SHW_DATA_TYPE_ARRAY ||
         complex_array->type == DM_SHW_DATA_TYPE_STRUCT) &&
        (res != SUCCESS_RETURN)) {
        return DM_JSON_PARSE_FAILED;
    }
    ...
    /* dm_log_debug("TSL Property Specs Type:
     * %s",g_dm_tsl_alink_mapping[complex_array->type].name); */

    /* Parse Array Type */
    res = g_dm_tsl_alink_mapping[complex_array->type].func_array_parse(
        data_value, &lite_specs);
    if (res != SUCCESS_RETURN) {
        return FAIL_RETURN;
    }
                                ...
                                _IN_ lite_cjson_t *root)
{
    ...
    complex_struct->value =
        DM_malloc((complex_struct->size) * (sizeof(dm_shw_data_t)));
    if (complex_struct->value == NULL) {
        return DM_MEMORY_NOT_ENOUGH;
    }
    memset(complex_struct->value, 0,
           (complex_struct->size) * (sizeof(dm_shw_data_t)));
    ...
    for (index = 0; index < complex_struct->size; index++) {
        ...
        /* dm_log_debug("TSL Property Struct Property:
         * %.*s",lite_item.value_length,lite_item.value); */
...
static int _dm_shw_data_parse(_IN_ dm_shw_data_value_t *data_value,
                              _IN_ lite_cjson_t *root)
{
    int res = 0;
    lite_cjson_t lite_item;
    ...
    /* Parse Type */
    memset(&lite_item, 0, sizeof(lite_cjson_t));
    res = lite_cjson_object_item(root, DM_SHW_KEY_TYPE, strlen(DM_SHW_KEY_TYPE),
                                 &lite_item);
    if (res != SUCCESS_RETURN || !lite_cjson_is_string(&lite_item)) {
        return DM_JSON_PARSE_FAILED;
    }
    dm_log_debug("TSL Data Type: %.*s", lite_item.value_length,
                 lite_item.value);
    res = _dm_shw_get_type(lite_item.value, lite_item.value_length,
                           &data_value->type);
    if (res != SUCCESS_RETURN) {
        return FAIL_RETURN;
    }
    ...
    /* Parse Specs */
    memset(&lite_item, 0, sizeof(lite_cjson_t));
    res = lite_cjson_object_item(root, DM_SHW_KEY_SPECS,
                                 strlen(DM_SHW_KEY_SPECS), &lite_item);
    if (res == SUCCESS_RETURN) {
        /* dm_log_debug("TSL Data Specs:
         * %.*s",lite_item.value_length,lite_item.value); */
    }
    ...
    res = g_dm_tsl_alink_mapping[data_value->type].func_parse(data_value,
                                                              &lite_item);
    if (res != SUCCESS_RETURN) {
        return FAIL_RETURN;
    }
                                  ...
                                  _IN_ lite_cjson_t *root)
{
    ...
    memset(&lite_item, 0, sizeof(lite_cjson_t));
    res = lite_cjson_object_item(root, DM_SHW_KEY_IDENTIFIER,
                                 strlen(DM_SHW_KEY_IDENTIFIER), &lite_item);
    if (res != SUCCESS_RETURN || !lite_cjson_is_string(&lite_item)) {
        return DM_JSON_PARSE_FAILED;
    }
    res = dm_utils_copy(lite_item.value, lite_item.value_length,
    ...
    /* Parse DataType */
    memset(&lite_item, 0, sizeof(lite_cjson_t));
    res = lite_cjson_object_item(root, DM_SHW_KEY_DATATYPE,
                                 strlen(DM_SHW_KEY_DATATYPE), &lite_item);
    if (res != SUCCESS_RETURN || !lite_cjson_is_object(&lite_item)) {
        return DM_JSON_PARSE_FAILED;
    }
    /* dm_log_debug("TSL Property Data Type:
     * %.*s",lite_item.value_length,lite_item.value); */
...
static int _dm_shw_properties_parse(_IN_ dm_shw_t *shadow,
                                    _IN_ lite_cjson_t *root)
{
    int res = 0, index = 0;
    ...
    res =
        lite_cjson_object_item(root, DM_SHW_KEY_PROPERTIES,
                               strlen(DM_SHW_KEY_PROPERTIES), &lite_properties);
    if (res == SUCCESS_RETURN) {
    ...
    shadow->properties =
        DM_malloc(sizeof(dm_shw_data_t) * (lite_properties.size));
    if (shadow->properties == NULL) {
        return DM_MEMORY_NOT_ENOUGH;
    }
    memset(shadow->properties, 0,
           sizeof(dm_shw_data_t) * (lite_properties.size));
...
static int _dm_shw_event_outputdata_parse(_IN_ dm_shw_t *shadow,
                                          _IN_ dm_shw_data_t *event_data,
                                          _IN_ lite_cjson_t *root)
{
    int res = 0;
    lite_cjson_t lite_item;
    ...
    /* dm_log_debug("TSL Output Event Data Type:
     * %.*s",lite_item.value_length,lite_item.value); */
...
static int _dm_shw_event_outputdatas_parse(_IN_ dm_shw_t *shadow,
                                           _IN_ dm_shw_event_t *event,
                                           _IN_ lite_cjson_t *root)
{
    int res = 0, index = 0;
    lite_cjson_t lite_item;
    ...
    event->output_datas =
        DM_malloc((event->output_data_number) * (sizeof(dm_shw_data_t)));
    if (event->output_datas == NULL) {
        return DM_MEMORY_NOT_ENOUGH;
    }
    memset(event->output_datas, 0,
           (event->output_data_number) * (sizeof(dm_shw_data_t)));
...
static int _dm_shw_event_parse(_IN_ dm_shw_t *shadow,
                               _IN_ dm_shw_event_t *event,
                               _IN_ lite_cjson_t *root)
{
    int res = 0;
    ...
    if (((strlen(event->identifier) ==
          strlen(DM_SHW_SPECIAL_EVENT_POST_IDENTIFIER)) &&
         (memcmp(event->identifier, DM_SHW_SPECIAL_EVENT_POST_IDENTIFIER,
                 strlen(DM_SHW_SPECIAL_EVENT_POST_IDENTIFIER)) == 0))) {
        /* dm_log_info("TSL Special Event Identifier: %s, Ignore
         * It",event->identifier); */
        return SUCCESS_RETURN;
    }
    ...
    memset(&lite_item, 0, sizeof(lite_cjson_t));
    res = lite_cjson_object_item(root, DM_SHW_KEY_OUTPUTDATA,
                                 strlen(DM_SHW_KEY_OUTPUTDATA), &lite_item);
...
static int _dm_shw_events_parse(_IN_ dm_shw_t *shadow, _IN_ lite_cjson_t *root)
{
    ...
    res = lite_cjson_object_item(root, DM_SHW_KEY_EVENTS,
                                 strlen(DM_SHW_KEY_EVENTS), &lite_events);
    if (res == SUCCESS_RETURN) {
...
static int _dm_shw_service_outputdata_parse(_IN_ dm_shw_t *shadow,
                                            _IN_ dm_shw_data_t *service_data,
                                            _IN_ lite_cjson_t *root)
{
    int res = 0;
    lite_cjson_t lite_item;
    ...
    /* dm_log_debug("TSL Output Service Data Type:
     * %.*s",lite_item.value_length,lite_item.value); */
...
static int _dm_shw_service_outputdatas_parse(_IN_ dm_shw_t *shadow,
                                             _IN_ dm_shw_service_t *service,
                                             _IN_ lite_cjson_t *root)
{
    int res = 0, index = 0;
    lite_cjson_t lite_item;
    ...
    /* Allocate Memory For Output Datas */
    service->output_datas =
        DM_malloc((service->output_data_number) * (sizeof(dm_shw_data_t)));
    if (service->output_datas == NULL) {
        return DM_MEMORY_NOT_ENOUGH;
    }
    memset(service->output_datas, 0,
           (service->output_data_number) * (sizeof(dm_shw_data_t)));
...
static int _dm_shw_service_inputdata_parse(_IN_ dm_shw_t *shadow,
                                           _IN_ dm_shw_data_t *input_data,
                                           _IN_ lite_cjson_t *root)
{
    int res = 0;
    lite_cjson_t lite_item;
    ...
    /* dm_log_debug("TSL Input Service Data Type:
     * %.*s",lite_item.value_length,lite_item.value); */
...
static int _dm_shw_service_inputdatas_parse(_IN_ dm_shw_t *shadow,
                                            _IN_ dm_shw_service_t *service,
                                            _IN_ lite_cjson_t *root)
{
    int res = 0, index = 0;
    ...
    /* Allocate Memory For Output Datas */
    service->input_datas =
        DM_malloc((service->input_data_number) * (sizeof(dm_shw_data_t)));
    if (service->input_datas == NULL) {
        return DM_MEMORY_NOT_ENOUGH;
    }
    memset(service->input_datas, 0,
           (service->input_data_number) * (sizeof(dm_shw_data_t)));
...
static int _dm_shw_service_parse(_IN_ dm_shw_t *shadow,
                                 _IN_ dm_shw_service_t *service,
                                 _IN_ lite_cjson_t *root)
{
    int res = 0;
    ...
    memset(&lite_item, 0, sizeof(lite_cjson_t));
    res = lite_cjson_object_item(root, DM_SHW_KEY_INPUTDATA,
                                 strlen(DM_SHW_KEY_INPUTDATA), &lite_item);
    if (res == SUCCESS_RETURN && lite_cjson_is_array(&lite_item)) {
...
static int _dm_shw_services_parse(_IN_ dm_shw_t *shadow,
                                  _IN_ lite_cjson_t *root)
{
    int res = 0, index = 0;
    ...
    res = lite_cjson_object_item(root, DM_SHW_KEY_SERVICES,
                                 strlen(DM_SHW_KEY_SERVICES), &lite_services);
    if (res == SUCCESS_RETURN) {
    ...
    shadow->services =
        DM_malloc(sizeof(dm_shw_service_t) * (lite_services.size));
    if (shadow->services == NULL) {
        return DM_MEMORY_NOT_ENOUGH;
    }
    memset(shadow->services, 0,
           sizeof(dm_shw_service_t) * (lite_services.size));
...
int dm_tsl_alink_create(_IN_ const char *tsl, _IN_ int tsl_len,
                        _OU_ dm_shw_t **shadow)
{
    int res = 0;
