...
typedef void (*iotx_cm_data_handle_cb)(int fd, const char *topic,
                                       uint32_t topic_len, const char *payload,
...
typedef void (*iotx_cm_event_handle_cb)(int fd, iotx_cm_event_msg_t *event,
                                        void *context);
...
int iotx_cm_pub(int fd, iotx_cm_ext_params_t *ext, const char *topic,
