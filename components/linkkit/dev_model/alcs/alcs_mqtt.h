...
#define ALCS_MQTT_THING_LAN_PREFIX_UPDATE_REPLY_FMT \
    "/thing/lan/prefix/update_reply"
#define ALCS_MQTT_THING_LAN_PREFIX_BLACKLIST_UPDATE_FMT \
    "/thing/lan/blacklist/update"
#define ALCS_MQTT_THING_LAN_PREFIX_BLACKLIST_UPDATE_REPLY_FMT \
    "/thing/lan/blacklist/update_reply"

#define ALCS_MQTT_THING_ALCS_REQUEST                                           \
    "{\"id\":\"%d\",\"version\":\"1.0\",\"params\":\"{}\",\"method\":\"thing." \
    "lan.prefix.get\"}"
#define ALCS_MQTT_THING_LAN_PREFIX_RESPONSE_FMT \
    "{\"id\": \"%d\", \"code\": %d, \"data\": %s}"
#define ALCS_MQTT_THING_ALCS_SUBDEV_REQUEST                                   \
    "{\"id\":\"%d\",\"version\":\"1.0\",\"params\":{\"productKey\":\"%.*s\"," \
    "\"deviceName\":\"%.*s\"},\"method\":\"thing.lan.prefix.get\"}"
