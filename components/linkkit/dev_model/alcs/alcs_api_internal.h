...
#ifdef ALCS_SERVER_ENABLED
#define get_svr_session_list(v) \
    (_device.role & ROLE_SERVER ? &_device.lst_svr_sessions : NULL)
#endif
#ifdef ALCS_CLIENT_ENABLED
#define get_ctl_session_list(v) \
    (_device.role & ROLE_CLIENT ? &_device.lst_ctl_sessions : NULL)
#endif
