...
typedef int (*dm_shw_data_set)(_IN_ dm_shw_data_value_t *data_value,
                               _IN_ void *value, _IN_ int value_len);
typedef int (*dm_shw_array_set)(_IN_ dm_shw_data_value_t *data_value,
                                _IN_ void *value, _IN_ int value_len,
                                _IN_ int index);
typedef int (*dm_shw_data_get)(_IN_ dm_shw_data_value_t *data_value,
                               _IN_ void *value);
typedef int (*dm_shw_array_get)(_IN_ dm_shw_data_value_t *data_value,
                                _IN_ void *value, _IN_ int index);
...
/* Data Set */
static int _dm_shw_int_set(_IN_ dm_shw_data_value_t *data_value,
                           _IN_ void *value, _IN_ int value_len);
static int _dm_shw_float_set(_IN_ dm_shw_data_value_t *data_value,
                             _IN_ void *value, _IN_ int value_len);
static int _dm_shw_double_set(_IN_ dm_shw_data_value_t *data_value,
                              _IN_ void *value, _IN_ int value_len);
static int _dm_shw_text_set(_IN_ dm_shw_data_value_t *data_value,
                            _IN_ void *value, _IN_ int value_len);
static int _dm_shw_enum_set(_IN_ dm_shw_data_value_t *data_value,
                            _IN_ void *value, _IN_ int value_len);
static int _dm_shw_date_set(_IN_ dm_shw_data_value_t *data_value,
                            _IN_ void *value, _IN_ int value_len);
static int _dm_shw_bool_set(_IN_ dm_shw_data_value_t *data_value,
                            _IN_ void *value, _IN_ int value_len);

/* Array Data Set */
static int _dm_shw_array_int_set(_IN_ dm_shw_data_value_t *data_value,
                                 _IN_ void *value, _IN_ int value_len,
                                 _IN_ int index);
static int _dm_shw_array_float_set(_IN_ dm_shw_data_value_t *data_value,
                                   _IN_ void *value, _IN_ int value_len,
                                   _IN_ int index);
static int _dm_shw_array_double_set(_IN_ dm_shw_data_value_t *data_value,
                                    _IN_ void *value, _IN_ int value_len,
                                    _IN_ int index);
static int _dm_shw_array_text_set(_IN_ dm_shw_data_value_t *data_value,
                                  _IN_ void *value, _IN_ int value_len,
                                  _IN_ int index);
static int _dm_shw_array_enum_set(_IN_ dm_shw_data_value_t *data_value,
                                  _IN_ void *value, _IN_ int value_len,
                                  _IN_ int index);
static int _dm_shw_array_date_set(_IN_ dm_shw_data_value_t *data_value,
                                  _IN_ void *value, _IN_ int value_len,
                                  _IN_ int index);
static int _dm_shw_array_bool_set(_IN_ dm_shw_data_value_t *data_value,
                                  _IN_ void *value, _IN_ int value_len,
                                  _IN_ int index);

/* Data Get */
static int _dm_shw_int_get(_IN_ dm_shw_data_value_t *data_value,
                           _IN_ void *value);
static int _dm_shw_float_get(_IN_ dm_shw_data_value_t *data_value,
                             _IN_ void *value);
static int _dm_shw_double_get(_IN_ dm_shw_data_value_t *data_value,
                              _IN_ void *value);
static int _dm_shw_text_get(_IN_ dm_shw_data_value_t *data_value,
                            _IN_ void *value);
static int _dm_shw_enum_get(_IN_ dm_shw_data_value_t *data_value,
                            _IN_ void *value);
static int _dm_shw_date_get(_IN_ dm_shw_data_value_t *data_value,
                            _IN_ void *value);
static int _dm_shw_bool_get(_IN_ dm_shw_data_value_t *data_value,
                            _IN_ void *value);

/* Array Data Get */
static int _dm_shw_array_int_get(_IN_ dm_shw_data_value_t *data_value,
                                 _IN_ void *value, _IN_ int index);
static int _dm_shw_array_float_get(_IN_ dm_shw_data_value_t *data_value,
                                   _IN_ void *value, _IN_ int index);
static int _dm_shw_array_double_get(_IN_ dm_shw_data_value_t *data_value,
                                    _IN_ void *value, _IN_ int index);
static int _dm_shw_array_text_get(_IN_ dm_shw_data_value_t *data_value,
                                  _IN_ void *value, _IN_ int index);
static int _dm_shw_array_enum_get(_IN_ dm_shw_data_value_t *data_value,
                                  _IN_ void *value, _IN_ int index);
static int _dm_shw_array_date_get(_IN_ dm_shw_data_value_t *data_value,
                                  _IN_ void *value, _IN_ int index);
static int _dm_shw_array_bool_get(_IN_ dm_shw_data_value_t *data_value,
                                  _IN_ void *value, _IN_ int index);
...
static int _dm_shw_data_struct_search(_IN_ dm_shw_data_t *input, _IN_ char *key,
                                      _IN_ int key_len,
                                      _OU_ dm_shw_data_t **output,
                                      _OU_ int *index);

static dm_shw_data_type_mapping_t g_iotx_data_type_mapping[] = {
    { DM_SHW_DATA_TYPE_NONE, "none", NULL, NULL, NULL, NULL, NULL, NULL },
    { DM_SHW_DATA_TYPE_INT, "int", _dm_shw_int_set, _dm_shw_array_int_set,
      _dm_shw_int_get, _dm_shw_array_int_get, _dm_shw_int_free,
      _dm_shw_array_int_free },
    {
        DM_SHW_DATA_TYPE_FLOAT,
        "float",
        _dm_shw_float_set,
        _dm_shw_array_float_set,
        _dm_shw_float_get,
        _dm_shw_array_float_get,
        _dm_shw_float_free,
        _dm_shw_array_float_free,
    },
    {
        DM_SHW_DATA_TYPE_DOUBLE,
        "double",
        _dm_shw_double_set,
        _dm_shw_array_double_set,
        _dm_shw_double_get,
        _dm_shw_array_double_get,
        _dm_shw_double_free,
        _dm_shw_array_double_free,
    },
    {
        DM_SHW_DATA_TYPE_TEXT,
        "text",
        _dm_shw_text_set,
        _dm_shw_array_text_set,
        _dm_shw_text_get,
        _dm_shw_array_text_get,
        _dm_shw_text_free,
        _dm_shw_array_text_free,
    },
    {
        DM_SHW_DATA_TYPE_ENUM,
        "enum",
        _dm_shw_enum_set,
        _dm_shw_array_enum_set,
        _dm_shw_enum_get,
        _dm_shw_array_enum_get,
        _dm_shw_enum_free,
        _dm_shw_array_enum_free,
    },
    {
        DM_SHW_DATA_TYPE_DATE,
        "date",
        _dm_shw_date_set,
        _dm_shw_array_date_set,
        _dm_shw_date_get,
        _dm_shw_array_date_get,
        _dm_shw_date_free,
        _dm_shw_array_date_free,
    },
    {
        DM_SHW_DATA_TYPE_BOOL,
        "bool",
        _dm_shw_bool_set,
        _dm_shw_array_bool_set,
        _dm_shw_bool_get,
        _dm_shw_array_bool_get,
        _dm_shw_bool_free,
        _dm_shw_array_bool_free,
    },
    {
        ...
        NULL,
        _dm_shw_array_free,
        _dm_shw_array_array_free,
    },
    {
        DM_SHW_DATA_TYPE_STRUCT,
        "struct",
        NULL,
        NULL,
        NULL,
...
static int _dm_shw_data_array_search(_IN_ dm_shw_data_t *input,
                                     _IN_ int input_index, _IN_ char *key,
                                     _IN_ int key_len,
                                     _OU_ dm_shw_data_t **output,
                                     _OU_ int *output_index)
{
    int res = 0, deli_offset = 0;

    dm_shw_data_value_complex_t *complex_struct =
        (dm_shw_data_value_complex_t *)input->data_value.value;
    ...
    case DM_SHW_DATA_TYPE_STRUCT:
        {
            ...
            return _dm_shw_data_struct_search(search_data, key, deli_offset,
                                              output, output_index);
        }
        break;
    default:
                                      ...
                                      _OU_ int *index)
{
    ...
    res = dm_utils_strarr_index(key, deli_offset, &partial_input_len,
                                &array_input_len, &array_index);
    if (res == SUCCESS_RETURN) {
    ...
    for (item_index = 0; item_index < complex_struct->size; item_index++) {
        ...
        case DM_SHW_DATA_TYPE_ARRAY:
            {
                int key_offset = (deli_offset == key_len) ? (deli_offset - 1)
                                                          : (deli_offset + 1);
                int key_len_offset =
                    (deli_offset == key_len) ? (key_len) : (deli_offset + 1);
                if ((partial_input_len == 0) && (deli_offset == key_len)) {
                    if (output) {
                        *output = data_item;
                    }
                ...
                return _dm_shw_data_array_search(
                    data_item, array_index, key + key_offset,
                    key_len - key_len_offset, output, index);
            }
        case DM_SHW_DATA_TYPE_STRUCT:
            {
                if (deli_offset == key_len) {
                ...
                return _dm_shw_data_struct_search(
                    data_item, key + deli_offset + 1, key_len - deli_offset - 1,
                    output, index);
            }
        default:
...
static int _dm_shw_data_search(_IN_ dm_shw_data_t *input, _IN_ char *key,
                               _IN_ int key_len, _OU_ dm_shw_data_t **output,
                               _OU_ int *index)
{
    ...
    case DM_SHW_DATA_TYPE_ARRAY:
        {
            ...
            return _dm_shw_data_array_search(
                input, array_index, key + key_offset, key_len - key_len_offset,
                output, index);
        }
        break;
    case DM_SHW_DATA_TYPE_STRUCT:
        {
            ...
            return _dm_shw_data_struct_search(input, key + deli_offset + 1,
                                              key_len - deli_offset - 1, output,
                                              index);
        }
        break;
    default:
...
static int _dm_shw_property_search(_IN_ dm_shw_t *shadow, _IN_ char *key,
                                   _IN_ int key_len,
                                   _OU_ dm_shw_data_t **property,
                                   _OU_ int *index)
{
...
static int _dm_shw_event_output_search(_IN_ dm_shw_data_t *outputdatas,
                                       _IN_ int number, _IN_ char *key,
                                       _IN_ int key_len,
                                       _OU_ dm_shw_data_t **event_data,
                                       _OU_ int *index)
{
    int res = 0, item_index = 0;
...
static int _dm_shw_event_search(_IN_ dm_shw_t *shadow, _IN_ char *key,
                                _IN_ int key_len, _OU_ dm_shw_event_t **event)
{
    int index = 0;
...
static int _dm_shw_service_input_output_search(
    _IN_ dm_shw_data_target_e type, _IN_ dm_shw_service_t *service,
    _IN_ char *key, _IN_ int key_len, _OU_ dm_shw_data_t **service_data,
    _OU_ int *index)
{
...
static int _dm_shw_service_search(_IN_ dm_shw_t *shadow, _IN_ char *key,
                                  _IN_ int key_len,
...
int dm_shw_create(_IN_ iotx_dm_tsl_type_t type, _IN_ const char *tsl,
                  _IN_ int tsl_len, _OU_ dm_shw_t **shadow)
{
    int res = 0;
...
int dm_shw_get_property_data(_IN_ dm_shw_t *shadow, _IN_ char *key,
                             _IN_ int key_len, _OU_ void **data)
{
    int res = 0;

    if (shadow == NULL || key == NULL || key_len <= 0 || data == NULL ||
        *data != NULL) {
        return DM_INVALID_PARAMETER;
    }

    res = _dm_shw_property_search(shadow, key, key_len, (dm_shw_data_t **)data,
                                  NULL);
    if (res != SUCCESS_RETURN) {
        return DM_TSL_PROPERTY_NOT_EXIST;
    }
...
int dm_shw_get_service_input_output_data(_IN_ dm_shw_data_target_e type,
                                         _IN_ dm_shw_t *shadow, _IN_ char *key,
                                         _IN_ int key_len, _OU_ void **data)
{
    int res = 0;
    ...
    if (type < DM_SHW_DATA_TARGET_SERVICE_INPUT_DATA ||
        type > DM_SHW_DATA_TARGET_SERVICE_OUTPUT_DATA || shadow == NULL ||
        key == NULL || key_len <= 0) {
        return DM_INVALID_PARAMETER;
    }
    ...
    pos = key + offset + 1;
    dm_log_debug("TSL Service input/output Data Search, Event Data ID: %s",
                 pos);

    res = _dm_shw_service_input_output_search(type, service, pos, strlen(pos),
                                              &service_data, &array_index);
    if (res != SUCCESS_RETURN) {
        return DM_TSL_EVENT_NOT_EXIST;
    }
...
int dm_shw_get_event_output_data(_IN_ dm_shw_t *shadow, _IN_ char *key,
                                 _IN_ int key_len, _OU_ void **data)
{
    int res = 0;
    int offset = 0, array_index = 0;
    ...
    res = _dm_shw_event_output_search(event->output_datas,
                                      event->output_data_number, pos,
                                      strlen(pos), &event_data, &array_index);
    if (res != SUCCESS_RETURN) {
        return DM_TSL_EVENT_NOT_EXIST;
    }
...
int dm_shw_get_data_type(_IN_ void *data, _OU_ dm_shw_data_type_e *type)
{
    ...
    if (data_item->data_value.type == DM_SHW_DATA_TYPE_ARRAY) {
        dm_shw_data_value_complex_t *complex_value =
            (dm_shw_data_value_complex_t *)data_item->data_value.value;
...
int dm_shw_get_event(_IN_ dm_shw_t *shadow, _IN_ char *key, _IN_ int key_len,
                     _OU_ void **event)
{
    int index = 0;
    dm_shw_event_t *dtsl_event = NULL;
...
int dm_shw_get_service(_IN_ dm_shw_t *shadow, _IN_ char *key, _IN_ int key_len,
                       _OU_ void **service)
{
    int index = 0;
    dm_shw_service_t *dtsl_service = NULL;
...
int dm_shw_get_property_by_index(_IN_ dm_shw_t *shadow, _IN_ int index,
                                 _OU_ void **property)
{
...
int dm_shw_get_service_by_index(_IN_ dm_shw_t *shadow, _IN_ int index,
                                _OU_ void **service)
{
...
int dm_shw_get_event_by_index(_IN_ dm_shw_t *shadow, _IN_ int index,
                              _OU_ void **event)
{
...
int dm_shw_get_service_by_identifier(_IN_ dm_shw_t *shadow,
                                     _IN_ char *identifier, _OU_ void **service)
{
    int index = 0;
    dm_shw_service_t *search_service = NULL;

    if (shadow == NULL || identifier == NULL || service == NULL ||
        *service != NULL) {
        return DM_INVALID_PARAMETER;
    }
    ...
    for (index = 0; index < shadow->service_number; index++) {
        ...
        if ((strlen(search_service->identifier) == strlen(identifier)) &&
            (memcmp(search_service->identifier, identifier,
                    strlen(identifier)) == 0)) {
...
int dm_shw_get_event_by_identifier(_IN_ dm_shw_t *shadow, _IN_ char *identifier,
                                   _OU_ void **event)
{
    int index = 0;
    dm_shw_event_t *search_event = NULL;

    if (shadow == NULL || identifier == NULL || event == NULL ||
        *event != NULL) {
        return DM_INVALID_PARAMETER;
    }
    ...
    for (index = 0; index < shadow->event_number; index++) {
        ...
        if ((strlen(search_event->identifier) == strlen(identifier)) &&
            (memcmp(search_event->identifier, identifier, strlen(identifier)) ==
             0)) {
...
int dm_shw_get_service_method(_IN_ void *service, _OU_ char **method)
{
    ...
    service_method_len =
        (strlen(service_method_fmt) + strlen(service_item->identifier) + 1);
    *method = DM_malloc(service_method_len);
    if (*method == NULL) {
        return DM_MEMORY_NOT_ENOUGH;
    }
    memset(*method, 0, service_method_len);
    HAL_Snprintf(*method, service_method_len, service_method_fmt,
...
int dm_shw_get_event_method(_IN_ void *event, _OU_ char **method)
{
    ...
    if ((strlen(event_item->identifier) == strlen(post_identifier)) &&
        (memcmp(event_item->identifier, post_identifier,
                strlen(post_identifier)) == 0)) {
                             ...
                             _IN_ void *value, _IN_ int value_len)
{
    ...
    dm_log_debug("Current Float Value Be Set(Float): %f",
                              ...
                              _IN_ void *value, _IN_ int value_len)
{
    ...
    dm_log_debug("Current Double Value Be Set(Double): %f",
                            ...
                            _IN_ void *value, _IN_ int value_len)
{
    ...
    res = dm_utils_copy(value_set, value_set_len, &data_value->value,
                        value_set_len + 1);
    if (res != SUCCESS_RETURN) {
        return DM_MEMORY_NOT_ENOUGH;
    }
                                 ...
                                 _IN_ int index)
{
    ...
    *((int *)(complex_array->value) + index) = int_set;
    dm_log_debug("Current Array Value Be Set(Int), Index: %d, Value: %d", index,
                 *((int *)(complex_array->value) + index));
                                   ...
                                   _IN_ int index)
{
    ...
    *((float *)(complex_array->value) + index) = float_set;
    dm_log_debug("Current Array Value Be Set(Float), Index: %d, Value: %f",
                 index, *((float *)(complex_array->value) + index));
                                    ...
                                    _IN_ int index)
{
    ...
    *((double *)(complex_array->value) + index) = double_set;
    dm_log_debug("Current Array Value Be Set(Double), Index: %d, Value: %f",
                 index, *((double *)(complex_array->value) + index));
                                  ...
                                  _IN_ int index)
{
    ...
    res = dm_utils_copy(text_set, value_set_len,
                        (void **)((char **)(complex_array->value) + index),
                        value_set_len + 1);
    if (res != SUCCESS_RETURN) {
        return FAIL_RETURN;
    }
    dm_log_debug(
        "Current Array Value Be Set(Text String), Index: %d, Value: %s", index,
                                  ...
                                  _IN_ int index)
{
    ...
    *((int *)(complex_array->value) + index) = int_set;
    dm_log_debug("Current Array Value Be Set(Enum), Index: %d, Value: %d",
                                  ...
                                  _IN_ int index)
{
    ...
    dm_log_debug(
        "Current Array Value Be Set(Date String), Index: %d, Value: %s", index,
        *((char **)(complex_array->value) + index));
                                  ...
                                  _IN_ int index)
{
    ...
    *((int *)(complex_array->value) + index) = int_set;
    dm_log_debug("Current Array Value Be Set(Bool), Index: %d, Value: %d",
                 index, *((int *)(complex_array->value) + index));

    return SUCCESS_RETURN;
}

static int _dm_shw_data_array_set(_IN_ dm_shw_data_value_t *data_value,
                                  _IN_ void *value, _IN_ int value_len,
                                  _IN_ int index)
{
    dm_shw_data_value_complex_t *complex_array = data_value->value;
    ...
    return g_iotx_data_type_mapping[complex_array->type].func_array_set(
        data_value, value, value_len, index);
}

static int _dm_shw_data_set(_IN_ dm_shw_data_value_t *data_value,
                            _IN_ void *value, _IN_ int value_len)
{
    ...
    return g_iotx_data_type_mapping[data_value->type].func_set(
        data_value, value, value_len);
}

int dm_shw_set_property_value(_IN_ dm_shw_t *shadow, _IN_ char *key,
                              ...
                              _IN_ int value_len)
{
    ...
    if (data->data_value.type == DM_SHW_DATA_TYPE_ARRAY) {
        ...
        res = _dm_shw_data_array_set(&data->data_value, value, value_len,
                                     array_index);
        if (res != SUCCESS_RETURN) {
                            ...
                            _IN_ void *value)
{
    ...
    res = dm_utils_copy_direct(data_value->value, strlen(data_value->value),
                               (void **)value, strlen(data_value->value) + 1);
    if (res != SUCCESS_RETURN) {
        return FAIL_RETURN;
    }
                                 ...
                                 _IN_ void *value, _IN_ int index)
{
    ...
    if (complex_array->value == NULL ||
        ((int *)(complex_array->value) + index) == NULL) {
        return DM_INVALID_PARAMETER;
    }
                                   ...
                                   _IN_ void *value, _IN_ int index)
{
    ...
    if (complex_array->value == NULL ||
        ((float *)(complex_array->value) + index) == NULL) {
        return DM_INVALID_PARAMETER;
    }
                                    ...
                                    _IN_ void *value, _IN_ int index)
{
    ...
    if (complex_array->value == NULL ||
        ((double *)(complex_array->value) + index) == NULL) {
        return DM_INVALID_PARAMETER;
    }
                                  ...
                                  _IN_ void *value, _IN_ int index)
{
    ...
    res = dm_utils_copy_direct(
        *((char **)(complex_array->value) + index),
        strlen(*((char **)(complex_array->value) + index)), (void **)value,
        strlen(*((char **)(complex_array->value) + index)) + 1);
    if (res != SUCCESS_RETURN) {
        return FAIL_RETURN;
    }
...
static int _dm_shw_data_array_get(_IN_ dm_shw_data_value_t *data_value,
                                  _IN_ void *value, _IN_ int index)
{
    dm_shw_data_value_complex_t *complex_array = data_value->value;
    ...
    return g_iotx_data_type_mapping[complex_array->type].func_array_get(
        data_value, value, index);
}

static int _dm_shw_data_get(_IN_ dm_shw_data_value_t *data_value,
                            _IN_ void *value)
{
    ...
    return g_iotx_data_type_mapping[data_value->type].func_get(data_value,
                                                               value);
}

int dm_shw_get_property_value(_IN_ dm_shw_t *shadow, _IN_ char *key,
                              _IN_ int key_len, _OU_ void *value)
{
    int res = 0, array_index = 0;
    dm_shw_data_t *data = NULL;
...
int dm_shw_set_event_output_value(_IN_ dm_shw_t *shadow, _IN_ char *key,
                                  _IN_ int key_len, _IN_ void *value,
                                  _IN_ int value_len)
{
    int res = 0, array_index = 0;
    ...
    if (event_data->data_value.type == DM_SHW_DATA_TYPE_ARRAY) {
        res = _dm_shw_data_array_set(&event_data->data_value, value, value_len,
                                     array_index);
        if (res != SUCCESS_RETURN) {
...
int dm_shw_get_event_output_value(_IN_ dm_shw_t *shadow, _IN_ char *key,
                                  _IN_ int key_len, _IN_ void *value)
{
    int res = 0;
    int offset = 0, array_index = 0;
    ...
    if (event_data->data_value.type == DM_SHW_DATA_TYPE_ARRAY) {
        res =
            _dm_shw_data_array_get(&event_data->data_value, value, array_index);
        if (res != SUCCESS_RETURN) {
...
int dm_shw_set_service_input_output_value(_IN_ dm_shw_data_target_e type,
                                          _IN_ dm_shw_t *shadow, _IN_ char *key,
                                          _IN_ int key_len, _IN_ void *value,
                                          _IN_ int value_len)
{
    ...
    if (service_data->data_value.type == DM_SHW_DATA_TYPE_ARRAY) {
        res = _dm_shw_data_array_set(&service_data->data_value, value,
                                     value_len, array_index);
        if (res != SUCCESS_RETURN) {
...
int dm_shw_get_service_input_output_value(_IN_ dm_shw_data_target_e type,
                                          _IN_ dm_shw_t *shadow, _IN_ char *key,
                                          _IN_ int key_len, _IN_ void *value)
{
    int res = 0;
    ...
    if (service_data->data_value.type == DM_SHW_DATA_TYPE_ARRAY) {
        res = _dm_shw_data_array_get(&service_data->data_value, value,
                                     array_index);
        if (res != SUCCESS_RETURN) {
...
static int _dm_shw_int_insert_json_item(_IN_ dm_shw_data_t *data,
                                        _IN_ lite_cjson_item_t *lite)
{
    lite_cjson_add_number_to_object(lite, data->identifier,
                                    data->data_value.value_int);

    return SUCCESS_RETURN;
}

static int _dm_shw_float_insert_json_item(_IN_ dm_shw_data_t *data,
                                          _IN_ lite_cjson_item_t *lite)
{
    lite_cjson_add_number_to_object(lite, data->identifier,
                                    data->data_value.value_float);

    return SUCCESS_RETURN;
}

static int _dm_shw_double_insert_json_item(_IN_ dm_shw_data_t *data,
                                           _IN_ lite_cjson_item_t *lite)
{
    lite_cjson_add_number_to_object(lite, data->identifier,
                                    data->data_value.value_double);

    return SUCCESS_RETURN;
}

static int _dm_shw_string_insert_json_item(_IN_ dm_shw_data_t *data,
                                           _IN_ lite_cjson_item_t *lite)
{
    char *value =
        (data->data_value.value == NULL) ? ("") : (data->data_value.value);
    lite_cjson_add_string_to_object(lite, data->identifier, value);

    return SUCCESS_RETURN;
}

static int _dm_shw_array_insert_json_item(_IN_ dm_shw_data_t *data,
                                          _IN_ lite_cjson_item_t *lite);
static int _dm_shw_struct_insert_json_item(_IN_ dm_shw_data_t *data,
                                           _IN_ lite_cjson_item_t *lite);
static int _dm_shw_data_insert_json_item(_IN_ dm_shw_data_t *data,
                                         _IN_ lite_cjson_item_t *lite);
    ...
    case DM_SHW_DATA_TYPE_ENUM:
        {
            ...
            for (index = 0; index < complex_array->size; index++) {
                ...
                lite_cjson_add_item_to_array(
                    array_item, lite_cjson_create_number((double)value));
            }
            if (lite->type == cJSON_Array) {
                lite_cjson_add_item_to_object(array, data->identifier,
                                              array_item);
                lite_cjson_add_item_to_array(lite, array);
            } else {
                lite_cjson_add_item_to_object(lite, data->identifier,
                                              array_item);
                lite_cjson_delete(array);
            }
        }
    ...
    case DM_SHW_DATA_TYPE_DOUBLE:
        {
            ...
            for (index = 0; index < complex_array->size; index++) {
                ...
                lite_cjson_add_item_to_array(array_item,
                                             lite_cjson_create_number(value));
            }
            if (lite->type == cJSON_Array) {
                lite_cjson_add_item_to_object(array, data->identifier,
                                              array_item);
    ...
    case DM_SHW_DATA_TYPE_DATE:
        {
            ...
            for (index = 0; index < complex_array->size; index++) {
                ...
                lite_cjson_add_item_to_array(
                    array_item, lite_cjson_create_string((const char *)value));
            }
            if (lite->type == cJSON_Array) {
                lite_cjson_add_item_to_object(array, data->identifier,
                                              array_item);
                                           ...
                                           _IN_ lite_cjson_item_t *lite)
{
    ...
    if (lite->type == cJSON_Array) {
        if (data->identifier) {
            lite_cjson_add_item_to_object(lite_object, data->identifier,
                                          lite_item);
                             ...
                             _IN_ lite_cjson_item_t *lite)
{
    ...
    if (shadow == NULL || identifier == NULL || identifier_len <= 0 ||
        lite == NULL || lite->type != cJSON_Object) {
        return DM_INVALID_PARAMETER;
    }
...
int dm_shw_assemble_event_output(_IN_ dm_shw_t *shadow, _IN_ char *identifier,
                                 _IN_ int identifier_len,
                                 _IN_ lite_cjson_item_t *lite)
{
    int res = 0, index = 0;
...
int dm_shw_assemble_service_output(_IN_ dm_shw_t *shadow, _IN_ char *identifier,
                                   _IN_ int identifier_len,
                                   _IN_ lite_cjson_item_t *lite)
{
    int res = 0, index = 0;
...
{
    /* Free Value */
    /* if (data_value->value) {DM_free(data_value->value);data_value->value =
     * NULL;} */
}
...
static void _dm_shw_array_struct_free(_IN_ dm_shw_data_value_t *data_value)
{
    ...
    dm_shw_data_value_complex_t *complex_struct =
        (dm_shw_data_value_complex_t *)data_value->value;
...
static void _dm_shw_array_free(_IN_ dm_shw_data_value_t *data_value)
{
    ...
    if (complex_array) {
        ...
        if (g_iotx_data_type_mapping[complex_array->type].func_array_free !=
            NULL) {
            g_iotx_data_type_mapping[complex_array->type].func_array_free(
                data_value);
        }
...
static void _dm_shw_properties_free(_IN_ dm_shw_data_t *properties,
                                    _IN_ int number)
{
    int index = 0;
    dm_shw_data_t *property = NULL;
...
static void _dm_shw_event_outputdatas_free(_IN_ dm_shw_data_t *outputdatas,
                                           _IN_ int number)
{
    int index = 0;
    dm_shw_data_t *outputdata = NULL;
...
static void _dm_shw_event_free(_IN_ dm_shw_event_t *event)
{
    ...
    if (event->output_datas) {
        _dm_shw_event_outputdatas_free(event->output_datas,
...
static void _dm_shw_service_outputdatas_free(_IN_ dm_shw_data_t *outputdatas,
                                             _IN_ int number)
{
    int index = 0;
    dm_shw_data_t *outputdata = NULL;
...
static void _dm_shw_service_inputdatas_free(_IN_ dm_shw_data_t *inputdatas,
                                            _IN_ int number)
{
    int index = 0;
...
static void _dm_shw_service_free(_IN_ dm_shw_service_t *service)
{
    ...
    if (service->output_datas) {
        _dm_shw_service_outputdatas_free(service->output_datas,
                                         service->output_data_number);
        DM_free(service->output_datas);
        service->output_datas = NULL;
    }
    if (service->input_datas) {
        _dm_shw_service_inputdatas_free(service->input_datas,
...
static void _dm_shw_services_free(_IN_ dm_shw_service_t *services,
                                  _IN_ int number)
{
    int index = 0;
    dm_shw_service_t *service = NULL;
...
void dm_shw_destroy(_IN_ dm_shw_t **shadow)
{
    ...
    if ((*shadow)->properties) {
        _dm_shw_properties_free((*shadow)->properties,
                                (*shadow)->property_number);
