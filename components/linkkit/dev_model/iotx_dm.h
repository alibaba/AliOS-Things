...
#define IOTX_DM_DEVICE_ALL \
    (IOTX_DM_DEVICE_SINGLE | IOTX_DM_DEVICE_SUBDEV | IOTX_DM_DEVICE_GATEWAY)
...
#define IOTX_DM_LOCAL_NO_AUTH \
    (IOTX_DM_SERVICE_LOCAL | IOTX_DM_SERVICE_LOCAL_NO_AUTH)
...
typedef void (*iotx_dm_event_callback)(iotx_dm_event_types_t type,
                                       char *payload);
...
int iotx_dm_get_device_status(_IN_ int devid,
                              _OU_ iotx_dm_dev_status_t *status);
