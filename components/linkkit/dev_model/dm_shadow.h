 ...
 * @param key. The property compound string, format decided by data type of
 * property as follows: int,float,double,text,enum,date,bool type: property_id
 *        array type: property_id(array)[index]
 *        struct type: property_id(struct).property_id or
 * property_id(struct).property_id[index]
 *
 ...
 * @param key. The property compound string, format decided by data type of
 * property as follows: int,float,double,text,enum,date,bool type: event_id
 *
 * @param key_len. The length of key.
 ...
 * @param shadow. The pointer of TSL Struct.
 * @param key. The property compound string, format decided by data type of
 * property as follows: int,float,double,text,enum,date,bool type: service_id
 *
 * @param key_len. The length of key.
 ...
 *        This function used to get service reference from TSL struct by
 * identifier.
 *
 * @param shadow. The pointer of TSL Struct.
 ...
 *        This function used to get event reference from TSL struct by
 * identifier.
 *
 * @param shadow. The pointer of TSL Struct.
 * @param identifier. The identifier of event
 ...
 *        This function used to get property identifier from TSL struct by
 * service handle.
 *
 ...
 *        This function used to get service method from TSL struct by service
 * handle.
 *
 ...
 *        This function used to get event method from TSL struct by event
 * handle.
 *
 * @param service. The handle of event.
 ...
 * int*, date: char*, bool: int* attention! value can be NULL to clear property
 * value
 ...
 * enum: int*, date: char**, bool: int* attention! value can not be NULL
 *
 ...
 * @param tsl. The pointer of TSL Struct.
 * @param key. The property compound string, format decided by data type of
 * property as follows: int,float,double,text,enum,date,bool type:
 * event_id.event_data_id array type: event_id.event_data_id(array)[index]
