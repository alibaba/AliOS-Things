 ...
 ** @retval  0 : sucess
 ** @note
 **      device will save reset flag if device dosen't connect cloud, device
 *will fails to send reset to cloud.
 **      when connection between device and cloud is ready, device will retry to
 *report reset to cloud.
 **/
