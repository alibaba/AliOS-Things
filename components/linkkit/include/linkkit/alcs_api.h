...
typedef void (*AuthHandler)(CoAPContext *context, NetworkAddr *addr,
                            void *user_data, ResponseMsg *result);
typedef struct {
    char *productKey;
    char *deviceName;
    char *accessKey;
 ...
 *        3 --client&server
 */
int alcs_auth_init(CoAPContext *context, const char *productKey,
 ...
 *
 */
int alcs_add_client_key(CoAPContext *context, const char *accesskey,
                        const char *accesstoken, const char *productKey,
                        const char *deviceName);
int alcs_remove_client_key(CoAPContext *context, const char *key,
                           char isfullkey);
/*
 *
 *
...
int alcs_add_svr_key(CoAPContext *context, const char *keyprefix,
