...
#define INFRA_ERR_AES_INVALID_INPUT_LENGTH \
 ...
 * \return         0 if successful
 */
int infra_aes_crypt_cfb8(infra_aes_context *ctx, int mode, size_t length,
                         unsigned char iv[16], const unsigned char *input,
                         unsigned char *output);
 ...
 * \return         0 if successful
 */
int infra_aes_crypt_ctr(infra_aes_context *ctx, size_t length, size_t *nc_off,
