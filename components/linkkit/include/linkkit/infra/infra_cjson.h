...
/* Render a lite_cjson_item_t entity to text for transfer/storage. Free the
 * char* when finished. */
...
lite_cjson_item_t *lite_cjson_create_floatArray(const float *numbers,
                                                int count);
...
#define lite_cjson_add_null_to_object(object, name) \
    lite_cjson_add_item_to_object(object, name, lite_cjson_create_null())
#define lite_cjson_add_true_to_object(object, name) \
    lite_cjson_add_item_to_object(object, name, lite_cjson_create_true())
#define lite_cjson_add_false_to_object(object, name) \
    lite_cjson_add_item_to_object(object, name, lite_cjson_create_false())
#define lite_cjson_add_bool_to_object(object, name, b) \
    lite_cjson_add_item_to_object(object, name, lite_cjson_create_bool(b))
#define lite_cjson_add_number_to_object(object, name, n) \
    lite_cjson_add_item_to_object(object, name, lite_cjson_create_number(n))
#define lite_cjson_add_string_to_object(object, name, s) \
    lite_cjson_add_item_to_object(object, name, lite_cjson_create_string(s))
#endif
