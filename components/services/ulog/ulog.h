 ...
 * @param  f         Usually File name
 * @param  l         Usually Line number of comment
 * @param  fmt       string point to variale format
 * @param  args      va_List of variable format
 * @return  0: success; other: fail.
 */
int ulog_print(const unsigned char s, const char *mod, const char *f,
               const unsigned long l, const char *fmt, va_list args);
/*
