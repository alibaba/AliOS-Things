...
#define EVENT_NETMGR_WIFI_DHCP_START_FAILED     (EVENT_NETMGR_BASE + 21) // DHCP start fails
#define EVENT_NETMGR_WIFI_DHCP_TIMEOUT          (EVENT_NETMGR_BASE + 22) // DHCP timeout
#define EVENT_NETMGR_WIFI_DHCP_SUCCESS          (EVENT_NETMGR_BASE + 23) // DHCP success
#define EVENT_NETMGR_WIFI_MAX                   (EVENT_NETMGR_WIFI_DHCP_SUCCESS)

#define EVENT_NETMGR_ETH_BASE                   (EVENT_NETMGR_WIFI_MAX)
#define EVENT_NETMGR_ETH_DISCONNECTED           (EVENT_NETMGR_ETH_BASE + 1) // Eth disconnected
#define EVENT_NETMGR_ETH_CONNECTED              (EVENT_NETMGR_ETH_BASE + 2) // Eth connected
#define EVENT_NETMGR_ETH_CONN_TIMEOUT           (EVENT_NETMGR_ETH_BASE + 3) // Eth conn timeout
#define EVENT_NETMGR_ETH_DHCP_START_FAILED      (EVENT_NETMGR_ETH_BASE + 4) // DHCP start fails
#define EVENT_NETMGR_ETH_DHCP_TIMEOUT           (EVENT_NETMGR_ETH_BASE + 5) // DHCP timeout
#define EVENT_NETMGR_ETH_DHCP_SUCCESS           (EVENT_NETMGR_ETH_BASE + 6) // DHCP success
#define EVENT_NETMGR_DHCP_MAX                   (EVENT_NETMGR_ETH_DHCP_SUCCESS)
...
#define EVENT_WIFI_DHCP_START_FAILED            (EVENT_WIFI_BASE + 21) // DHCP start fails
#define EVENT_WIFI_DHCP_TIMEOUT                 (EVENT_WIFI_BASE + 22) // DHCP timeout
#define EVENT_WIFI_DHCP_SUCCESS                 (EVENT_WIFI_BASE + 23) // DHCP success
#define EVENT_WIFI_MAX                          (EVENT_WIFI_DHCP_SUCCESS)

#define EVENT_ETH_BASE                          (EVENT_WIFI_MAX)
#define EVENT_ETH_DISCONNECTED                  (EVENT_ETH_BASE + 1)  // Eth disconnected
#define EVENT_ETH_CONNECTED                     (EVENT_ETH_BASE + 2)  // Eth connected
#define EVENT_ETH_CONN_TIMEOUT                  (EVENT_ETH_BASE + 3)  // Eth conn timeout
#define EVENT_ETH_DHCP_START_FAILED             (EVENT_ETH_BASE + 4)  // DHCP start fails
#define EVENT_ETH_DHCP_TIMEOUT                  (EVENT_ETH_BASE + 5)  // DHCP timeout
#define EVENT_ETH_DHCP_SUCCESS                  (EVENT_ETH_BASE + 6)  // DHCP success
#define EVENT_ETH_MAX                           (EVENT_ETH_DHCP_SUCCESS)

#define EVENT_SNTP_BASE                         (EVENT_ETH_MAX)
