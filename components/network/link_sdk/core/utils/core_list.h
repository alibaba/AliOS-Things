 ...
 * @member: the name of the core_list_head within the struct.
 */
#define core_list_next_entry(pos, member) \
    core_list_entry((pos)->member.next, typeof(*(pos)), member)
 ...
 * @member: the name of the core_list_head within the struct.
 */
#define core_list_for_each_entry(pos, head, member)              \
    for (pos = core_list_first_entry(head, typeof(*pos), member);    \
         &pos->member != (head);                    \
         pos = core_list_next_entry(pos, member))
 ...
 * @member: the name of the core_list_head within the struct.
 */
#define core_list_for_each_entry_safe(pos, n, head, member)          \
    for (pos = core_list_first_entry(head, typeof(*pos), member),    \
         n = core_list_next_entry(pos, member);           \
         &pos->member != (head);                    \
         pos = n, n = core_list_next_entry(n, member))
