...
static void _cli_iperf_server_command( int argc, char **argv )
{
    ...
    g_iperf_param = (char** )malloc( IPERF_COMMAND_BUFFER_NUM * IPERF_COMMAND_BUFFER_SIZE );
    ...
    for ( i = 0; (i < argc) && (i < IPERF_COMMAND_BUFFER_NUM); i++ ) {
        strncpy( (char *) &g_iperf_param[i * offset], argv[i], offset);
    ...
    for ( i = 0; (i < argc) && (i < IPERF_COMMAND_BUFFER_NUM); i++ ) {
        if ( strcmp( argv[i], "-u" ) == 0 ) {
            ...
            aos_task_new_ext(&aos_iperf_task, IPERF_NAME, iperf_udp_run_server_thread, (void*)g_iperf_param, IPERF_STACKSIZE, IPERF_PRIO, 1);
            is_create_task = 1;
            break;
        }
    }
    if ( is_create_task != 1 ) {
        ...
        aos_task_new_ext(&aos_iperf_task, IPERF_NAME, iperf_tcp_run_server_thread, (void*)g_iperf_param, IPERF_STACKSIZE, IPERF_PRIO, 1);
        is_create_task = 1;
    }
    krhino_sched_policy_set(aos_iperf_task.hdl, KSCHED_RR, IPERF_PRIO);
}
...
static void _cli_iperf_client_command( int argc, char **argv )
{
    ...
    for ( i = 0; (i < argc) && (i < IPERF_COMMAND_BUFFER_NUM); i++ ) {
        if ( strcmp( argv[i], "-u" ) == 0 ) {
            ...
            aos_task_new_ext(&aos_iperf_task, IPERF_NAME, iperf_udp_run_client_thread, (void*)g_iperf_param, IPERF_STACKSIZE, IPERF_PRIO, 1);
            is_create_task = 1;
            break;
        }
    }
    ...
    if ( is_create_task != 1 ) {
        ...
        aos_task_new_ext(&aos_iperf_task, IPERF_NAME, iperf_tcp_run_client_thread, (void*)g_iperf_param, IPERF_STACKSIZE, IPERF_PRIO, 1);
        is_create_task = 1;
    }
    krhino_sched_policy_set(aos_iperf_task.hdl, KSCHED_RR, IPERF_PRIO);
}
