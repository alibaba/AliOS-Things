...
typedef enum {
    ...
    UMESH_FRAME_DATA,
    UMESH_FRAME_ZERO_REQ,
    UMESH_FRAME_ZERO_RESP,
    UMESH_FRAME_ZERO_FINISH,   
} umesh_frame_type_t;
...
struct umesh_send_message {
    ...
    uint8_t ext_addr_enable;

    uint8_t ra[IEEE80211_MAC_ADDR_LEN]; /* recieve address */
    uint8_t sa[IEEE80211_MAC_ADDR_LEN]; /* recieve address */
