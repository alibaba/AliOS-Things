...
#ifdef MAL_CONFIG_MAX_TOPIC_LEN
#define MAL_MC_MAX_TOPIC_LEN   MAL_CONFIG_MAX_TOPIC_LEN
#else
#define MAL_MC_MAX_TOPIC_LEN   128
#endif

#ifdef MAL_CONFIG_MAX_MSG_LEN
#define MAL_MC_MAX_MSG_LEN     MAL_CONFIG_MAX_MSG_LEN
#else
#define MAL_MC_MAX_MSG_LEN     256
#endif
