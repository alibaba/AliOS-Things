 ...
 */
typedef enum {
	RX8130CE_OutputFrequency_1Hz = 0x00, /*!< Set SQW/OUT pin to 1Hz output frequency */
	RX8130CE_OutputFrequency_4096Hz,     /*!< Set SQW/OUT pin to 4096Hz output frequency */
	RX8130CE_OutputFrequency_8192Hz,     /*!< Set SQW/OUT pin to 8192Hz output frequency */
	RX8130CE_OutputFrequency_32768Hz,    /*!< Set SQW/OUT pin to 32768Hz output frequency */
	RX8130CE_OutputFrequency_High,       /*!< Set SQW/OUT pin high. Because this pin is open-drain, you will need external pull up resistor */
