...
static uart_dev_t ec20_at_uart_dev;
...
static int ec20_sal_add_dev(void* data)
{
    ...
    if(data != NULL)
    {
        ...
        ec20_at_uart_dev.port  = config->uart_dev.port;
        ec20_at_uart_dev.config.baud_rate    = config->uart_dev.config.baud_rate;
        ec20_at_uart_dev.config.data_width   = config->uart_dev.config.data_width;
        ec20_at_uart_dev.config.parity       = config->uart_dev.config.parity;
        ec20_at_uart_dev.config.stop_bits    = config->uart_dev.config.stop_bits;
        ec20_at_uart_dev.config.flow_control = config->uart_dev.config.flow_control;
        ec20_at_uart_dev.config.mode         = config->uart_dev.config.mode;
    }
    else
    {
    ...
    at_config.port                             = ec20_at_uart_dev.port;
    at_config.dev_cfg                          = &ec20_at_uart_dev;
