#ifndef HEADER_CURL_CONFIG_BES_H
#define HEADER_CURL_CONFIG_BES_H
/***************************************************************************
 *                                  _   _ ____  _
 *  Project                     ___| | | |  _ \| |
 *                             / __| | | | |_) | |
...
/* =============================================================== */
/*               Hand crafted config file for BES              */
/* =============================================================== */
...
/* #undef CURL_SA_FAMILY_T sa_family_t*/
...
/* #under HAVE_CRYPTO_CLEANUP_ALL_EX_DATA */
...
/* #define HAVE_VXWORKS_STRERROR_R */
...
//#define CURL_DOES_CONVERSIONS // for build

//#define HAVE_ICONV

#endif /* HEADER_CURL_CONFIG_BES_H */
