...
static void *ulog_task;
static int ulog_stack_used;
...
{
    amp_os_thread_param_t ulog_task_params = {0};
    ulog_task_params.name = "amp_ulog";
    ulog_task_params.priority = HAL_GetDefaultTaskPriority();
    ulog_task_params.stack_size = 3072;
    ...
    if (0 == HAL_ThreadCreate(&ulog_task, log_routine, NULL, &ulog_task_params, &ulog_stack_used))
    {
