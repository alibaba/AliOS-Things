...
#define AT_LOGD(fmt, ...) LOGD("at",fmt,##__VA_ARGS__)
#define AT_LOGI(fmt, ...) LOGI("at",fmt,##__VA_ARGS__)
#define AT_LOGW(fmt, ...) LOGW("at",fmt,##__VA_ARGS__)
#define AT_LOGE(fmt, ...) LOGE("at",fmt,##__VA_ARGS__)
