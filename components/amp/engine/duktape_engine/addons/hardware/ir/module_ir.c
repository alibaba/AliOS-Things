...
void module_ir_register(void)
{
    ...
    AMP_ADD_FUNCTION("open",  native_ir_open, 1);
    AMP_ADD_FUNCTION("on",    native_ir_on, 2);
    AMP_ADD_FUNCTION("send",  native_ir_send, 3);
    AMP_ADD_FUNCTION("learn", native_ir_learn, 3);
    AMP_ADD_FUNCTION("close", native_ir_close, 1);
