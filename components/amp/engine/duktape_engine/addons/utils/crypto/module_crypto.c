...
void module_crypto_register(void)
{
    ...
    /* md5 */
    duk_push_c_function(ctx, native_crypto_md5, 1);
    duk_put_prop_string(ctx, -2, "md5");

    // /* encrypt */
    // duk_push_c_function(ctx, native_crypto_encrypt, 0);
    // duk_put_prop_string(ctx, -2, "encrypt");

    // /* decrypt */
    // duk_push_c_function(ctx, native_crypto_decrypt, 0);
    // duk_put_prop_string(ctx, -2, "decrypt");
