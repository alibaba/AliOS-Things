 ...
 */
extern void *aos_realloc(void *ptr, unsigned int size);
extern void *aos_malloc(unsigned int size);
extern void aos_free(void *ptr);

#if !defined(DUK_ANSI_MALLOC)
#define DUK_ANSI_MALLOC      aos_malloc
#endif

#if !defined(DUK_ANSI_REALLOC)
#define DUK_ANSI_REALLOC     aos_realloc
#endif
#if !defined(DUK_ANSI_CALLOC)
// #define DUK_ANSI_CALLOC      duk_custom_calloc
#endif
#if !defined(DUK_ANSI_FREE)
#define DUK_ANSI_FREE        aos_free
#endif
...
#define DUK_USE_TARGET_INFO "amp"
...
#if !defined(AMP_LOWMEMORY_ENABLE)
/* More feature */
...
/** custom defines */
extern duk_double_t amp_date_get_now();
/** get utc time */
#define DUK_USE_DATE_GET_NOW(ctx) amp_date_get_now()
/** beijing time offset */
#define DUK_USE_DATE_GET_LOCAL_TZOFFSET(d)  28800
...
extern void DUK_USE_DEBUG_WRITE(long arg_level, const char *arg_file, long arg_line, const char *arg_func, const char *arg_msg);
#define DUK_USE_DEBUG_WRITE duk_debug_write_cb
