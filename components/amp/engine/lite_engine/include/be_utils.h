...
void be_amp_error(MOD_STR, const char *message);
void be_amp_error_at(const char *message, be_jse_lexer_ctx_t *lex,
                     int tokenPos);
void be_amp_warn(MOD_STR, const char *message);
void be_amp_warn(MOD_STR,%s, _at(const char *message, be_jse_lexer_ctx_t *lex, int tokenPos);
