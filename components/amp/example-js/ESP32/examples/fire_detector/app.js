...
function reportFireAlarm() {
  var alarm_on = 0;
  console.log('reportFireAlarm');
  var fireVoltage = fireDev.getVoltage();
  if(fireVoltage > 200) {
    alarm_on = 0;
  } else {
    alarm_on = 1;
  }
  console.log('>> fireVoltage is ' + fireVoltage + ', alarm_on is ' + alarm_on);
