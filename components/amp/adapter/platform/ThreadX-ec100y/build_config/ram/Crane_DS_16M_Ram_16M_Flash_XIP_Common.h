...
#define DDR_RO_SIZE     (0x02000000)//32M as max after ptable solution implement
...
//PSRAM_BLOCK_1
	...
	#define PS_CODE_IN_PSRAM_SIZE  (0x00300000 - MSA_SIZE)
	#else
	#define PS_CODE_IN_PSRAM_BASE  (MSA_BASE_ADDR + MSA_SIZE)
	#define PS_CODE_IN_PSRAM_SIZE  (0x00280000 - MSA_SIZE)
	#endif
...
//PSRAM_BLOCK_2
	...
	#define DDR_HEAP_GUARD_SIZE    (0x002C0000)


//PSRAM_BLOCK_3
	//[REGN] NONCACHE_REGION
	//[DESC] ALL NONCACHE regions
	//[SIZE] 1.5M - BOOT_SP_AREA
