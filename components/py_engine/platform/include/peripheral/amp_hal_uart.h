...
#ifndef AMP_HAL_UART_H
#define AMP_HAL_UART_H
...
/**
 * Register callback on a UART interface
 *
 * @param[in]   uart         the UART interface
 * @param[out]  cb           pointer to the buffer which will store incoming data
 * @param[out]  args         other data
 *
 * @return  0 : on success, EIO : if an error occurred with any step
 */
