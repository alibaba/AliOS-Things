...
enum {
    MP_QSTR__0x00_ = MP_QSTRnumber_of,
    ...
    MP_QSTR__gt__space_,
    MP_QSTR_AI,
    MP_QSTR_AI_ENGINE_ALIYUN,
    MP_QSTR_AI_ENGINE_NATIVE,
    MP_QSTR_APA106,
    MP_QSTR_CLEAR,
    MP_QSTR_CONFIG,
    ...
    MP_QSTR_delete,
    MP_QSTR_deps,
    MP_QSTR_detectFruits,
    MP_QSTR_detectPedestrian,
    MP_QSTR_dht_dot_py,
    MP_QSTR_diff,
    MP_QSTR_disabled,
    MP_QSTR_drain,
...
const qstr_pool_t mp_qstr_frozen_const_pool = {
    ...
    true, // entries are sorted
    {
        ...
        (const byte*)"\x2d\x72\x02" "AI",
        (const byte*)"\x25\x18\x10" "AI_ENGINE_ALIYUN",
        (const byte*)"\xc2\x75\x10" "AI_ENGINE_NATIVE",
        ...
        (const byte*)"\xa4\x72\x02" "ML",
        (const byte*)"\x7b\x80\x0f" "ML_ENGINE_CLOUD",
        ...
        (const byte*)"\xed\x75\x07" "VfsLfs2",
        ...
        (const byte*)"\x36\xbe\x09" "accessKey",
        (const byte*)"\x37\xbc\x0c" "accessSecret",
        ...
        (const byte*)"\xa3\xe8\x0b" "compareFace",
        (const byte*)"\x4e\xef\x0f" "compareFacePath",
        ...
        (const byte*)"\x50\x4c\x05" "delay",
        (const byte*)"\x9c\xe7\x06" "delete",
        (const byte*)"\x87\xec\x04" "deps",
        (const byte*)"\x6d\x73\x0c" "detectFruits",
        (const byte*)"\x05\x33\x10" "detectPedestrian",
        ...
        (const byte*)"\x7e\x19\x13" "getPredictResponses",
        ...
        (const byte*)"\xcc\xb5\x01" "i",
        (const byte*)"\x50\x54\x03" "idx",
        (const byte*)"\xef\x66\x09" "imagePath",
        ...
        (const byte*)"\x3c\x0b\x07" "loadNet",
        ...
        (const byte*)"\x13\x6e\x06" "minicv",
        (const byte*)"\xa4\x6e\x02" "ml",
        ...
        (const byte*)"\x84\xa5\x09" "ossBucket",
        (const byte*)"\xc9\x95\x0b" "ossEndpoint",
        ...
        (const byte*)"\x78\x08\x07" "predict",
        ...
        (const byte*)"\x96\xbe\x15" "recognizeLicensePlate",
        ...
        (const byte*)"\x81\xa0\x0c" "setInputData",
        ...
        (const byte*)"\xc7\x4c\x09" "unLoadNet",
...
// frozen bytecode for file uai.py, scope uai__lt_module_gt__AI___init__
STATIC const byte fun_data_uai__lt_module_gt__AI___init__[116] = {
    0xda, 0x85, 0x80, 0x01, 0x20,
    MP_QSTR___init__ & 0xff, MP_QSTR___init__ >> 8,
    MP_QSTR_uai_dot_py & 0xff, MP_QSTR_uai_dot_py >> 8,
    0x80, 0x07, 0x25, 0x29, 0x2b, 0x31, 0x28, 0x28, 0x42, 0x51, 0x28, 0x00,
    0xb1, 
    0xb0, 
    0x18, MP_QSTR_type & 0xff, MP_QSTR_type >> 8, 
    0x12, MP_QSTR_ML & 0xff, MP_QSTR_ML >> 8, 
    0x34, 0x00, 
    0xb0, 
    0x18, MP_QSTR_ml & 0xff, MP_QSTR_ml >> 8, 
    0xb0, 
    0x13, MP_QSTR_type & 0xff, MP_QSTR_type >> 8, 
    0x12, MP_QSTR_AI_ENGINE_ALIYUN & 0xff, MP_QSTR_AI_ENGINE_ALIYUN >> 8, 
    0xd9, 
    0x44, 0x34, 0x80, 
    0xb0, 
    0x13, MP_QSTR_ml & 0xff, MP_QSTR_ml >> 8, 
    0x14, MP_QSTR_open & 0xff, MP_QSTR_open >> 8, 
    0xb0, 
    0x13, MP_QSTR_ml & 0xff, MP_QSTR_ml >> 8, 
    0x13, MP_QSTR_ML_ENGINE_CLOUD & 0xff, MP_QSTR_ML_ENGINE_CLOUD >> 8, 
    0x36, 0x01, 
    0x59, 
    0xb2, 
    0x44, 0x04, 0x80, 
...
STATIC const mp_obj_str_t const_obj_uai__lt_module_gt__AI___init___0 = {{&mp_type_str}, 11827, 26, (const byte*)"\x61\x63\x63\x65\x73\x73\x20\x6b\x65\x79\x20\x63\x61\x6e\x20\x6e\x6f\x74\x20\x62\x65\x20\x6e\x75\x6c\x6c"};
STATIC const mp_obj_str_t const_obj_uai__lt_module_gt__AI___init___1 = {{&mp_type_str}, 65523, 54, (const byte*)"\x6e\x6f\x77\x20\x6f\x6e\x6c\x79\x20\x73\x75\x70\x70\x6f\x72\x74\x20\x63\x6c\x6f\x75\x64\x20\x61\x69\x2c\x20\x6e\x6f\x74\x20\x73\x75\x70\x70\x6f\x72\x74\x20\x6e\x61\x74\x69\x76\x61\x74\x65\x20\x61\x69\x20\x79\x65\x74"};
STATIC const mp_obj_str_t const_obj_uai__lt_module_gt__AI___init___2 = {{&mp_type_str}, 50006, 88, (const byte*)""};
STATIC const mp_rom_obj_t const_table_data_uai__lt_module_gt__AI___init__[9] = {
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_type),
    MP_ROM_QSTR(MP_QSTR_accessKey),
    MP_ROM_QSTR(MP_QSTR_accessSecret),
    MP_ROM_QSTR(MP_QSTR_ossEndpoint),
    MP_ROM_QSTR(MP_QSTR_ossBucket),
    MP_ROM_PTR(&const_obj_uai__lt_module_gt__AI___init___0),
    MP_ROM_PTR(&const_obj_uai__lt_module_gt__AI___init___1),
    MP_ROM_PTR(&const_obj_uai__lt_module_gt__AI___init___2),
};
STATIC const mp_raw_code_t raw_code_uai__lt_module_gt__AI___init__ = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 6,
    .fun_data = fun_data_uai__lt_module_gt__AI___init__,
    .const_table = (mp_uint_t*)const_table_data_uai__lt_module_gt__AI___init__,
    #if MICROPY_PERSISTENT_CODE_SAVE
    .fun_data_len = 116,
    .n_obj = 3,
    .n_raw_code = 0,
    ...
    .prelude = {
        ...
        .qstr_source_file = MP_QSTR_uai_dot_py,
        .line_info = fun_data_uai__lt_module_gt__AI___init__ + 9,
        .opcodes = fun_data_uai__lt_module_gt__AI___init__ + 21,
    },
    .line_of_definition = 0,
    #endif
    #if MICROPY_EMIT_MACHINE_CODE
...
// frozen bytecode for file uai.py, scope uai__lt_module_gt__AI_compareFace
STATIC const byte fun_data_uai__lt_module_gt__AI_compareFace[71] = {
    0x3b, 0x18,
    MP_QSTR_compareFace & 0xff, MP_QSTR_compareFace >> 8,
    MP_QSTR_uai_dot_py & 0xff, MP_QSTR_uai_dot_py >> 8,
    0x80, 0x16, 0x2c, 0x2c, 0x2a, 0x2b, 0x2a, 0x00,
    0xb0, 
    0x13, MP_QSTR_ml & 0xff, MP_QSTR_ml >> 8, 
    0x14, MP_QSTR_setInputData & 0xff, MP_QSTR_setInputData >> 8, 
    0xb1, 
    0xb2, 
    0x36, 0x02, 
    0x59, 
    0xb0, 
    0x13, MP_QSTR_ml & 0xff, MP_QSTR_ml >> 8, 
    0x14, MP_QSTR_loadNet & 0xff, MP_QSTR_loadNet >> 8, 
    0x23, 0x03, 
    0x36, 0x01, 
    0x59, 
    0xb0, 
    0x13, MP_QSTR_ml & 0xff, MP_QSTR_ml >> 8, 
    0x14, MP_QSTR_predict & 0xff, MP_QSTR_predict >> 8, 
    0x36, 0x00, 
    0x59, 
    0xb0, 
    0x13, MP_QSTR_ml & 0xff, MP_QSTR_ml >> 8, 
    0x14, MP_QSTR_getPredictResponses & 0xff, MP_QSTR_getPredictResponses >> 8, 
    0x51, 
    0x36, 0x01, 
    0xc3, 
    0xb0, 
    0x13, MP_QSTR_ml & 0xff, MP_QSTR_ml >> 8, 
    0x14, MP_QSTR_unLoadNet & 0xff, MP_QSTR_unLoadNet >> 8, 
    0x36, 0x00, 
    0x59, 
    0xb3, 
    0x63, 
};
STATIC const mp_obj_str_t const_obj_uai__lt_module_gt__AI_compareFace_0 = {{&mp_type_str}, 38582, 17, (const byte*)"\x46\x61\x63\x65\x62\x6f\x64\x79\x43\x6f\x6d\x70\x61\x72\x69\x6e\x67"};
STATIC const mp_rom_obj_t const_table_data_uai__lt_module_gt__AI_compareFace[4] = {
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_imagePath),
    MP_ROM_QSTR(MP_QSTR_compareFacePath),
    MP_ROM_PTR(&const_obj_uai__lt_module_gt__AI_compareFace_0),
};
STATIC const mp_raw_code_t raw_code_uai__lt_module_gt__AI_compareFace = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 3,
    .fun_data = fun_data_uai__lt_module_gt__AI_compareFace,
    .const_table = (mp_uint_t*)const_table_data_uai__lt_module_gt__AI_compareFace,
    #if MICROPY_PERSISTENT_CODE_SAVE
    .fun_data_len = 71,
    .n_obj = 1,
    .n_raw_code = 0,
    ...
    .prelude = {
        ...
        .n_kwonly_args = 0,
        .n_def_pos_args = 0,
        .qstr_block_name = MP_QSTR_compareFace,
        .qstr_source_file = MP_QSTR_uai_dot_py,
        .line_info = fun_data_uai__lt_module_gt__AI_compareFace + 6,
        .opcodes = fun_data_uai__lt_module_gt__AI_compareFace + 14,
    },
    .line_of_definition = 0,
    #endif
    #if MICROPY_EMIT_MACHINE_CODE
...
// frozen bytecode for file uai.py, scope uai__lt_module_gt__AI_detectPedestrian
STATIC const byte fun_data_uai__lt_module_gt__AI_detectPedestrian[70] = {
    0x2a, 0x18,
    MP_QSTR_detectPedestrian & 0xff, MP_QSTR_detectPedestrian >> 8,
    MP_QSTR_uai_dot_py & 0xff, MP_QSTR_uai_dot_py >> 8,
    0x80, 0x1f, 0x2b, 0x2c, 0x2a, 0x2b, 0x2a, 0x00,
    0xb0, 
    0x13, MP_QSTR_ml & 0xff, MP_QSTR_ml >> 8, 
    0x14, MP_QSTR_setInputData & 0xff, MP_QSTR_setInputData >> 8, 
    0xb1, 
...
STATIC const mp_obj_str_t const_obj_uai__lt_module_gt__AI_detectPedestrian_0 = {{&mp_type_str}, 61477, 16, (const byte*)"\x44\x65\x74\x65\x63\x74\x50\x65\x64\x65\x73\x74\x72\x69\x61\x6e"};
STATIC const mp_rom_obj_t const_table_data_uai__lt_module_gt__AI_detectPedestrian[3] = {
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_imagePath),
    MP_ROM_PTR(&const_obj_uai__lt_module_gt__AI_detectPedestrian_0),
};
STATIC const mp_raw_code_t raw_code_uai__lt_module_gt__AI_detectPedestrian = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 2,
    .fun_data = fun_data_uai__lt_module_gt__AI_detectPedestrian,
    .const_table = (mp_uint_t*)const_table_data_uai__lt_module_gt__AI_detectPedestrian,
    #if MICROPY_PERSISTENT_CODE_SAVE
    .fun_data_len = 70,
    .n_obj = 1,
    .n_raw_code = 0,
    ...
    .prelude = {
        ...
        .n_kwonly_args = 0,
        .n_def_pos_args = 0,
        .qstr_block_name = MP_QSTR_detectPedestrian,
        .qstr_source_file = MP_QSTR_uai_dot_py,
        .line_info = fun_data_uai__lt_module_gt__AI_detectPedestrian + 6,
        .opcodes = fun_data_uai__lt_module_gt__AI_detectPedestrian + 14,
    },
    .line_of_definition = 0,
    #endif
    #if MICROPY_EMIT_MACHINE_CODE
...
// frozen bytecode for file uai.py, scope uai__lt_module_gt__AI_detectFruits
STATIC const byte fun_data_uai__lt_module_gt__AI_detectFruits[71] = {
    0x32, 0x18,
    MP_QSTR_detectFruits & 0xff, MP_QSTR_detectFruits >> 8,
    MP_QSTR_uai_dot_py & 0xff, MP_QSTR_uai_dot_py >> 8,
    0x80, 0x28, 0x2c, 0x2c, 0x2a, 0x2b, 0x2a, 0x00,
    0xb0, 
    0x13, MP_QSTR_ml & 0xff, MP_QSTR_ml >> 8, 
    0x14, MP_QSTR_setInputData & 0xff, MP_QSTR_setInputData >> 8, 
    0xb1, 
...
STATIC const mp_obj_str_t const_obj_uai__lt_module_gt__AI_detectFruits_0 = {{&mp_type_str}, 52877, 12, (const byte*)"\x44\x65\x74\x65\x63\x74\x46\x72\x75\x69\x74\x73"};
STATIC const mp_rom_obj_t const_table_data_uai__lt_module_gt__AI_detectFruits[3] = {
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_imagePath),
    MP_ROM_PTR(&const_obj_uai__lt_module_gt__AI_detectFruits_0),
};
STATIC const mp_raw_code_t raw_code_uai__lt_module_gt__AI_detectFruits = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 2,
    .fun_data = fun_data_uai__lt_module_gt__AI_detectFruits,
    .const_table = (mp_uint_t*)const_table_data_uai__lt_module_gt__AI_detectFruits,
    #if MICROPY_PERSISTENT_CODE_SAVE
    .fun_data_len = 71,
    .n_obj = 1,
    .n_raw_code = 0,
    ...
    .prelude = {
        ...
        .n_kwonly_args = 0,
        .n_def_pos_args = 0,
        .qstr_block_name = MP_QSTR_detectFruits,
        .qstr_source_file = MP_QSTR_uai_dot_py,
        .line_info = fun_data_uai__lt_module_gt__AI_detectFruits + 6,
        .opcodes = fun_data_uai__lt_module_gt__AI_detectFruits + 14,
    },
    .line_of_definition = 0,
    #endif
    #if MICROPY_EMIT_MACHINE_CODE
...
// frozen bytecode for file uai.py, scope uai__lt_module_gt__AI_recognizeLicensePlate
STATIC const byte fun_data_uai__lt_module_gt__AI_recognizeLicensePlate[70] = {
    0x2a, 0x18,
    MP_QSTR_recognizeLicensePlate & 0xff, MP_QSTR_recognizeLicensePlate >> 8,
    MP_QSTR_uai_dot_py & 0xff, MP_QSTR_uai_dot_py >> 8,
    0x80, 0x31, 0x2b, 0x2c, 0x2a, 0x2b, 0x2a, 0x00,
    0xb0, 
    0x13, MP_QSTR_ml & 0xff, MP_QSTR_ml >> 8, 
    0x14, MP_QSTR_setInputData & 0xff, MP_QSTR_setInputData >> 8, 
    0xb1, 
...
STATIC const mp_obj_str_t const_obj_uai__lt_module_gt__AI_recognizeLicensePlate_0 = {{&mp_type_str}, 6198, 21, (const byte*)"\x52\x65\x63\x6f\x67\x6e\x69\x7a\x65\x4c\x69\x63\x65\x6e\x73\x65\x50\x6c\x61\x74\x65"};
STATIC const mp_rom_obj_t const_table_data_uai__lt_module_gt__AI_recognizeLicensePlate[3] = {
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_imagePath),
    MP_ROM_PTR(&const_obj_uai__lt_module_gt__AI_recognizeLicensePlate_0),
};
STATIC const mp_raw_code_t raw_code_uai__lt_module_gt__AI_recognizeLicensePlate = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 2,
    .fun_data = fun_data_uai__lt_module_gt__AI_recognizeLicensePlate,
    .const_table = (mp_uint_t*)const_table_data_uai__lt_module_gt__AI_recognizeLicensePlate,
    #if MICROPY_PERSISTENT_CODE_SAVE
    .fun_data_len = 70,
    .n_obj = 1,
    .n_raw_code = 0,
    ...
    .prelude = {
        ...
        .n_kwonly_args = 0,
        .n_def_pos_args = 0,
        .qstr_block_name = MP_QSTR_recognizeLicensePlate,
        .qstr_source_file = MP_QSTR_uai_dot_py,
        .line_info = fun_data_uai__lt_module_gt__AI_recognizeLicensePlate + 6,
        .opcodes = fun_data_uai__lt_module_gt__AI_recognizeLicensePlate + 14,
    },
    .line_of_definition = 0,
    #endif
    #if MICROPY_EMIT_MACHINE_CODE
...
// frozen bytecode for file uai.py, scope uai__lt_module_gt__AI___del__
STATIC const byte fun_data_uai__lt_module_gt__AI___del__[56] = {
    0x35, 0x16,
    MP_QSTR___del__ & 0xff, MP_QSTR___del__ >> 8,
    MP_QSTR_uai_dot_py & 0xff, MP_QSTR_uai_dot_py >> 8,
    0x80, 0x39, 0x23, 0x2a, 0x26, 0x52, 0x00,
    0x48, 0x19, 0x00, 
    0xb0, 
    0x13, MP_QSTR_ml & 0xff, MP_QSTR_ml >> 8, 
    0x14, MP_QSTR_close & 0xff, MP_QSTR_close >> 8, 
...
STATIC const mp_rom_obj_t const_table_data_uai__lt_module_gt__AI___del__[1] = {
    MP_ROM_QSTR(MP_QSTR_self),
};
STATIC const mp_raw_code_t raw_code_uai__lt_module_gt__AI___del__ = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 1,
    .fun_data = fun_data_uai__lt_module_gt__AI___del__,
    .const_table = (mp_uint_t*)const_table_data_uai__lt_module_gt__AI___del__,
    #if MICROPY_PERSISTENT_CODE_SAVE
    .fun_data_len = 56,
    .n_obj = 0,
    .n_raw_code = 0,
    ...
    .prelude = {
        ...
        .n_kwonly_args = 0,
        .n_def_pos_args = 0,
        .qstr_block_name = MP_QSTR___del__,
        .qstr_source_file = MP_QSTR_uai_dot_py,
        .line_info = fun_data_uai__lt_module_gt__AI___del__ + 6,
        .opcodes = fun_data_uai__lt_module_gt__AI___del__ + 13,
    },
    .line_of_definition = 0,
    #endif
    #if MICROPY_EMIT_MACHINE_CODE
...
// frozen bytecode for file uai.py, scope uai__lt_module_gt__AI
STATIC const byte fun_data_uai__lt_module_gt__AI[73] = {
    0x20, 0x22,
    MP_QSTR_AI & 0xff, MP_QSTR_AI >> 8,
    MP_QSTR_uai_dot_py & 0xff, MP_QSTR_uai_dot_py >> 8,
    0x6c, 0x60, 0x8f, 0x0f, 0x85, 0x09, 0x85, 0x09, 0x85, 0x09, 0x85, 0x08, 0x00,
    0x11, MP_QSTR___name__ & 0xff, MP_QSTR___name__ >> 8, 
    0x16, MP_QSTR___module__ & 0xff, MP_QSTR___module__ >> 8, 
    0x10, MP_QSTR_AI & 0xff, MP_QSTR_AI >> 8, 
    0x16, MP_QSTR___qualname__ & 0xff, MP_QSTR___qualname__ >> 8, 
    0x11, MP_QSTR_AI_ENGINE_NATIVE & 0xff, MP_QSTR_AI_ENGINE_NATIVE >> 8, 
    0x51, 
    0x51, 
    0x51, 
    0x51, 
    ...
    0x32, 0x01, 
    0x16, MP_QSTR_compareFace & 0xff, MP_QSTR_compareFace >> 8, 
    0x32, 0x02, 
    0x16, MP_QSTR_detectPedestrian & 0xff, MP_QSTR_detectPedestrian >> 8, 
    0x32, 0x03, 
    0x16, MP_QSTR_detectFruits & 0xff, MP_QSTR_detectFruits >> 8, 
    0x32, 0x04, 
    0x16, MP_QSTR_recognizeLicensePlate & 0xff, MP_QSTR_recognizeLicensePlate >> 8, 
    0x32, 0x05, 
    0x16, MP_QSTR___del__ & 0xff, MP_QSTR___del__ >> 8, 
    0x51, 
    0x63, 
};
STATIC const mp_rom_obj_t const_table_data_uai__lt_module_gt__AI[6] = {
    MP_ROM_PTR(&raw_code_uai__lt_module_gt__AI___init__),
    MP_ROM_PTR(&raw_code_uai__lt_module_gt__AI_compareFace),
    MP_ROM_PTR(&raw_code_uai__lt_module_gt__AI_detectPedestrian),
    MP_ROM_PTR(&raw_code_uai__lt_module_gt__AI_detectFruits),
    MP_ROM_PTR(&raw_code_uai__lt_module_gt__AI_recognizeLicensePlate),
    MP_ROM_PTR(&raw_code_uai__lt_module_gt__AI___del__),
};
STATIC const mp_raw_code_t raw_code_uai__lt_module_gt__AI = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 0,
    .fun_data = fun_data_uai__lt_module_gt__AI,
    .const_table = (mp_uint_t*)const_table_data_uai__lt_module_gt__AI,
    #if MICROPY_PERSISTENT_CODE_SAVE
    .fun_data_len = 73,
    .n_obj = 0,
    .n_raw_code = 6,
    ...
    .prelude = {
        ...
        .n_kwonly_args = 0,
        .n_def_pos_args = 0,
        .qstr_block_name = MP_QSTR_AI,
        .qstr_source_file = MP_QSTR_uai_dot_py,
        .line_info = fun_data_uai__lt_module_gt__AI + 6,
        .opcodes = fun_data_uai__lt_module_gt__AI + 19,
    },
    .line_of_definition = 0,
    #endif
    #if MICROPY_EMIT_MACHINE_CODE
...
// frozen bytecode for file uai.py, scope uai_<module>
STATIC const byte fun_data_uai__lt_module_gt_[47] = {
    0x10, 0x10,
    MP_QSTR__lt_module_gt_ & 0xff, MP_QSTR__lt_module_gt_ >> 8,
    MP_QSTR_uai_dot_py & 0xff, MP_QSTR_uai_dot_py >> 8,
    0x50, 0x24, 0x44, 0x00,
    0x80, 
    0x10, MP_QSTR_ML & 0xff, MP_QSTR_ML >> 8, 
    0x2a, 0x01, 
    0x1b, MP_QSTR_minicv & 0xff, MP_QSTR_minicv >> 8, 
    0x1c, MP_QSTR_ML & 0xff, MP_QSTR_ML >> 8, 
    0x16, MP_QSTR_ML & 0xff, MP_QSTR_ML >> 8, 
    0x59, 
    0x81, 
    0x16, MP_QSTR_AI_ENGINE_ALIYUN & 0xff, MP_QSTR_AI_ENGINE_ALIYUN >> 8, 
    0x82, 
    0x16, MP_QSTR_AI_ENGINE_NATIVE & 0xff, MP_QSTR_AI_ENGINE_NATIVE >> 8, 
    0x54, 
    0x32, 0x00, 
    0x10, MP_QSTR_AI & 0xff, MP_QSTR_AI >> 8, 
    0x34, 0x02, 
    0x16, MP_QSTR_AI & 0xff, MP_QSTR_AI >> 8, 
    0x51, 
    0x63, 
};
STATIC const mp_rom_obj_t const_table_data_uai__lt_module_gt_[1] = {
    MP_ROM_PTR(&raw_code_uai__lt_module_gt__AI),
};
const mp_raw_code_t raw_code_uai__lt_module_gt_ = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 0,
    .fun_data = fun_data_uai__lt_module_gt_,
    .const_table = (mp_uint_t*)const_table_data_uai__lt_module_gt_,
    #if MICROPY_PERSISTENT_CODE_SAVE
    .fun_data_len = 47,
    .n_obj = 0,
    .n_raw_code = 1,
    ...
    .prelude = {
        ...
        .qstr_block_name = MP_QSTR__lt_module_gt_,
        .qstr_source_file = MP_QSTR_uai_dot_py,
        .line_info = fun_data_uai__lt_module_gt_ + 6,
        .opcodes = fun_data_uai__lt_module_gt_ + 10,
    },
    .line_of_definition = 0,
    #endif
    #if MICROPY_EMIT_MACHINE_CODE
...
MICROPY_FROZEN_LIST_ITEM("uai", "uai.py")
