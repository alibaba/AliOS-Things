...
QDEF(MP_QSTR_reboot, (const byte*)"\xe4\x06" "reboot")
...
QDEF(MP_QSTR_video, (const byte *)"\x54\x05" "video")
QDEF(MP_QSTR_camera, (const byte *)"\xdc\x06" "camera")
QDEF(MP_QSTR_preview, (const byte *)"\xef\x07" "preview")
QDEF(MP_QSTR_capture, (const byte *)"\x61\x07" "capture")
QDEF(MP_QSTR_YUV, (const byte *)"\x1f\x03" "YUV")
QDEF(MP_QSTR_JPEG, (const byte *)"\x3d\x04" "JPEG")
QDEF(MP_QSTR_H264, (const byte *)"\xfd\x04" "H264")
QDEF(MP_QSTR_HEVC, (const byte *)"\x1d\x04" "HEVC")
...
QDEF(MP_QSTR_memRead, (const byte*)"\xf2\x07" "memRead")
QDEF(MP_QSTR_memWrite, (const byte*)"\x3d\x08" "memWrite")
QDEF(MP_QSTR_readAfterWrite, (const byte*)"\x4e\x0e" "readAfterWrite")
QDEF(MP_QSTR_readAndWrite, (const byte*)"\x01\x0c" "readAndWrite")
...
QDEF(MP_QSTR_AUDIOPLAYER_STAT_STOP, (const byte*)"\x8a\x15" "AUDIOPLAYER_STAT_STOP")
QDEF(MP_QSTR_AUDIOPLAYER_STAT_PAUSED, (const byte*)"\x04\x17" "AUDIOPLAYER_STAT_PAUSED")
QDEF(MP_QSTR_AUDIOPLAYER_STAT_PLAYING, (const byte*)"\xf6\x18" "AUDIOPLAYER_STAT_PLAYING")
QDEF(MP_QSTR_AUDIOPLAYER_STAT_ERROR, (const byte*)"\x2a\x16" "AUDIOPLAYER_STAT_ERROR")
...
QDEF(MP_QSTR_ETHERNET, (const byte *)"\x54\x08" "ETHERNET")
QDEF(MP_QSTR_CELLULAR, (const byte *)"\x69\x08" "CELLULAR")
...
QDEF(MP_QSTR_atten, (const byte *)"\xaf\x05" "atten")
QDEF(MP_QSTR_width, (const byte *)"\x23\x05" "width")
QDEF(MP_QSTR_read_u16, (const byte *)"\xda\x08" "read_u16")
QDEF(MP_QSTR_WIDTH_9BIT, (const byte *)"\x5a\x0a" "WIDTH_9BIT")
QDEF(MP_QSTR_WIDTH_10BIT, (const byte *)"\xc2\x0b" "WIDTH_10BIT")
QDEF(MP_QSTR_WIDTH_11BIT, (const byte *)"\xa3\x0b" "WIDTH_11BIT")
QDEF(MP_QSTR_WIDTH_12BIT, (const byte *)"\x80\x0b" "WIDTH_12BIT")
QDEF(MP_QSTR_WIDTH_13BIT, (const byte *)"\x61\x0b" "WIDTH_13BIT")
...
QDEF(MP_QSTR_RisingEdge, (const byte*)"\xae\x0a" "RisingEdge")
QDEF(MP_QSTR_FallingEdge, (const byte*)"\xa1\x0b" "FallingEdge")
...
QDEF(MP_QSTR_seekTo, (const byte*)"\xe6\x06" "seekTo")
...
QDEF(MP_QSTR_getDev, (const byte*)"\x64\x06" "getDev")
QDEF(MP_QSTR_autoReconnect, (const byte*)"\x03\x0d" "autoReconnect")
QDEF(MP_QSTR_autoSaveAP, (const byte*)"\x1a\x0a" "autoSaveAP")
QDEF(MP_QSTR_saveConfig, (const byte*)"\x4e\x0a" "saveConfig")
QDEF(MP_QSTR_deleteConfig, (const byte*)"\x76\x0c" "deleteConfig")
QDEF(MP_QSTR_setChannelList, (const byte*)"\x66\x0e" "setChannelList")
QDEF(MP_QSTR_getChannelList, (const byte*)"\xf2\x0e" "getChannelList")
QDEF(MP_QSTR_qrScan, (const byte *)"\x19\x06" "qrScan")
QDEF(MP_QSTR_smartConfig, (const byte *)"\x16\x0b" "smartConfig")
QDEF(MP_QSTR_softAP, (const byte *)"\x5a\x06" "softAP")
QDEF(MP_QSTR_ble, (const byte *)"\x4e\x03" "ble")
QDEF(MP_QSTR_blecfg, (const byte*)"\xac\x06" "blecfg")
QDEF(MP_QSTR_restore, (const byte*)"\x2d\x07" "restore")
QDEF(MP_QSTR_WifiInfo, (const byte*)"\xda\x08" "WifiInfo")
QDEF(MP_QSTR_DevInfo, (const byte*)"\xdc\x07" "DevInfo")
QDEF(MP_QSTR_startAdv, (const byte*)"\xf6\x08" "startAdv")
QDEF(MP_QSTR_stopAdv, (const byte *)"\xee\x07" "stopAdv")
QDEF(MP_QSTR_addService, (const byte *)"\xd9\x0a" "addService")
QDEF(MP_QSTR_updateCharacter, (const byte*)"\xed\x0f" "updateCharacter")
QDEF(MP_QSTR_onEvent, (const byte *)"\xa8\x07" "onEvent")
QDEF(MP_QSTR_STATUS, (const byte *)"\x31\x06" "STATUS")
QDEF(MP_QSTR_CHARAWRITE, (const byte *)"\xa1\x0a" "CHARAWRITE")
...
QDEF(MP_QSTR_getStream, (const byte*)"\x8f\x09" "getStream")
QDEF(MP_QSTR_enableNS, (const byte*)"\x59\x08" "enableNS")
QDEF(MP_QSTR_enableEC, (const byte*)"\xa2\x08" "enableEC")
QDEF(MP_QSTR_enableAGC, (const byte*)"\x21\x09" "enableAGC")
QDEF(MP_QSTR_enableVAD, (const byte*)"\xf7\x09" "enableVAD")
...
QDEF(MP_QSTR_EVT_GOT_IP, (const byte *)"\xe7\x0a" "EVT_GOT_IP")
QDEF(MP_QSTR_EVT_GOT_SSID_PASSWD, (const byte *)"\xae\x13" "EVT_GOT_SSID_PASSWD")
QDEF(MP_QSTR_EVT_CONN_FAIL, (const byte *)"\x4c\x0d" "EVT_CONN_FAIL")
...
QDEF(MP_QSTR_ChatBot, (const byte *)"\xa2\x07" "ChatBot")
QDEF(MP_QSTR_ucloud_ai, (const byte *)"\xd6\x09" "ucloud_ai")
QDEF(MP_QSTR_get_token_id, (const byte *)"\xa5\x0c" "get_token_id")
QDEF(MP_QSTR_AIAgent, (const byte *)"\x74\x07" "AIAgent")
QDEF(MP_QSTR_aiagent, (const byte *)"\x94\x07" "aiagent")
QDEF(MP_QSTR_infer, (const byte *)"\x73\x05" "infer")
...
QDEF(MP_QSTR_freqduty, (const byte *)"\xf9\x08" "freqduty")
...
QDEF(MP_QSTR_writeHoldingRegister, (const byte *)"\x7e\x14" "writeHoldingRegister")
QDEF(MP_QSTR_writeMultipleHoldingRegisters, (const byte *)"\xbd\x1d" "writeMultipleHoldingRegisters")
QDEF(MP_QSTR_writeCoil, (const byte *)"\x31\x09" "writeCoil")
QDEF(MP_QSTR_writeMultipleCoils, (const byte *)"\x12\x12" "writeMultipleCoils")
QDEF(MP_QSTR_readHoldingRegisters, (const byte *)"\x22\x14" "readHoldingRegisters")
QDEF(MP_QSTR_readInputRegisters, (const byte *)"\xdb\x12" "readInputRegisters")
QDEF(MP_QSTR_readDiscreteInputs, (const byte *)"\x69\x12" "readDiscreteInputs")
QDEF(MP_QSTR_readCoils, (const byte *)"\x6d\x09" "readCoils")
...
QDEF(MP_QSTR_ucamera, (const byte*)"\x09\x07" "ucamera")
QDEF(MP_QSTR_uninit, (const byte *)"\xa4\x06" "uninit")
...
QDEF(MP_QSTR_SLEEP, (const byte *)"\x0a\x05" "SLEEP")
QDEF(MP_QSTR_Timer, (const byte *)"\xa2\x05" "Timer")
QDEF(MP_QSTR_SoftTimer, (const byte *)"\xec\x09" "SoftTimer")
...
QDEF(MP_QSTR_PIN_WAKE, (const byte *)"\xd5\x08" "PIN_WAKE")
QDEF(MP_QSTR_EXT0_WAKE, (const byte *)"\x5b\x09" "EXT0_WAKE")
QDEF(MP_QSTR_EXT1_WAKE, (const byte *)"\xfa\x09" "EXT1_WAKE")
QDEF(MP_QSTR_TIMER_WAKE, (const byte *)"\x65\x0a" "TIMER_WAKE")
QDEF(MP_QSTR_TOUCHPAD_WAKE, (const byte *)"\xb2\x0d" "TOUCHPAD_WAKE")
QDEF(MP_QSTR_ULP_WAKE, (const byte *)"\x6b\x08" "ULP_WAKE")
QDEF(MP_QSTR_IDLE, (const byte *)"\xa1\x04" "IDLE")
QDEF(MP_QSTR_DEEPSLEEP, (const byte *)"\x7e\x09" "DEEPSLEEP")
QDEF(MP_QSTR_POWER_ON, (const byte *)"\xc4\x08" "POWER_ON")
QDEF(MP_QSTR_WLAN_WAKE, (const byte *)"\xb6\x09" "WLAN_WAKE")
QDEF(MP_QSTR_RTC_WAKE, (const byte *)"\xa7\x08" "RTC_WAKE")
...
QDEF(MP_QSTR_PULL_HOLD, (const byte *)"\x50\x09" "PULL_HOLD")
QDEF(MP_QSTR_WAKE_LOW, (const byte *)"\x96\x08" "WAKE_LOW")
QDEF(MP_QSTR_WAKE_HIGH, (const byte *)"\x0c\x09" "WAKE_HIGH")
QDEF(MP_QSTR_handler, (const byte *)"\xdd\x07" "handler")
QDEF(MP_QSTR_wake, (const byte *)"\xdd\x04" "wake")
QDEF(MP_QSTR_ulog, (const byte *)"\xd4\x04" "ulog")
QDEF(MP_QSTR_setlogfilesize, (const byte *)"\xa0\x0e" "setlogfilesize")
QDEF(MP_QSTR_setlogfilepath, (const byte *)"\x08\x0e" "setlogfilepath")
QDEF(MP_QSTR_fsloglevel, (const byte *)"\xa2\x0a" "fsloglevel")
QDEF(MP_QSTR_cloudloglevel, (const byte *)"\x46\x0d" "cloudloglevel")
QDEF(MP_QSTR_stdloglevel, (const byte *)"\x34\x0b" "stdloglevel")
QDEF(MP_QSTR_fatal, (const byte *)"\xdb\x05" "fatal")
QDEF(MP_QSTR_error, (const byte *)"\xbd\x05" "error")
QDEF(MP_QSTR_warn, (const byte *)"\xaf\x04" "warn")
...
QDEF(MP_QSTR_LOG_WARN, (const byte *)"\x54\x08" "LOG_WARN")
QDEF(MP_QSTR_LOG_FATAL, (const byte *)"\x60\x09" "LOG_FATAL")
QDEF(MP_QSTR_LOG_ERROR, (const byte *)"\x06\x09" "LOG_ERROR")
QDEF(MP_QSTR_upgrade, (const byte *)"\x95\x07" "upgrade")
QDEF(MP_QSTR_report, (const byte *)"\x8b\x06" "report")
QDEF(MP_QSTR_verify, (const byte *)"\xd2\x06" "verify")
QDEF(MP_QSTR_ota, (const byte *)"\x5f\x03" "ota")
QDEF(MP_QSTR_linksdk, (const byte *)"\x99\x07" "linksdk")
...
QDEF(MP_QSTR_max_clients, (const byte *)"\x84\x0b" "max_clients")
QDEF(MP_QSTR_essid, (const byte *)"\x4d\x05" "essid")
QDEF(MP_QSTR_bssid, (const byte *)"\x4a\x05" "bssid")
QDEF(MP_QSTR_ugraphics, (const byte *)"\xe5\x09" "ugraphics")
QDEF(MP_QSTR_loadFont, (const byte *)"\x10\x08" "loadFont")
QDEF(MP_QSTR_setFontStyle, (const byte *)"\x03\x0c" "setFontStyle")
QDEF(MP_QSTR_ugraphicsFlip, (const byte *)"\x76\x0d" "ugraphicsFlip")
QDEF(MP_QSTR_ugraphicsClear, (const byte *)"\x7c\x0e" "ugraphicsClear")
QDEF(MP_QSTR_setColour, (const byte *)"\x8f\x09" "setColour")
QDEF(MP_QSTR_drawRect, (const byte *)"\xa5\x08" "drawRect")
QDEF(MP_QSTR_fillRect, (const byte *)"\x0a\x08" "fillRect")
// QDEF(MP_QSTR_drawLine, (const byte*)"\x8b\x08" "drawLine")
QDEF(MP_QSTR_drawString, (const byte *)"\x30\x0a" "drawString")
QDEF(MP_QSTR_stringWidth, (const byte *)"\xd6\x0b" "stringWidth")
QDEF(MP_QSTR_saveImage, (const byte *)"\x63\x09" "saveImage")

QDEF(MP_QSTR_ASC8_8, (const byte*)"\xab\x06" "ASC8_8")
QDEF(MP_QSTR_ASC12_8, (const byte*)"\xf0\x07" "ASC12_8")
QDEF(MP_QSTR_ASC16_8, (const byte*)"\xf4\x07" "ASC16_8")
QDEF(MP_QSTR_ASC24_12, (const byte*)"\xae\x08" "ASC24_12")
QDEF(MP_QSTR_ASC32_16, (const byte*)"\xad\x08" "ASC32_16")
QDEF(MP_QSTR_ASC48_24, (const byte*)"\xc1\x08" "ASC48_24")
QDEF(MP_QSTR_HZK12, (const byte*)"\xdf\x05" "HZK12")
QDEF(MP_QSTR_HZK16, (const byte*)"\xdb\x05" "HZK16")
QDEF(MP_QSTR_HZK24, (const byte*)"\x3a\x05" "HZK24")
QDEF(MP_QSTR_HZK32, (const byte*)"\x1d\x05" "HZK32")
...
QDEF(MP_QSTR_space, (const byte*)"\x21\x05" "space")
QDEF(MP_QSTR_separators, (const byte*)"\xeb\x0a" "separators")
QDEF(MP_QSTR_state, (const byte*)"\xd2\x05" "state")
QDEF(MP_QSTR_getUptime, (const byte*)"\x03\x09" "getUptime")
QDEF(MP_QSTR_getMemory, (const byte*)"\x52\x09" "getMemory")
QDEF(MP_QSTR_aliyunIoT, (const byte *)"\x11\x09" "aliyunIoT")
QDEF(MP_QSTR_getDeviceHandle, (const byte *)"\xc1\x0f" "getDeviceHandle")
QDEF(MP_QSTR_getNtpTime, (const byte *)"\x0c\x0a" "getNtpTime")
QDEF(MP_QSTR_ON_SUBCRIBE, (const byte*)"\x40\x0b" "ON_SUBCRIBE")
QDEF(MP_QSTR_Gateway, (const byte *)"\x9d\x07" "Gateway")
QDEF(MP_QSTR_getGatewayHandle, (const byte *)"\xc1\x10" "getGatewayHandle")
QDEF(MP_QSTR_addTopo, (const byte *)"\xe0\x07" "addTopo")
QDEF(MP_QSTR_getTopo, (const byte *)"\xd7\x07" "getTopo")
QDEF(MP_QSTR_login, (const byte *)"\x46\x05" "login")
QDEF(MP_QSTR_logout, (const byte *)"\x8f\x06" "logout")
QDEF(MP_QSTR_registerSubDevice, (const byte *)"\x10\x11" "registerSubDevice")
QDEF(MP_QSTR_removeTopo, (const byte *)"\x07\x0a" "removeTopo")
QDEF(MP_QSTR_ON_LOGIN, (const byte *)"\x58\x08" "ON_LOGIN")
QDEF(MP_QSTR_ON_LOGOUT, (const byte *)"\xf1\x09" "ON_LOGOUT")
QDEF(MP_QSTR_ON_TOPOADD, (const byte *)"\x9e\x0a" "ON_TOPOADD")
QDEF(MP_QSTR_ON_TOPOGET, (const byte *)"\xa9\x0a" "ON_TOPOGET")
QDEF(MP_QSTR_ON_SUBREGISTER, (const byte *)"\x56\x0e" "ON_SUBREGISTER")
QDEF(MP_QSTR_ON_TOPOREMOVE, (const byte *)"\xd9\x0d" "ON_TOPOREMOVE")
QDEF(MP_QSTR_NET_AP_DISCONNECTING, (const byte *)"\xab\x14" "NET_AP_DISCONNECTING")
QDEF(MP_QSTR_NET_AP_DISCONNECTED, (const byte *)"\xea\x13" "NET_AP_DISCONNECTED")
QDEF(MP_QSTR_NET_AP_CONNECTING, (const byte *)"\xf5\x11" "NET_AP_CONNECTING")
QDEF(MP_QSTR_NET_AP_CONNECTED, (const byte *)"\xf4\x10" "NET_AP_CONNECTED")
QDEF(MP_QSTR_NET_IP_OBTAINING, (const byte *)"\xbc\x10" "NET_IP_OBTAINING")
QDEF(MP_QSTR_NET_IP_OBTAINED, (const byte *)"\x1d\x0f" "NET_IP_OBTAINED")
QDEF(MP_QSTR_NET_FAILED, (const byte *)"\x46\x0a" "NET_FAILED")
QDEF(MP_QSTR_NET_TYPE_WIFI, (const byte *)"\xd3\x0d" "NET_TYPE_WIFI")
QDEF(MP_QSTR_NET_TYPE_CELLULAR, (const byte *)"\x4e\x11" "NET_TYPE_CELLULAR")
QDEF(MP_QSTR_NET_TYPE_ETH, (const byte *)"\xfb\x0c" "NET_TYPE_ETH")
QDEF(MP_QSTR_postRaw, (const byte *)"\xb9\x07" "postRaw")
QDEF(MP_QSTR_ON_RAWDATA, (const byte *)"\xaf\x0a" "ON_RAWDATA")
QDEF(MP_QSTR_setOption, (const byte *)"\x04\x09" "setOption")
QDEF(MP_QSTR_getOption, (const byte *)"\x10\x09" "getOption")
QDEF(MP_QSTR_waitComplete, (const byte *)"\x27\x0c" "waitComplete")
QDEF(MP_QSTR_readVoltage, (const byte *)"\x95\x0b" "readVoltage")
QDEF(MP_QSTR_readRaw, (const byte *)"\xf3\x07" "readRaw")
QDEF(MP_QSTR_getHwParam, (const byte *)"\x83\x0a" "getHwParam")
