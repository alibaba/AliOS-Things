...
const qstr_pool_t mp_qstr_frozen_const_pool = {
    ...
    true, // entries are sorted
    {
        ...
        (const byte*)"\xa7\x43\x09" "Partition",
        ...
        (const byte*)"\xf2\xc3\x09" "TYPE_DATA",
        ...
        (const byte*)"\x5b\x28\x07" "network",
