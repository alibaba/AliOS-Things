...
{
    netmgr_connect_params_t* params = (netmgr_connect_params_t*) args;
...
STATIC mp_obj_t connect_wifi(mp_obj_t ssid,mp_obj_t pwd) {
    ...
    params = (netmgr_connect_params_t*) malloc(sizeof(netmgr_connect_params_t));
    if(params == NULL) {
    ...
    strncpy(params->params.wifi_params.ssid, _ssid, sizeof(params->params.wifi_params.ssid)-1);
    params->params.wifi_params.timeout = 18000;

    strncpy((char* )params->params.wifi_params.pwd, _pwd, sizeof(params->params.wifi_params.pwd)-1);
