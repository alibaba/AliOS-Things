...
typedef struct iot_device_hanlde{
    ...
    int res;
    mp_obj_t cb_on_connected ;
    mp_obj_t cb_on_disconnect ;
    mp_obj_t cb_on_report_reply ;
    mp_obj_t cb_on_event_reply ;
    mp_obj_t cb_on_property_set ;
    mp_obj_t cb_on_async_service ;
}iot_device_handle_t;
