...
static void demo_dm_recv_handler(void *dm_handle, const aiot_dm_recv_t *recv, void *userdata)
{
    ...
    switch (recv->type) {
        ...
        case AIOT_DMRECV_PROPERTY_SET: {
            ...
            if(mp_obj_is_fun(on_property_set)){
                callback_to_python(on_property_set, mp_obj_new_str(recv->data.property_set.params, recv->data.property_set.params_len));
            }else{
        ...
        case AIOT_DMRECV_ASYNC_SERVICE_INVOKE: {
            ...
            if(mp_obj_is_fun(on_async_service)){
                ...
                mp_obj_dict_store(dict, MP_OBJ_NEW_QSTR(qstr_from_str("id")), mp_obj_new_strn(recv->data.async_service_invoke.service_id));
                mp_obj_dict_store(dict, MP_OBJ_NEW_QSTR(qstr_from_str("param")), mp_obj_new_str(recv->data.async_service_invoke.params,recv->data.async_service_invoke.params_len));
