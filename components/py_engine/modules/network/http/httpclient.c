...
void http_client_print(const mp_print_t *print, mp_obj_t self_in,
...
STATIC mp_obj_t http_client_new(const mp_obj_type_t *type, size_t n_args,
...
STATIC mp_obj_t obj_http_get(size_t n_args, const mp_obj_t *args)
{
    ...
    ret = httpclient_get(&http_client_obj->client, url,
                         &http_client_obj->client_data);
...
STATIC mp_obj_t obj_http_put(size_t n_args, const mp_obj_t *args)
{
    ...
    char *url = (char *)mp_obj_str_get_str(args[1]);
    ret = httpclient_put(&http_client_obj->client, url,
                         &http_client_obj->client_data);
    return mp_obj_new_int(ret);
}
...
STATIC mp_obj_t obj_http_post(size_t n_args, const mp_obj_t *args)
{
    ...
    char *url = (char *)mp_obj_str_get_str(args[1]);
    ret = httpclient_post(&http_client_obj->client, url,
                          &http_client_obj->client_data);
    return mp_obj_new_int(ret);
}
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR(mp_obj_http_client_set_header, 2,
                                   http_set_header);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR(mp_obj_http_client_set_data, 3,
                                   http_set_data);
...
STATIC mp_obj_t obj_http_header(size_t n_args, const mp_obj_t *args)
{
    ...
    char *url = (char *)mp_obj_str_get_str(args[1]);
    ret = httpclient_head(&http_client_obj->client, url,
                          &http_client_obj->client_data);
    return mp_obj_new_int(ret);
}
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR(mp_obj_http_client_header, 2,
                                   obj_http_header);
...
STATIC mp_obj_t obj_http_recv(size_t n_args, const mp_obj_t *args)
{
    ...
    char *url = (char *)mp_obj_str_get_str(args[1]);
    ret = httpclient_recv(&http_client_obj->client,
                          &http_client_obj->client_data);
    return mp_obj_new_int(ret);
}
...
STATIC mp_obj_t obj_http_send(size_t n_args, const mp_obj_t *args)
{
    ...
    ret = httpclient_send(&http_client_obj->client, url, method,
                          &http_client_obj->client_data);
    return mp_obj_new_int(ret);
}
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR(mp_obj_http_client_send, 3, obj_http_send);

STATIC mp_obj_t obj_http_get_res_header_value(size_t n_args,
                                              const mp_obj_t *args)
{
    LOGD(LOG_TAG, "enter  %s; n_args = %d;\n", __func__, n_args);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR(mp_obj_get_res_header_value, 2,
                                   obj_http_get_res_header_value);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR(mp_obj_get_res_code, 1,
                                   obj_http_get_res_code);
...
STATIC mp_obj_t obj_http_get_add_text(size_t n_args, const mp_obj_t *args)
{
    ...
    ret = httpclient_formdata_addtext(&http_client_obj->client,
                                      content_disposition, content_type, name,
                                      data, data_len);
    return mp_obj_new_int(ret);
}
...
STATIC mp_obj_t obj_http_get_add_file(size_t n_args, const mp_obj_t *args)
{
    ...
    ret = httpclient_formdata_addfile(&http_client_obj->client,
                                      content_disposition, name, content_type,
                                      file_path);
    return mp_obj_new_int(ret);
}
...
STATIC mp_obj_t obj_http_delete(size_t n_args, const mp_obj_t *args)
{
    ...
    char *url = (char *)mp_obj_str_get_str(args[1]);
    ret = httpclient_delete(&http_client_obj->client, url,
                            &http_client_obj->client_data);
    return mp_obj_new_int(ret);
}
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR(mp_obj_http_client_prepare, 3,
                                   obj_http_prepare);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR(mp_obj_http_client_unprapare, 1,
                                   obj_http_unprepare);
...
STATIC mp_obj_t obj_http_get_response(size_t n_args, const mp_obj_t *args)
{
    ...
    return mp_obj_new_str(http_client_obj->client_data.response_buf,
                          strlen(http_client_obj->client_data.response_buf));
}
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR(mp_obj_get_response, 1,
                                   obj_http_get_response);
    ...
    if (!ret) {
        ...
        do {
            ...
            if (client_data.content_block_len > 0) {
                num = aos_write(fd, client_data.response_buf,
                                client_data.content_block_len);
                if (num > 0) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR(mp_obj_HTTPConnection, 2,
                                   obj_HTTPConnection);
...
STATIC const mp_rom_map_elem_t http_client_module_globals_table[] = {
    ...
    { MP_OBJ_NEW_QSTR(MP_QSTR_set_header),
      MP_ROM_PTR(&mp_obj_http_client_set_header) },
    { MP_OBJ_NEW_QSTR(MP_QSTR_set_data),
      MP_ROM_PTR(&mp_obj_http_client_set_data) },
    ...
    { MP_OBJ_NEW_QSTR(MP_QSTR_get_response_code),
      MP_ROM_PTR(&mp_obj_get_res_code) },
    { MP_OBJ_NEW_QSTR(MP_QSTR_get_response_header),
      MP_ROM_PTR(&mp_obj_get_res_header_value) },
    ...
    { MP_OBJ_NEW_QSTR(MP_QSTR_prepare),
      MP_ROM_PTR(&mp_obj_http_client_prepare) },
    { MP_OBJ_NEW_QSTR(MP_QSTR_unprepare),
      MP_ROM_PTR(&mp_obj_http_client_unprapare) },
    ...
    { MP_OBJ_NEW_QSTR(MP_QSTR_HTTPConnection),
      MP_ROM_PTR(&mp_obj_HTTPConnection) },

};

STATIC MP_DEFINE_CONST_DICT(http_client_module_globals,
                            http_client_module_globals_table);
