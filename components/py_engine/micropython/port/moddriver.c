...
extern const mp_obj_type_t driver_systimer_type;
...
STATIC const mp_rom_map_elem_t driver_locals_dict_table[] = {
    ...
    {MP_OBJ_NEW_QSTR(MP_QSTR_LCD), MP_ROM_PTR(&driver_lcd_type)},
    ...
    {MP_OBJ_NEW_QSTR(MP_QSTR_AudioPlayer), MP_ROM_PTR(&driver_audioplayer_type)},
    ...
    {MP_OBJ_NEW_QSTR(MP_QSTR_TTS), MP_ROM_PTR(&driver_tts_type)},
    {MP_OBJ_NEW_QSTR(MP_QSTR_UND), MP_ROM_PTR(&driver_und_type)},
    {MP_OBJ_NEW_QSTR(MP_QSTR_Crypto), MP_ROM_PTR(&driver_crypto_type)},
    {MP_OBJ_NEW_QSTR(MP_QSTR_SysTimer), MP_ROM_PTR(&driver_systimer_type)},
};
