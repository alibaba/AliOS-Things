...
extern void sk_init_imagedecoder_png();

HaasImageCodecPng::HaasImageCodecPng()
{
    LOG_D("entern\n");
}
...
int HaasImageCodecPng::ImgRead(ImageBuffer_t **image, char * filename)
{
    LOG_D("entern\n");
    return STATUS_OK;
}

int HaasImageCodecPng::ImgReadMulti(ImageBuffer_t **images, char * filename)
{
    LOG_D("entern\n");
    return STATUS_OK;
}

int HaasImageCodecPng::ImgWrite(ImageBuffer_t *image, char * filename)
{
    LOG_D("entern\n");
    return STATUS_OK;
}

int HaasImageCodecPng::ImgWriteMulti(ImageBuffer_t **images, char * filename)
{
    LOG_D("entern\n");
    return STATUS_OK;
}

int HaasImageCodecPng::ImgDecode(void *addr, ImageBuffer_t **image)
{
    LOG_D("entern\n");
    return STATUS_OK;
}

ImageBuffer_t * HaasImageCodecPng::ImgDecode(const char *filename)
{
...
int HaasImageCodecPng::ImgEncode(void *addr, ImageBuffer_t **image)
{
    LOG_D("entern\n");
    return STATUS_OK;
}

int HaasImageCodecPng::haveImageReader(char * filename)
{
    LOG_D("entern\n");
    return STATUS_OK;
}

int HaasImageCodecPng::haveImageWriter(char * filename)
{
    LOG_D("entern\n");
    return STATUS_OK;
}
