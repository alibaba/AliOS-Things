#ifndef HAAS_IMAGE_PROC_CPU_H
#define HAAS_IMAGE_PROC_CPU_H
...
class HaasImageProcCpu : public IHaasImageProc
{
    public:
        HaasImageProcCpu();
        virtual ~HaasImageProcCpu();
...
private:
    ImageCvtColorCpu *mImageCvtColorCpu;
    ImageResizeCpu *mImageResizeCpu;
};
#endif
