...
1. Differential incremental upgrade: compress rate, more than 50%;
2. Dual banker:AB partition upgrade to support rollback to old version;
3. Compress binary upgrade: XZ compress rate, more than 30%;
4. Footprint: such as 3060, ROM-->12K~18K RAM: 3K~8K
...
```
for sample code please check 2ndboot.c.
## RTOS build
```sh
cd ROOT DIR;
aos make 2ndboot;
