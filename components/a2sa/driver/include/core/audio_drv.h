...
#define AOS_SNDCARD_NUM_MAX         5                  /* Assume we support maxmum 5 sound card */
#define AOS_SNDCARD_DEVICE_NUM_MAX  5                  /* Assume we support maxmum 5 sound device for each sound card */
