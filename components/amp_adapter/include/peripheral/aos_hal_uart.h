 ...
 * @return  0 : on success,  otherwise is error
 */
int32_t aos_hal_uart_send_poll(uart_dev_t *uart, const void *data, uint32_t size);
 ...
 * @return  0 : on success,  otherwise is error
 */
int32_t aos_hal_uart_recv(uart_dev_t *uart, void *data, uint32_t expect_size, uint32_t timeout);
 ...
 */
int32_t aos_hal_uart_recv_cb_reg(uart_dev_t *uart, uart_rx_cb cb);
