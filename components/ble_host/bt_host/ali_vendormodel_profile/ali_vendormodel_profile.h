...
typedef void (*bt_mesh_profile_prov_link_open_t)(uint8_t status);

//typedef void (*bt_mesh_evt_t)(s_bt_mesh_evt bt_mesh_evt);

typedef void (*bt_mesh_opcode_cb_t)(uint8_t type,uint8_t *attr_buf,uint8_t attr_len);
...
int bt_mesh_profile_prov_init(const uint8_t *dev_uuid,
                              ...
                              bt_mesh_profile_prov_link_open_t prov_link_open_cb);
#else
int bt_mesh_profile_prov_init(const uint8_t *dev_uuid,
                              const uint8_t *digest, size_t digest_len,
...
#endif // ALI_VENDORMODEL_PROFILE_H_
