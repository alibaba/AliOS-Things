    ...
    switch (padding.type) {
        ...
        case RSAES_PKCS1_V1_5: {
            ...
            ret = mbedtls_rsa_pkcs1_encrypt(
              &ctx, myrand, NULL, MBEDTLS_RSA_PUBLIC, src_size,
                               ...
                               rsa_padding_t padding)
{
    ...
    ret = mbedtls_rsa_pkcs1_sign(
      &ctx, myrand, NULL, MBEDTLS_RSA_PRIVATE, (mbedtls_md_type_t)hash_type,
                                 ...
                                 rsa_padding_t padding, bool *p_result)
{
    ...
    ret = mbedtls_rsa_pkcs1_verify(
      &ctx, NULL, NULL, MBEDTLS_RSA_PUBLIC, (mbedtls_md_type_t)hash_type,
