...
#define crypto_sm4_get_ctx_size(type, size)  \
           ali_sm4_get_ctx_size(type, size)

#define crypto_sm4_init(type, is_enc, key1, key2, keybytes, iv, context)     \
           ali_sm4_init(type, is_enc, key1, key2, keybytes, iv, context)

#define crypto_sm4_process(src, dst, size, context)             \
           ali_sm4_process(src, dst, size, context)

#define crypto_sm4_finish(src, src_size, dst, dst_size, padding, context)     \
           ali_sm4_finish(src, src_size, dst, dst_size, padding, context)

#define crypto_sm4_reset(context)          \
           ali_sm4_reset(context)

#define crypto_sm4_copy_context(dst_ctx, src_ctx)       \
           ali_sm4_copy_context(dst_ctx, src_ctx)
...
#define crypto_authenc_init(type, is_enc, key, keybytes, nonce,                \
                            nonce_len, tag_len, payload_len, aad_len, context) \
           ali_authenc_init(type, is_enc, key, keybytes, nonce,                \
                            nonce_len, tag_len, payload_len, aad_len, context)
...
#define crypto_authenc_enc_finish(src, src_size, dst, dst_size,           \
                                                 tag, tag_len, context)     \
           ali_authenc_enc_finish(src, src_size, dst, dst_size,           \
                                                 tag, tag_len, context)
#define crypto_authenc_dec_finish(src, src_size, dst, dst_size,               \
                                                 tag, tag_len, context)       \
           ali_authenc_dec_finish(src, src_size, dst, dst_size,               \
                                                 tag, tag_len, context)

#define crypto_authenc_reset(context)             \
           ali_authenc_reset(context)
...
#define crypto_cbcmac_reset(context)                \
           ali_cbcmac_reset(context)
...
#define crypto_cmac_get_ctx_size(type, size)             \
           ali_cmac_get_ctx_size(type, size)
...
#define crypto_cmac_reset(context)         \
           ali_cmac_reset(context)
...
#define crypto_dsa_init_keypair(keybits, g, g_size, p, p_size,           \
                      q, q_size, y, y_size, x, x_size, keypair)      \
           ali_dsa_init_keypair(keybits, g, g_size, p, p_size,           \
                      q, q_size, y, y_size, x, x_size, keypair)

#define crypto_dsa_init_pubkey(keybits, g, g_size, p, p_size, q, q_size,  \
                                    y, y_size, pubkey)                            \
           ali_dsa_init_pubkey(keybits, g, g_size, p, p_size, q, q_size,  \
                                    y, y_size, pubkey)

#define crypto_dsa_gen_keypair(keybit, g, g_size, p, p_size, q, q_size, \
                          keypair)                                      \
           ali_dsa_gen_keypair(keybit, g, g_size, p, p_size, q, q_size, \
                                      keypair)

#define crypto_dsa_sign(priv_key, src, src_size, signature,             \
             sig_size, padding)                             \
           ali_dsa_sign(priv_key, src, src_size, signature,             \
                         sig_size, padding)

#define crypto_dsa_verify(pub_key, src, src_size, signature,           \
               sig_size, padding, result)                  \
           ali_dsa_verify(pub_key, src, src_size, signature,           \
                           sig_size, padding, result)
...
#define crypto_dh_init_keypair(keybits, g, g_size, p, p_size, y, y_size,     \
                            x, x_size, q, q_size, xbits, keypair)          \
           ali_dh_init_keypair(keybits, g, g_size, p, p_size, y, y_size,     \
                            x, x_size, q, q_size, xbits, keypair)

#define crypto_dh_init_pubkey(keybits, y, y_size, pubkey)           \
           ali_dh_init_pubkey(keybits, y, y_size, pubkey)

#define crypto_dh_gen_keypair(keybit, g, g_size, p, p_size, q, q_size, xbits, keypair)   \
           ali_dh_gen_keypair(keybit, g, g_size, p, p_size, q, q_size, xbits, keypair)

#define crypto_dh_derive_secret(priv_key, peer_pub_key, shared_secret, secret_size)     \
...
#define crypto_ecc_init_keypair(x, x_size, y, y_size, d, d_size, curve, keypair)     \
...
#define crypto_ecdsa_verify(pub_key, src, src_size, signature, sig_size, result)    \
       ali_ecdsa_verify(pub_key, src, src_size, signature, sig_size, result)

#define crypto_ecdh_derive_secret(priv_key, peer_pubkey_key, shared_secret, secret_size)     \
           ali_ecdh_derive_secret(priv_key, peer_pubkey_key, shared_secret, secret_size)

#define crypto_sm2_get_keypair_size(keybits, size)           \
           ali_sm2_get_keypair_size(keybits, size)

#define crypto_sm2_get_pubkey_size(keybits, size)            \
           ali_sm2_get_pubkey_size(keybits, size)

#define crypto_sm2_init_pubkey(x, x_size, y, y_size, curve, pubkey)  \
           ali_sm2_init_pubkey(x, x_size, y, y_size, curve, pubkey)

#define crypto_sm2_gen_keypair(curve, keypair)     \
           ali_sm2_gen_keypair(curve, keypair)

#define crypto_sm2_sign(priv_key, src, src_size, signature, sig_size)     \
           ali_sm2_sign(priv_key, src, src_size, signature, sig_size)

#define crypto_sm2_verify(pub_key, src, src_size, signature, sig_size, p_result)    \
           ali_sm2_verify(pub_key, src, src_size, signature, sig_size, p_result)

#define crypto_sm2_encrypt(pub_key, plaintext, p_size, ciphertext, c_size)           \
           ali_sm2_encrypt(pub_key, plaintext, p_size, ciphertext, c_size)

#define crypto_sm2_decrypt(priv_key, ciphertext, c_size,plaintext, p_size)           \
           ali_sm2_decrypt(priv_key, ciphertext, c_size,plaintext, p_size)

#define crypto_sm2dh_derive_secret(flag_server, ID, ID_size,       \
                peer_ID, peer_ID_size, priv_key, tmp_priv_key,     \
                peer_pubkey,tmp_peer_pubkey,                       \
                shared_secret, secret_size)                        \
        ali_sm2dh_derive_secret(flag_server, ID, ID_size,          \
                peer_ID, peer_ID_size, priv_key, tmp_priv_key,     \
                peer_pubkey,tmp_peer_pubkey,                       \
                shared_secret, secret_size)
