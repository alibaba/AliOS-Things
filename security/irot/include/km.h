...
#define KM_ERR_OVERFLOW 0xffff000A
    ...
    uint32_t km_export_key(const char *name, const uint32_t name_len,
                           km_format_t format, uint8_t *export_data,
     ...
     * return: see km error code
     * */
    uint32_t km_mac(const char *name, const uint32_t name_len,
                    km_sym_param *mac_params, const uint8_t *iv,
    ...
    uint32_t km_envelope_begin(void **ctx, const char *name,
                               const uint32_t name_len, uint8_t *iv,
                               uint16_t iv_len, uint8_t *protected_key,
                               uint32_t *      protected_key_len,
    ...
    uint32_t km_sign(const char *name, const uint32_t name_len,
                     void *sign_params, const uint8_t *data,
     ...
     *
     * */
    uint32_t km_verify(const char *name, const uint32_t name_len,
                       void *sign_params, const uint8_t *data,
                       const size_t data_len, const uint8_t *signature,
     ...
     * return: see km error code
     * */
    uint32_t km_asym_encrypt(const char *name, const uint32_t name_len,
                             void *enc_params, const uint8_t *src,
                             const size_t src_len, uint8_t *dest,
                             size_t *dest_len);
    /*
