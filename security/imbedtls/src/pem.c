                            ...
                            size_t pwdlen)
{
    ...
    mbedtls_des_crypt_cbc(&des_ctx, MBEDTLS_DES_DECRYPT, buflen, des_iv, buf,
                          buf);
                             ...
                             size_t pwdlen)
{
    ...
    mbedtls_des3_crypt_cbc(&des3_ctx, MBEDTLS_DES_DECRYPT, buflen, des3_iv, buf,
                           buf);
                            ...
                            const unsigned char *pwd, size_t pwdlen)
{
    ...
    mbedtls_aes_crypt_cbc(&aes_ctx, MBEDTLS_AES_DECRYPT, buflen, aes_iv, buf,
                          buf);
    ...
    mbedtls_aes_crypt_cbc_alt(&aes_ctx, MBEDTLS_AES_DECRYPT, buflen, aes_iv,
                              buf, buf);
