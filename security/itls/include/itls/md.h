...
#define MBEDTLS_MD_MAX_SIZE 32 /* longest known is SHA256 or less */
    ...
    /**
     * \brief           Returns the message digest information associated with
     * the given digest name.
     *
     * \param md_name   Name of the digest to search for.
     *
     * \return          The message digest information associated with md_name
     ...
     *
     * \return          The message digest information associated with md_type
     * or NULL if not found.
     */
...
#define MBEDTLS_DEPRECATED
     ...
     *                  \c MBEDTLS_ERR_MD_ALLOC_FAILED memory allocation
     * failure.
     */
...
#undef MBEDTLS_DEPRECATED
     ...
     *                  Called between mbedtls_md_starts() and
     * mbedtls_md_finish(). May be called repeatedly.
     *
     * \param ctx       Generic message digest context
