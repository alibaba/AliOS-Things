...
extern "C"
{
     ...
     *
     * The configuration options you can set for this module are in this
     * section. Either change them in config.h or define them on the compiler
     * command line.
     * \{
     */
...
#define MBEDTLS_PLATFORM_STD_SNPRINTF \
    mbedtls_platform_win32_snprintf /**< Default snprintf to use  */
#else
...
#define MBEDTLS_PLATFORM_STD_EXIT_SUCCESS \
    EXIT_SUCCESS /**< Default exit value to use */
#endif
#if !defined(MBEDTLS_PLATFORM_STD_EXIT_FAILURE)
#define MBEDTLS_PLATFORM_STD_EXIT_FAILURE \
    EXIT_FAILURE /**< Default exit value to use */
#endif
...
#include "platform_alt.h"
     ...
     * \return  0 if successful
     *
     * \note    This function is intended to allow platform specific
     * initialisation, and should be called before any other library functions.
     * Its implementation is platform specific, and by default, unless platform
     *          specific code is provided, it does nothing.
     *
     *          Its use and whether its necessary to be called is dependent on
     * the platform.
     */
     ...
     * has been correctly freed using the appropriate free function. Its
