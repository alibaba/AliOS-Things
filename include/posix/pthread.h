...
/* A workaround, the posix thread types we defined, avoid conflicts with the same types defined
 * in toolchain. The defined types in toolchain should be disable.
 */
#define pthread_t aos_pthread_t
#define pthread_once_t aos_pthread_once_t
#define sched_param aos_sched_param
#define pthread_attr_t aos_pthread_attr_t
#define pthread_mutexattr_t aos_pthread_mutexattr_t
#define pthread_mutex_t aos_pthread_mutex_t
#define pthread_condattr_t aos_pthread_condattr_t
#define pthread_cond_t aos_pthread_cond_t
#define pthread_key_t aos_pthread_key_t
